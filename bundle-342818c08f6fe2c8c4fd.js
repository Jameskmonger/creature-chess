...
var BenchPieces = function () {
    var e_1, _a;
    var pieces = react_redux_1.useSelector(function (state) { return state.bench.piecePositions; });
    ...
    try {
        for (var entries_1 = __values(entries), entries_1_1 = entries_1.next(); !entries_1_1.done; entries_1_1 = entries_1.next()) {
            ...
            pieceElements.push(React.createElement(positionablePiece_1.PositionablePiece, { key: id, id: id, x: x, y: y, draggable: true, animate: false, selected: selected, pieceIsOnBench: true }));
        }
    }
