import { Card, StreakType, PlayerBattle, PlayerStatus } from "@creature-chess/models";
...
export const UPDATE_SHOP_LOCK_COMMAND = "UPDATE_SHOP_LOCK_COMMAND";
export type UPDATE_SHOP_LOCK_COMMAND = typeof UPDATE_SHOP_LOCK_COMMAND;
export const UPDATE_CARDS_COMMAND = "UPDATE_CARDS_COMMAND";
export type UPDATE_CARDS_COMMAND = typeof UPDATE_CARDS_COMMAND;
...
export type UpdateShopLockCommand = ({ type: UPDATE_SHOP_LOCK_COMMAND, payload: { locked: boolean } });
...
export type UpdateCardsCommand = ({ type: UPDATE_CARDS_COMMAND, payload: { cards: Card[] } });
...
export const updateShopLockCommand = (locked: boolean): UpdateShopLockCommand => ({ type: UPDATE_SHOP_LOCK_COMMAND, payload: { locked } });
...
export const updateCardsCommand = (cards: Card[]): UpdateCardsCommand => ({ type: UPDATE_CARDS_COMMAND, payload: { cards }});
