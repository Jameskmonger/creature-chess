...
const PhaseInfo: React.FunctionComponent = () => {
    const phase = useSelector<AppState, GamePhase>(state => state.game.gameInfo.phase);
    const phaseStartedAtSeconds = useSelector<AppState, number>(state => state.game.gameInfo.phaseStartedAtSeconds);
