...
exports.isRegistered = function (user) { return user["https://creaturechess.jamesmonger.com/playerNickname"] !== null; };
...
exports.runPlayingPhase = function () {
    var options, players, battleTimeoutDeferred, phase, startedAt, promises, round, _a, _b, player;
    var e_1, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 5:
                round = _d.sent();
                try {
                    for (_a = __values(players.getAll().filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.getRoundDiedAt() === round; })), _b = _a.next(); !_b.done; _b = _a.next()) {
                        player = _b.value;
                        player.kill();
                    }
                }
...
exports.runPreparingPhase = function () {
...
exports.runReadyPhase = function () {
...
exports.playerGameDeckSagaFactory = function (deck) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.all([
                        effects_1.takeEvery(player_1.PlayerEvents.playerDeathEvent.toString(), function (_a) {
                            var _b = _a.payload, pieces = _b.pieces, cards = _b.cards;
                            return __generator(this, function (_c) {
                        ...
                        effects_1.takeEvery(player_1.PlayerEvents.afterRerollCardsEvent.toString(), function () {
                            var state, cards, level, threeStarBoardPieces, threeStarBenchPieces, excludeIds, blessCandidateIds, newCards;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        excludeIds = __spread(threeStarBoardPieces, threeStarBenchPieces).map(function (p) { return p.definitionId; });
                                        blessCandidateIds = __spread(new Set(pieceSelectors_1.getPiecesExceptStage(state.board, 2).map(function (p) { return p.definitionId; })));
                                        newCards = pullNewCards(cards, level, excludeIds, blessCandidateIds);
...
exports.listenForPropertyUpdates = function (player, fns) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (fns.status) {
                        sagas.push(effects_1.takeLatest(playerInfo_1.PlayerInfoCommands.UPDATE_STATUS_COMMAND, function (_a) {
...
var roundInfo_1 = __webpack_require__(/*! ./roundInfo */ "../gamemode/lib/game/roundInfo/index.js");
exports.sendPublicEventsSaga = function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
...
var redux_saga_1 = __webpack_require__(/*! redux-saga */ "../gamemode/node_modules/redux-saga/dist/redux-saga-core-npm-proxy.esm.js");
var roundInfo_1 = __webpack_require__(/*! ./roundInfo */ "../gamemode/lib/game/roundInfo/index.js");
exports.createGameStore = function (context) {
    var sagaMiddleware = redux_saga_1["default"]({
        context: context
    });
    var store = redux_1.createStore(redux_1.combineReducers({
...
exports.__esModule = true;
exports.playerMatchRewardsEvent = exports.PLAYER_MATCH_REWARDS_EVENT = exports.playerDeathEvent = exports.clientFinishMatchEvent = exports.CLIENT_FINISH_MATCH_EVENT = exports.afterRerollCardsEvent = exports.afterSellPieceEvent = exports.playerFinishMatchEvent = exports.PLAYER_FINISH_MATCH_EVENT = void 0;
var toolkit_1 = __webpack_require__(/*! @reduxjs/toolkit */ "../gamemode/node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
...
var Player = /** @class */ (function () {
    ...
    Player.prototype.enterPreparingPhase = function () {
        if (!this.getShopLocked()) {
            this.store.dispatch(events_2.afterRerollCardsEvent());
        }
    ...
    Player.prototype.kill = function () {
        ...
        this.store.dispatch(events_2.playerDeathEvent({ pieces: pieces, cards: cards }));
    };
...
exports.validateNicknameFormat = function (nickname) {
