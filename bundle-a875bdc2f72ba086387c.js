...
var ReadyUpButton = function () {
    var canReadyUp = react_redux_1.useSelector(function (state) { return state.game.phase === models_1.GamePhase.PREPARING && state.game.ready === false; });
    var dispatch = react_redux_1.useDispatch();
    if (!canReadyUp) {
        return null;
    }
...
var Healthbar = function (_a) {
    ...
    var localPlayerId = react_redux_1.useSelector(function (state) { return state.game.localPlayerId; });
...
var react_redux_1 = __webpack_require__(/*! react-redux */ "../../node_modules/react-redux/es/index.js");
var selectors_1 = __webpack_require__(/*! ../../store/selectors */ "./src/game/store/selectors.ts");
var playerSelectors_1 = __webpack_require__(/*! @creature-chess/shared/player/playerSelectors */ "../shared/player/playerSelectors.ts");
var PlayerList = function () {
    var players = react_redux_1.useSelector(function (state) { return state.playerList; });
    var opponentId = react_redux_1.useSelector(selectors_1.opponentIdSelector);
    var localPlayerId = react_redux_1.useSelector(selectors_1.localPlayerIdSelector);
...
var subscribe = function (registry, socket) {
    return redux_saga_1.eventChannel(function (emit) {
        socket.on("reconnect_failed", function () {
            ...
            emit(actions_1.updateConnectionStatus(networking_1.ConnectionStatus.DISCONNECTED));
        });
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.PHASE_UPDATE, function (packet) {
            ...
            emit(actions_1.updateConnectionStatus(networking_1.ConnectionStatus.CONNECTED));
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.JOIN_GAME, function (packet) {
            ...
            if (packet.type === "game") {
                ...
                emit(actions_1.joinCompleteAction(localPlayerId));
                ...
                if (phase) {
                    ...
                    emit(actions_1.updateConnectionStatus(networking_1.ConnectionStatus.RECONNECTED));
                }
            }
        });
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.SHOP_LOCK_UPDATE, function (packet) {
            ...
            emit(actions_1.shopLockUpdated(packet.locked));
        });
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 25:
                ...
                return [4 /*yield*/, effects_1.put(actions_1.updateConnectionStatus(networking_1.ConnectionStatus.CONNECTED))];
            case 26:
                _a.sent();
...
exports.__esModule = true;
exports.finishGameAction = exports.shopLockUpdated = exports.updateConnectionStatus = exports.playersResurrected = exports.enableDebugMode = exports.phaseStartSeconds = exports.joinGameError = exports.joinCompleteAction = exports.findGameAction = exports.FINISH_GAME = exports.SHOP_LOCK_UPDATED = exports.UPDATE_CONNECTION_STATUS = exports.ENABLE_DEBUG_MODE = exports.PHASE_START_SECONDS = exports.PLAYERS_RESURRECTED = exports.JOIN_ERROR = exports.JOIN_COMPLETE = exports.FIND_GAME = void 0;
...
exports.enableDebugMode = function () { return ({
    type: exports.ENABLE_DEBUG_MODE
}); };
...
function reducer(state, action) {
    ...
    switch (action.type) {
        case actions_1.JOIN_COMPLETE:
            return tslib_1.__assign(tslib_1.__assign({}, state), { localPlayerId: action.payload.playerId, ready: false });
...
exports.localPlayerIdSelector = function (state) { return state.game.localPlayerId; };
...
var selectors_1 = __webpack_require__(/*! ../game/store/selectors */ "./src/game/store/selectors.ts");
...
var mapStateToProps = function (state) { return ({
    loading: selectors_1.loadingSelector(state),
...
exports.ownedPieceSelector = function (state) {
    var playerId = selectors_1.localPlayerIdSelector(state);
    ...
    return tslib_1.__generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, effects_1.takeEvery(actions_1.JOIN_COMPLETE, function (_a) {
