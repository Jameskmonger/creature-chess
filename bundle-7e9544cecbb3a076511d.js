...
var incomingGameNetworking = function (socket, slices) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                registry = new networking_1.IncomingPacketRegistry(
                // todo fix typing here
                function (opcode, handler) { return socket.on(opcode, handler); });
...
var sendPlayerActions = function (registry) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                if (false) {}
                return [4 /*yield*/, effects_1.take(gamemode_1.PlayerActionTypesArray)];
            case 2:
                action = _a.sent();
                index = ++lastSentIndex;
...
exports.__esModule = true;
exports.playerReducers = exports.PlayerCommands = exports.PlayerEntitySelectors = exports.playerEntity = void 0;
        ...
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.all([
                    ...
                    effects_1.takeLatest(events_1.playerFinishMatchEvent.toString(), function (_a) {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0: return [5 /*yield**/, __values(typed_redux_saga_1.select(playerSelectors_1.getOpponentId))];
                                case 1:
                                    opponentId = _c.sent();
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, effects_1.takeEvery(FILL_BOARD_COMMAND, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [5 /*yield**/, __values(typed_redux_saga_1.select(player_1.PlayerSelectors.isPlayerAlive))];
                                case 1:
                                    isAlive = _a.sent();
                                    if (!isAlive) {
                                        return [2 /*return*/];
                                ...
                                case 3:
                                    state = _a.sent();
                                    belowPieceLimit = player_1.PlayerSelectors.getPlayerBelowPieceLimit(state, playerId);
                                    if (!belowPieceLimit) {
                                        return [2 /*return*/];
                                    }
                                    benchPiece = player_1.PlayerSelectors.getMostExpensiveBenchPiece(state);
                                    if (!benchPiece) {
                                        return [2 /*return*/];
                                    }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, typed_redux_saga_1.select(playerSelectors_1.getPlayerStreak)];
            case 1:
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            ...
                            case 1:
                                ...
                                return [5 /*yield**/, __values(typed_redux_saga_1.select(playerSelectors_1.getPlayerHealth))];
                            case 2:
                                oldValue = _d.sent();
                            ...
                            case 7:
                                _d.sent();
                                _d.label = 8;
                            case 8: return [5 /*yield**/, __values(typed_redux_saga_1.select(playerSelectors_1.getPlayerMoney))];
                            case 9:
                                currentMoney = _d.sent();
                                return [5 /*yield**/, __values(typed_redux_saga_1.select(playerSelectors_1.getPlayerStreak))];
                            case 10:
                                streak = _d.sent();
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    return [5 /*yield**/, __values(typed_redux_saga_1.select(playerSelectors_1.getPlayerMoney))];
                                case 3:
            ...
            case 2:
                ...
                return [4 /*yield*/, effects_1.all([
                        effects_1.takeEvery(player_1.PlayerEvents.playerDeathEvent.toString(), function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [5 /*yield**/, __values(typed_redux_saga_1.select(playerSelectors_1.getPlayerCards))];
                                    case 1:
                                        cards = _a.sent();
        ...
        var watchQuitTask = player.runSaga(function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [5 /*yield**/, __values(typed_redux_saga_1.select(player_1.PlayerSelectors.isPlayerAlive))];
                    case 2:
                        isAlive = _a.sent();
                        return [5 /*yield**/, __values(typed_redux_saga_1.select(player_1.PlayerSelectors.isPlayerReady))];
                    case 3:
                        isReady = _a.sent();
                        if (isAlive && !isReady) {
                            queue.add(player.id);
...
exports.__esModule = true;
exports.PlayerInfoCommands = exports.PlayerSagaContext = exports.PlayerSelectors = exports.PlayerEvents = void 0;
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 6:
                                ...
                                return [5 /*yield**/, __values(typed_redux_saga_1.select(playerSelectors_1.getPlayerCards))];
                            case 7:
                                cards = _c.sent();
                                return [5 /*yield**/, __values(typed_redux_saga_1.select(playerSelectors_1.getPlayerMoney))];
                            case 8:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeEvery(exports.toggleShopLockPlayerAction.toString(), function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, effects_1.select(player_1.PlayerSelectors.isPlayerShopLocked)];
                            case 1:
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/index.tsx","vendors-node_modules_auth0_auth0-react_dist_auth0-react_esm_js-node_modules_fortawesome_free--73e14a"]
/******/ 		];
...
/******/ })()
;
//# sourceMappingURL=bundle-7e9544cecbb3a076511d.js.map