...
var Game = /** @class */ (function () {
    function Game(players, options) {
        ...
        this.addPlayer = function (player) {
            ...
            player.onQuitGame(_this.playerQuitGame);
        };
...
var actions_2 = __webpack_require__(/*! ../store/actions */ "../shared/game/store/actions.ts");
...
var Player = /** @class */ (function () {
    function Player(id, name) {
        ...
        this.sellPiece = function (pieceId) {
            ...
            var currentMoney = _this.store.getState().playerInfo.money;
            _this.store.dispatch(playerInfo_1.moneyUpdateAction(currentMoney + (pieceCost * piecesUsed)));
    ...
    Player.prototype.clearMatchSaga = function () {
        var _this = this;
        var clearMatch = function () { return _this.match = null; };
        return function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, effects_1.takeEvery(actions_2.GAME_PHASE_STARTED, function (_a) {
                            var phase = _a.payload.phase;
                            return tslib_1.__generator(this, function (_b) {
                                if (phase !== models_1.GamePhase.PREPARING) {
                                    return [2 /*return*/];
                                }
                                clearMatch();
                                return [2 /*return*/];
