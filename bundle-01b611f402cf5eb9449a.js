...
var player_list_player_1 = __webpack_require__(/*! ./player-list-player */ "../models/player-list-player.ts");
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, effects_1.put(actions_1.userLoaded(existingAuthInfo))];
            case 2:
                _a.sent();
                return [3 /*break*/, 8];
            case 3: return [4 /*yield*/, effects_1.put(actions_1.sessionChecked())];
            case 4:
                _a.sent();
            ...
            case 6:
                authInfo = _a.sent();
                return [4 /*yield*/, effects_1.put(actions_1.userLoaded(authInfo))];
            case 7:
                _a.sent();
                _a.label = 8;
...
exports.__esModule = true;
exports.getIdToken = exports.isCheckingSession = exports.isLoggedIn = void 0;
...
exports.getIdToken = function (state) { return state.auth.user.idToken; };
...
var playerSelectors_1 = __webpack_require__(/*! @creature-chess/shared/player/playerSelectors */ "../shared/player/playerSelectors.ts");
var settings_1 = __webpack_require__(/*! ./settings/settings */ "./src/display/game/settings/settings.tsx");
...
/***/ "./src/display/game/settings/quitGameButton.tsx":
/*!******************************************************!*\
  !*** ./src/display/game/settings/quitGameButton.tsx ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./src/display/game/settings/settings.tsx":
/*!************************************************!*\
  !*** ./src/display/game/settings/settings.tsx ***!
  \************************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "../../node_modules/react/index.js");
var footer_1 = __webpack_require__(/*! ../../footer */ "./src/display/footer.tsx");
var quitGameButton_1 = __webpack_require__(/*! ./quitGameButton */ "./src/display/game/settings/quitGameButton.tsx");
...
var footer_1 = __webpack_require__(/*! ../footer */ "./src/display/footer.tsx");
var quitGameButton_1 = __webpack_require__(/*! ../game/settings/quitGameButton */ "./src/display/game/settings/quitGameButton.tsx");
...
var footer_1 = __webpack_require__(/*! ../footer */ "./src/display/footer.tsx");
var leaderboard_1 = __webpack_require__(/*! ../leaderboard */ "./src/display/leaderboard.tsx");
...
var player_1 = __webpack_require__(/*! @creature-chess/shared/player */ "../shared/player/index.ts");
var playerSelectors_1 = __webpack_require__(/*! @creature-chess/shared/player/playerSelectors */ "../shared/player/playerSelectors.ts");
var toggleLockButton_1 = __webpack_require__(/*! ./toggleLockButton */ "./src/features/cardShop/toggleLockButton.tsx");
...
/***/ "./src/features/cardShop/toggleLockButton.tsx":
/*!****************************************************!*\
  !*** ./src/features/cardShop/toggleLockButton.tsx ***!
  \****************************************************/
/*! no static exports found */
    ...
    return redux_saga_1.eventChannel(function (emit) {
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.JOIN_GAME, function (packet) {
            if (packet.type === "lobby") {
                ...
                emit(lobbyActions_1.joinLobbyAction(playerId, lobbyId, players, startTimestamp));
            }
            if (packet.type === "game") {
                var localPlayerId = packet.payload.localPlayerId;
                emit(localPlayerActions_1.joinCompleteAction(localPlayerId));
...
exports.joinCompleteAction = function (playerId) { return ({
...
function localPlayer(state, action) {
    ...
    switch (action.type) {
        case localPlayerActionTypes_1.JOIN_COMPLETE:
            return tslib_1.__assign(tslib_1.__assign({}, state), { id: action.payload.playerId, ready: false });
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, effects_1.fork(saga_2.cardShopSagaFactory(definitionProvider, playerId))];
                case 8:
                    _b = _b.concat([
                        _c.sent()
                    ]);
