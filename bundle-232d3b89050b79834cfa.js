    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, effects_1.all(finishMatchTasks)];
            case 4:
                _a.sent();
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (emitReady) {
                        ...
                        sagas.push(effects_1.takeLatest(playerInfo_1.PlayerInfoCommands.CLEAR_OPPONENT_COMMAND, function () {
                            return __generator(this, function (_a) {
                                emitReady(false);
                                return [2 /*return*/];
                            });
...
exports.__esModule = true;
exports.playerMatchRewardsEvent = exports.PLAYER_MATCH_REWARDS_EVENT = exports.playerDeathEvent = exports.clientFinishMatchEvent = exports.CLIENT_FINISH_MATCH_EVENT = exports.afterRerollCardsEvent = exports.afterSellPieceEvent = exports.playerFinishMatchEvent = void 0;
var toolkit_1 = __webpack_require__(/*! @reduxjs/toolkit */ "../gamemode/node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
...
var Player = /** @class */ (function () {
    ...
    Player.prototype.enterPreparingPhase = function () {
        if (!this.getShopLocked()) {
            this.store.dispatch(events_1.afterRerollCardsEvent());
        }
    ...
    Player.prototype.onFinishMatch = function (finalMatchBoard) {
        var _this = this;
        var survivingPieces = board_1.BoardSelectors.getAllPieces(finalMatchBoard).filter(function (p) { return p.currentHealth > 0; });
        var surviving = {
        ...
        var homeScore = surviving.home.length;
        var awayScore = surviving.away.length;
        this.store.dispatch(events_1.playerFinishMatchEvent({ homeScore: homeScore, awayScore: awayScore }));
        this.match = null;
    };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeLatest(events_1.playerFinishMatchEvent.toString(), function (_a) {
                    var win, damage, oldValue, newValue, justDied, currentMoney, streak, _b, total, base, winBonus, streakBonus, interest;
