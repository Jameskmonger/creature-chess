	...
	return (
		<div className={styles.menu}>
			...
			<div className={styles.joinGame}>
				...
				<button onClick={findGame} className={styles.findGameButton}>Find Game</button>
				...
				<div className={styles.blurb}>
					<p>This is a <span>multiplayer strategy game</span> in which you configure creatures on a board.</p>
