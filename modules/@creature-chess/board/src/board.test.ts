...
describe("board", () => {
	...
	describe("getPiecePosition", () => {
		...
		it("should throw error when piece ID does not exist", () => {
			const board = new Board(8, 8);

			expect(() => board.getPiecePosition("nonExistentPiece")).toThrowError();
		});
	});
	...
	describe("removePiece", () => {
		...
		it("should error when removing a non-existent piece", () => {
			const board = new Board(8, 8);

			expect(() => board.removePiece("nonExistentPiece")).toThrowError();
		});
	});
