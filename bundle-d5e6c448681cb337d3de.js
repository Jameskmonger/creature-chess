...
var GameBoard = function (_a) {
    ...
    var _c = __read(React.useState([0, 0]), 2), size = _c[0], setSize = _c[1];
    var isPortrait = size[0] <= size[1];
    ...
    var chessboardStyles = useChessboardStyles({
        width: isPortrait ? "".concat(size[0], "px") : "".concat(size[1], "px"),
        height: isPortrait ? "".concat(size[0], "px") : "100%"
    });
...
/******/ })()
;
//# sourceMappingURL=bundle-d5e6c448681cb337d3de.js.map