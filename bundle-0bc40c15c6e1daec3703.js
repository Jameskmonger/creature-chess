...
var AuthenticatedRootPage = function () {
    var _a = (0, auth0_react_1.useAuth0)(), logout = _a.logout, getAccessTokenSilently = _a.getAccessTokenSilently, getIdTokenClaims = _a.getIdTokenClaims;
    var _b = (0, auth_web_1.useUser)(), user = _b.user, isFetching = _b.isFetching, refresh = _b.refresh;
    if (isFetching) {
        return React.createElement("span", null, "Loading");
    }
    if (!user) {
        return React.createElement("span", null, "an error occured, please tell a dev");
    }
...
exports.auth0Config = {
    ...
    redirectUri: models_1.APP_BASE_URL,
...
exports.__esModule = true;
exports.usePlayerId = exports.GameAuthContextProvider = exports.AuthContextProvider = void 0;
var React = __importStar(__webpack_require__(/*! react */ "../../node_modules/react/index.js"));
var useUser_1 = __webpack_require__(/*! ./useUser */ "../../modules/@creature-chess/auth-web/useUser.ts");
var GameAuthContext = React.createContext({
    user: null
});
GameAuthContext.displayName = "GameAuthContext";
exports.AuthContextProvider = GameAuthContext.Provider;
function GameAuthContextProvider(_a) {
    var children = _a.children;
    var user = (0, useUser_1.useUser)().user;
    return (React.createElement(GameAuthContext.Provider, { value: { user: user || null } }, children));
}
exports.GameAuthContextProvider = GameAuthContextProvider;
var usePlayerId = function () {
    var user = React.useContext(GameAuthContext).user;
    if (!user) {
        return "";
    }
    return user.id;
...
/***/ "../../modules/@creature-chess/auth-web/getCurrentUser.ts":
/*!****************************************************************!*\
  !*** ../../modules/@creature-chess/auth-web/getCurrentUser.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports.__esModule = true;
exports.useUser = exports.usePlayerId = exports.GameAuthContextProvider = exports.AuthContextProvider = exports.AuthProvider = void 0;
...
__createBinding(exports, context_1, "GameAuthContextProvider");
__createBinding(exports, context_1, "usePlayerId");
var useUser_1 = __webpack_require__(/*! ./useUser */ "../../modules/@creature-chess/auth-web/useUser.ts");
__createBinding(exports, useUser_1, "useUser");
...
var AuthProvider = function (_a) {
    ...
    return (react_1["default"].createElement(auth0_react_1.Auth0Provider, { domain: domain, clientId: clientID, redirectUri: config_1.auth0Config.redirectUri, audience: config_1.auth0Config.audience, scope: config_1.auth0Config.scope, cacheLocation: "localstorage", onRedirectCallback: onRedirectCallback, useRefreshTokens: true },
        react_1["default"].createElement(context_1.GameAuthContextProvider, null, children)));
};
...
/***/ "../../modules/@creature-chess/auth-web/useUser.ts":
/*!*********************************************************!*\
  !*** ../../modules/@creature-chess/auth-web/useUser.ts ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var react_1 = __importDefault(__webpack_require__(/*! react */ "../../node_modules/react/index.js"));
var auth0_react_1 = __webpack_require__(/*! @auth0/auth0-react */ "../../node_modules/@auth0/auth0-react/dist/auth0-react.esm.js");
var getCurrentUser_1 = __webpack_require__(/*! ./getCurrentUser */ "../../modules/@creature-chess/auth-web/getCurrentUser.ts");
/**
...
function useUser() {
    var _this = this;
    var _a = (0, auth0_react_1.useAuth0)(), auth0User = _a.user, getAccessTokenSilently = _a.getAccessTokenSilently;
    var _b = __read(react_1["default"].useState(null), 2), currentUser = _b[0], setCurrentUser = _b[1];
    var _c = __read(react_1["default"].useState(false), 2), isFetching = _c[0], setIsFetching = _c[1];
    var _d = __read(react_1["default"].useState(null), 2), error = _d[0], setError = _d[1];
    var _e = __read(react_1["default"].useState(true), 2), shouldRefresh = _e[0], setShouldRefresh = _e[1];
    ...
    react_1["default"].useEffect(function () {
        var getUser = function () { return __awaiter(_this, void 0, void 0, function () {
            var token, response, message, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!auth0User) {
                    ...
                    case 1:
                        token = _a.sent();
                        return [4 /*yield*/, (0, getCurrentUser_1.getCurrentUser)(token)];
                    case 2:
                        response = _a.sent();
                        setIsFetching(false);
    ...
    return { user: currentUser, isFetching: isFetching, error: error, refresh: refresh };
}
...
var _a;
exports.__esModule = true;
exports.PIECES_FOR_STAGE = exports.AVAILABLE_PROFILE_PICTURES = exports.LOBBY_WAIT_TIME = exports.MAX_PLAYERS_IN_GAME = exports.MAX_NAME_LENGTH = exports.DEFAULT_TURN_DURATION = exports.DEFAULT_TURN_COUNT = exports.PIECES_TO_EVOLVE = exports.BUY_XP_AMOUNT = exports.BUY_XP_COST = exports.HEALTH_LOST_PER_PIECE = exports.MAX_PLAYER_LEVEL = exports.STARTING_HEALTH = exports.STARTING_LEVEL = exports.STARTING_MONEY = exports.REROLL_COST = exports.PHASE_LENGTHS = exports.BENCH_SLOT_COUNT = exports.GRID_SIZE = exports.IMAGE_BASE_URL = exports.APP_BASE_URL = void 0;
var game_phase_1 = __webpack_require__(/*! ./game-phase */ "../../modules/@creature-chess/models/src/game-phase.ts");
exports.APP_BASE_URL = "https://creaturechess.com/";
...
var NO_PLAYER_IMAGE = "".concat(models_1.IMAGE_BASE_URL, "/ui/no_player_img.png");
...
var react_jss_1 = __webpack_require__(/*! react-jss */ "../../node_modules/react-jss/dist/react-jss.esm.js");
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../../modules/@creature-chess/models/index.ts");
var creatureImage_1 = __webpack_require__(/*! ../../../../src/display/creatureImage */ "../../modules/@creature-chess/ui/src/display/creatureImage.tsx");
var BaseRegistrationInput_1 = __webpack_require__(/*! ./BaseRegistrationInput */ "../../modules/@creature-chess/ui/pages/menu/registration/input/BaseRegistrationInput.tsx");
var useStyles = (0, react_jss_1.createUseStyles)({
    pictureList: {
...
var MatchPiece = function () {
    ...
    var runAnimations = React.useCallback(function (newPiece) {
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../../modules/@creature-chess/models/index.ts");
var layout_1 = __webpack_require__(/*! ../../layout */ "../../modules/@creature-chess/ui/layout/index.ts");
var STAR = "".concat(models_1.IMAGE_BASE_URL, "/ui/star.svg");
...
var Footer = function () {
    ...
    return (React.createElement("div", { className: classes.footer },
        ...
        " - ",
        React.createElement("a", { className: classes.item, href: "".concat(models_1.APP_BASE_URL, "privacy") }, "Privacy Policy"),
        " - ",
...
var Countdown = function (_a) {
    ...
    var updateSecondsRemaining = React.useCallback(function () {
...
function getIconUrl(iconName) {
    return "".concat(models_1.IMAGE_BASE_URL, "/ui/").concat(iconName);
}
var ICON_FOR_TYPE = (_a = {},
    _a[models_1.CreatureType.Fire] = getIconUrl("type-fire.svg"),
    _a[models_1.CreatureType.Earth] = getIconUrl("type-earth.svg"),
    _a[models_1.CreatureType.Metal] = getIconUrl("type-metal.svg"),
    _a[models_1.CreatureType.Water] = getIconUrl("type-water.svg"),
    _a[models_1.CreatureType.Wood] = getIconUrl("type-wood.svg"),
    _a);
...
function getCreatureUrl(facing, definitionId) {
    return "".concat(models_1.IMAGE_BASE_URL, "/creatures/").concat(facing, "/").concat(definitionId, ".png");
}
...
function getCreatureUrl(definitionId) {
    return "".concat(models_1.IMAGE_BASE_URL, "/creatures/front/").concat(definitionId, ".png");
}
...
/******/ })()
;
//# sourceMappingURL=bundle-0bc40c15c6e1daec3703.js.map