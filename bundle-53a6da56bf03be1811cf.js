...
var BoardPieces = function (props) {
    ...
    try {
        for (var _b = __values(Object.entries(pieces)), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            pieceElements.push(React.createElement(positionablePiece_1.PositionablePiece, { id: id, x: x, y: y, draggable: inPreparingPhase, animate: !inPreparingPhase, selected: selected }));
        }
    }
...
exports.gameSaga = function (playerId, socket) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 14: return [4 /*yield*/, _a.apply(void 0, [_b.concat([
                        _c.sent()
                    ])])];
            case 15:
                _c.sent();
...
var HeadToHeadOpponentProvider = /** @class */ (function () {
    ...
    HeadToHeadOpponentProvider.prototype.getMatchupsEven = function (playerIds) {
        ...
        var _loop_1 = function () {
            ...
            if (playerA === playerB) {
                console.log(JSON.stringify({ playerA: playerA, rotation: rotation, remainingPlayers: remainingPlayerIds }, null, 4));
            }
...
var RoundRobinOpponentProvider = /** @class */ (function () {
    ...
    RoundRobinOpponentProvider.prototype.getMatchups = function () {
        ...
        var output = this.players.map(function (player, index) {
            ...
            if (!opponent) {
                console.log("BIG WARNING! NO OPPONENT FOUND!", index, _this.rotation, _this.players.length, _this.remainingRotations.length);
            }
