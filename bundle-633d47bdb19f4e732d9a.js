...
/***/ "../shared/board/utils/mergeBoards.ts":
/*!********************************************!*\
  !*** ../shared/board/utils/mergeBoards.ts ***!
  \********************************************/
/*! no static exports found */
...
var rotateGridPosition = function (gridSize, position) {
    return position_1.createTileCoordinates(gridSize.width - 1 - position.x, gridSize.height - 1 - position.y);
};
var transformAwayPieces = function (gridSize, pieces) {
    return Object.entries(pieces).reduce(function (acc, _a) {
        ...
        var _b = tslib_1.__read(_a, 2), pieceId = _b[0], piece = _b[1];
        acc[pieceId] = tslib_1.__assign(tslib_1.__assign({}, piece), { facingAway: false, position: rotateGridPosition(gridSize, piece.position) });
        return acc;
    }, {});
};
exports.mergeBoards = function (gridSize, home, away) {
    var transformedAway = transformAwayPieces(gridSize, away);
    return tslib_1.__assign(tslib_1.__assign({}, home), transformedAway);
};


/***/ }),

/***/ "../shared/cardShop/cardDeck.ts":
/*!**************************************!*\
  !*** ../shared/cardShop/cardDeck.ts ***!
  \**************************************/
/*! no static exports found */
...
var CardDeck = /** @class */ (function () {
    ...
    CardDeck.prototype.addCards = function (cards) {
        ...
        try {
            for (var cardsToAdd_1 = tslib_1.__values(cardsToAdd), cardsToAdd_1_1 = cardsToAdd_1.next(); !cardsToAdd_1_1.done; cardsToAdd_1_1 = cardsToAdd_1.next()) {
    ...
    CardDeck.prototype.addPiece = function (piece) {
        ...
        var cardCount = (piece.stage + 1) * constants_1.PIECES_TO_EVOLVE;
...
var delay_1 = __webpack_require__(/*! delay */ "../../node_modules/delay/index.js");
var game_phase_1 = __webpack_require__(/*! @creature-chess/models/src/game-phase */ "../models/src/game-phase.ts");
var opponentProvider_1 = __webpack_require__(/*! ./opponentProvider */ "../shared/game/opponentProvider.ts");
var cardDeck_1 = __webpack_require__(/*! ../cardShop/cardDeck */ "../shared/cardShop/cardDeck.ts");
var log_1 = __webpack_require__(/*! ../log */ "../shared/log.ts");
var constants_1 = __webpack_require__(/*! @creature-chess/models/src/constants */ "../models/src/constants.ts");
var events_1 = __webpack_require__(/*! events */ "../../node_modules/events/events.js");
var playerList_1 = __webpack_require__(/*! ./playerList */ "../shared/game/playerList.ts");
var turnSimulator_1 = __webpack_require__(/*! ../match/combat/turnSimulator */ "../shared/match/combat/turnSimulator.ts");
var definitionProvider_1 = __webpack_require__(/*! ./definitionProvider */ "../shared/game/definitionProvider.ts");
...
var store_1 = __webpack_require__(/*! ./store/store */ "../shared/game/store/store.ts");
var actions_1 = __webpack_require__(/*! ./store/actions */ "../shared/game/store/actions.ts");
var options_1 = __webpack_require__(/*! ./options */ "../shared/game/options.ts");
...
(function (GameEvents) {
    ...
    GameEvents["PLAYER_DEATH"] = "PLAYER_DEATH";
    GameEvents["PLAYER_QUIT"] = "PLAYER_QUIT";
...
var Game = /** @class */ (function () {
    function Game(players, options) {
        ...
        this.playerQuitGame = function (player) {
            _this.events.emit(GameEvents.PLAYER_QUIT, player);
        };
        this.startGame = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var startTime, startTimeMs, livingPlayers, duration, winner, gamePlayers;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        livingPlayers = this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.isAlive(); });
                    ...
                    case 5:
                        ...
                        winner = this.players.find(function (p) { return p.isAlive(); });
        ...
        var livingPlayers = this.players.filter(function (p) { return p.isAlive(); });
        ...
        this.turnSimulator = new turnSimulator_1.TurnSimulator();
    ...
    Game.prototype.getCurrentGamePhaseUpdateForPlayer = function (player) {
        var _a = this.store.getState(), round = _a.round, phase = _a.phase, phaseStartedAtSeconds = _a.phaseStartedAtSeconds;
        switch (phase) {
            case game_phase_1.GamePhase.DEAD:
                return {
                    startedAtSeconds: phaseStartedAtSeconds,
                    phase: phase
                };
            case game_phase_1.GamePhase.PREPARING:
                return {
                    startedAtSeconds: phaseStartedAtSeconds,
                    phase: phase,
                    payload: {
            ...
            case game_phase_1.GamePhase.PLAYING:
            default:
                return null;
        }
    };
    ...
    Game.prototype.onPlayerDeath = function (fn) {
        this.events.on(GameEvents.PLAYER_DEATH, fn);
    };
    Game.prototype.onPlayerQuit = function (fn) {
    ...
    Game.prototype.runPreparingPhase = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var round, _a, newPhaseStartedAt, newRound, promises;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        round = this.store.getState().round;
                        this.store.dispatch(actions_1.preparingPhaseStarted(round + 1, Date.now() / 1000));
                        this.players.forEach(function (p) { return p.reset(); });
                        _a = this.store.getState(), newPhaseStartedAt = _a.phaseStartedAtSeconds, newRound = _a.round;
                        promises = this.players
                            .filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT; })
                            .map(function (p) { return p.enterPreparingPhase(newPhaseStartedAt, newRound); });
                        return [4 /*yield*/, Promise.race([
                                Promise.all(promises),
                                delay_1["default"](this.options.phaseLengths[game_phase_1.GamePhase.PREPARING] * 1000)
                            ])];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
    ...
    Game.prototype.updateLivingPlayers = function () {
        var livingPlayers = this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.isAlive(); });
    ...
    Game.prototype.runReadyPhase = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var newPhaseStartedAt;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.store.dispatch(actions_1.gamePhaseStarted(game_phase_1.GamePhase.READY, Date.now() / 1000));
                        this.updateLivingPlayers();
                        newPhaseStartedAt = this.store.getState().phaseStartedAtSeconds;
                        this.players
                            .filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT; })
                            .forEach(function (p) { return p.enterReadyPhase(_this.turnSimulator, _this.opponentProvider, newPhaseStartedAt); });
                        return [4 /*yield*/, delay_1["default"](this.options.phaseLengths[game_phase_1.GamePhase.READY] * 1000)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Game.prototype.runPlayingPhase = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.store.dispatch(actions_1.gamePhaseStarted(game_phase_1.GamePhase.PLAYING, Date.now() / 1000));
                        this.opponentProvider.updateRotation();
                        return [4 /*yield*/, this.fightBattles()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Game.prototype.fightBattles = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var maxTimeMs, battleTimeoutDeferred, livingPlayers, _a, round, newPhaseStartedAt, promises, newLivingPlayers, justDiedPlayers, justDiedPlayers_1, justDiedPlayers_1_1, player, justDiedPlayerIds, _b, _c, player, _d, _e, player, _f, _g, player;
            var e_1, _h, e_2, _j, e_3, _k, e_4, _l;
            return tslib_1.__generator(this, function (_m) {
                switch (_m.label) {
                    case 0:
                        maxTimeMs = this.options.phaseLengths[game_phase_1.GamePhase.PLAYING] * 1000;
                        battleTimeoutDeferred = pDefer();
                        delay_1["default"](maxTimeMs).then(function () { return battleTimeoutDeferred.resolve(); });
                        livingPlayers = this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.isAlive(); });
                        _a = this.store.getState(), round = _a.round, newPhaseStartedAt = _a.phaseStartedAtSeconds;
                        promises = livingPlayers.map(function (p) { return p.fightMatch(newPhaseStartedAt, battleTimeoutDeferred); });
                        return [4 /*yield*/, Promise.all(promises)];
                    case 1:
                        _m.sent();
                        newLivingPlayers = this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.isAlive(); });
                        if (newLivingPlayers.length === 0) {
                            ...
                            try {
                                for (justDiedPlayers_1 = tslib_1.__values(justDiedPlayers), justDiedPlayers_1_1 = justDiedPlayers_1.next(); !justDiedPlayers_1_1.done; justDiedPlayers_1_1 = justDiedPlayers_1.next()) {
                                    player = justDiedPlayers_1_1.value;
                                    player.resurrect(constants_1.RESURRECT_HEALTH);
                                }
                            }
                            catch (e_1_1) { e_1 = { error: e_1_1 }; }
                            finally {
                                try {
                                    if (justDiedPlayers_1_1 && !justDiedPlayers_1_1.done && (_h = justDiedPlayers_1["return"])) _h.call(justDiedPlayers_1);
                                }
                                finally { if (e_1) throw e_1.error; }
                            }
                            justDiedPlayerIds = justDiedPlayers.map(function (p) { return p.id; });
                            try {
                                for (_b = tslib_1.__values(this.players), _c = _b.next(); !_c.done; _c = _b.next()) {
                                    player = _c.value;
                        ...
                        try {
                            for (_d = tslib_1.__values(this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.getRoundDiedAt() === round; })), _e = _d.next(); !_e.done; _e = _d.next()) {
                                player = _e.value;
                                player.kill();
                    ...
                    case 2:
                        ...
                        _m.sent();
                        try {
                            for (_f = tslib_1.__values(this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.isAlive(); })), _g = _f.next(); !_g.done; _g = _f.next()) {
                                player = _g.value;
...
exports.__esModule = true;
var game_1 = __webpack_require__(/*! ./game */ "../shared/game/game.ts");
__createBinding(exports, game_1, "Game");
var player_1 = __webpack_require__(/*! ./player/player */ "../shared/game/player/player.ts");
__createBinding(exports, player_1, "Player");
var reducer_1 = __webpack_require__(/*! ./store/reducer */ "../shared/game/store/reducer.ts");
__createBinding(exports, reducer_1, "reducer", "gameReducer");


/***/ }),

/***/ "../shared/game/opponentProvider.ts":
/*!******************************************!*\
  !*** ../shared/game/opponentProvider.ts ***!
  \******************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.playerFinishMatch = exports.PLAYER_FINISH_MATCH = void 0;
...
/***/ "../shared/game/player/matchRewards.ts":
/*!*********************************************!*\
  !*** ../shared/game/player/matchRewards.ts ***!
  \*********************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.getMoneyForMatch = void 0;
...
exports.getMoneyForMatch = function (currentMoney, streak, win) {
    var base = 3;
...
var match_1 = __webpack_require__(/*! ../../match/match */ "../shared/match/match.ts");
var log_1 = __webpack_require__(/*! ../../log */ "../shared/log.ts");
var events_1 = __webpack_require__(/*! events */ "../../node_modules/events/events.js");
var constants_1 = __webpack_require__(/*! @creature-chess/models/src/constants */ "../models/src/constants.ts");
var utils_1 = __webpack_require__(/*! ../../utils */ "../shared/utils/index.ts");
...
var store_1 = __webpack_require__(/*! ../../player/store */ "../shared/player/store.ts");
var playerInfo_1 = __webpack_require__(/*! ../../player/playerInfo */ "../shared/player/playerInfo/index.ts");
var playerSelectors_1 = __webpack_require__(/*! ../../player/playerSelectors */ "../shared/player/playerSelectors.ts");
var benchActions_1 = __webpack_require__(/*! packages/shared/player/bench/benchActions */ "../shared/player/bench/benchActions.ts");
var boardActions_1 = __webpack_require__(/*! packages/shared/board/actions/boardActions */ "../shared/board/actions/boardActions.ts");
var matchRewards_1 = __webpack_require__(/*! ./matchRewards */ "../shared/game/player/matchRewards.ts");
var health_1 = __webpack_require__(/*! packages/shared/player/sagas/health */ "../shared/player/sagas/health.ts");
var actions_1 = __webpack_require__(/*! packages/shared/player/actions */ "../shared/player/actions.ts");
var streak_1 = __webpack_require__(/*! ./sagas/streak */ "../shared/game/player/sagas/streak.ts");
var playerPropertyUpdates_1 = __webpack_require__(/*! ./sagas/playerPropertyUpdates */ "../shared/game/player/sagas/playerPropertyUpdates.ts");
var actions_2 = __webpack_require__(/*! ./actions */ "../shared/game/player/actions.ts");
var xp_1 = __webpack_require__(/*! packages/shared/player/sagas/xp */ "../shared/player/sagas/xp.ts");
var battle_1 = __webpack_require__(/*! ./sagas/battle */ "../shared/game/player/sagas/battle.ts");
var PlayerEvent;
...
var Player = /** @class */ (function () {
    function Player(id, name) {
        ...
        this.sellPiece = function (pieceId) {
            // todo add `from` here to improve lookup
            var piece = pieceSelectors_1.getPiece(_this.store.getState(), pieceId);
            if (piece === null) {
                log_1.log(_this.name + " attempted to sell piece with id " + pieceId + " but did not own it");
                return;
            }
            var piecesUsed = utils_1.getPiecesForStage(piece.stage);
            var pieceCost = _this.definitionProvider.get(piece.definitionId).cost;
            _this.addMoney(pieceCost * piecesUsed);
            _this.deck.addPiece(piece);
            _this.deck.shuffle();
            _this.store.dispatch(benchActions_1.removeBenchPiece(pieceId));
            _this.store.dispatch(boardActions_1.removeBoardPiece(pieceId));
        };
        this.buyXp = function () {
            // todo put this all into a saga
            if (playerSelectors_1.isPlayerAlive(_this.store.getState()) === false) {
                log_1.log(_this.name + " attempted to buy xp, but they are dead");
                return;
            }
            if (_this.getLevel() === constants_1.MAX_PLAYER_LEVEL) {
                log_1.log(_this.name + " attempted to buy xp, but they are at max level");
                return;
            }
            var money = _this.store.getState().playerInfo.money;
            // not enough money
            if (money < constants_1.BUY_XP_COST) {
                log_1.log(_this.name + " attempted to buy xp costing $" + constants_1.BUY_XP_COST + " but only had $" + money);
                return;
            }
            _this.store.dispatch(xp_1.addXpCommand(constants_1.BUY_XP_AMOUNT));
            _this.store.dispatch(playerInfo_1.moneyUpdateAction(money - constants_1.BUY_XP_COST));
        };
        this.buyReroll = function () {
            if (playerSelectors_1.isPlayerAlive(_this.store.getState()) === false) {
                log_1.log(_this.name + " attempted to reroll, but they are dead");
                return;
            }
            var money = _this.store.getState().playerInfo.money;
            // not enough money
            if (money < constants_1.REROLL_COST) {
                log_1.log(_this.name + " attempted to reroll costing $" + constants_1.REROLL_COST + " but only had $" + money);
                return;
            }
            _this.rerollCards();
            _this.store.dispatch(playerInfo_1.moneyUpdateAction(money - constants_1.REROLL_COST));
        };
        ...
        streak_1.playerStreak(this.sagaMiddleware);
        battle_1.playerBattle(this.sagaMiddleware);
        this.propertyUpdateRegistry = playerPropertyUpdates_1.createPropertyUpdateRegistry(this.sagaMiddleware);
    }
    ...
    Player.prototype.setGameOptions = function (options) {
    ...
    Player.prototype.addMoney = function (money) {
        var currentMoney = this.store.getState().playerInfo.money;
        this.store.dispatch(playerInfo_1.moneyUpdateAction(currentMoney + money));
    };
    ...
    Player.prototype.enterPreparingPhase = function (startedAtSeconds, round) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.store.dispatch(playerInfo_1.clearOpponent());
                        this.store.dispatch(benchActions_1.unlockBench());
                        this.onEnterPreparingPhase(startedAtSeconds, round);
                        if (playerSelectors_1.isPlayerAlive(this.store.getState()) === false) {
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, this.readyUpDeferred.promise];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Player.prototype.enterReadyPhase = function (turnSimulator, opponentProvider, startedAt) {
        this.readyUpDeferred = null;
        if (playerSelectors_1.isPlayerAlive(this.store.getState())) {
            this.store.dispatch(benchActions_1.lockBench());
            var opponent = opponentProvider.getOpponent(this.id);
            this.store.dispatch(playerInfo_1.setOpponent(opponent.id));
            this.match = new match_1.Match(turnSimulator, this.gameOptions.turnCount, this.gameOptions.turnDuration, this, opponent);
            this.onEnterReadyPhase(startedAt);
        }
    };
    Player.prototype.fightMatch = function (startedAt, battleTimeout) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var finalMatchBoard, pieces, surviving, homeScore, awayScore, damage, win;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        damage = awayScore * 3;
                        this.store.dispatch(health_1.subtractHealthCommand(this.currentRound, damage));
                        win = homeScore > awayScore;
                        this.wonLastMatch = win;
                        this.store.dispatch(actions_2.playerFinishMatch(homeScore, awayScore));
                        return [2 /*return*/, {
                                homePlayer: this,
    ...
    Player.prototype.giveMatchRewards = function () {
        var money = matchRewards_1.getMoneyForMatch(this.getMoney(), this.store.getState().playerInfo.streak.amount, this.wonLastMatch);
        this.addMoney(money);
        this.store.dispatch(xp_1.addXpCommand(1));
        this.wonLastMatch = false;
    };
    Player.prototype.onQuitGame = function (fn) {
        this.events.on(PlayerEvent.QUIT_GAME, fn);
    };
    Player.prototype.rerollCards = function () {
        if (playerSelectors_1.isPlayerAlive(this.store.getState()) === false) {
            return;
        }
        var cards = this.store.getState().playerInfo.cards;
        var newCards = this.deck.reroll(cards, this.getLevel(), 5);
        this.store.dispatch(playerInfo_1.cardsUpdated(newCards));
    };
    Player.prototype.clearPieces = function () {
        var e_1, _a;
        var pieces = pieceSelectors_1.getAllPieces(this.store.getState());
        this.store.dispatch(boardActions_1.initialiseBoard({}));
        // todo this is ugly
        this.store.dispatch(benchActions_1.initialiseBench({
            pieces: [],
        ...
        var cards = this.store.getState().playerInfo.cards;
        this.store.dispatch(playerInfo_1.cardsUpdated([]));
    ...
    Player.prototype.resurrect = function (startingHealth) {
        this.store.dispatch(playerInfo_1.roundDiedAtUpdated(null));
        this.store.dispatch(playerInfo_1.healthUpdated(startingHealth));
    };
    ...
    Player.prototype.getGameState = function () {
        var _a = this.store.getState(), board = _a.board, bench = _a.bench, _b = _a.playerInfo, money = _b.money, cards = _b.cards, level = _b.level, xp = _b.xp;
        return {
            board: board.pieces,
            bench: bench,
            cards: cards,
    ...
    Player.prototype.quitGame = function () {
        this.store.dispatch(playerInfo_1.statusUpdated(player_list_player_1.PlayerStatus.QUIT));
        // todo combine these
    ...
    Player.prototype.readyUpSaga = function () {
        var _this = this;
        var getReadyUpDeferred = function () { return _this.readyUpDeferred; };
        return function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, effects_1.takeEvery(actions_1.READY_UP, function () {
                            var deferred;
                            return tslib_1.__generator(this, function (_a) {
                                deferred = getReadyUpDeferred();
                                if (deferred) {
                                    deferred.resolve();
                                }
                                return [2 /*return*/];
...
/***/ "../shared/game/player/sagas/battle.ts":
/*!*********************************************!*\
  !*** ../shared/game/player/sagas/battle.ts ***!
  \*********************************************/
/*! no static exports found */
...
var tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.js");
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../../node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
var playerInfo_1 = __webpack_require__(/*! packages/shared/player/playerInfo */ "../shared/player/playerInfo/index.ts");
var player_list_player_1 = __webpack_require__(/*! @creature-chess/models/src/player-list-player */ "../models/src/player-list-player.ts");
var actions_1 = __webpack_require__(/*! ../actions */ "../shared/game/player/actions.ts");
    ...
    sagaMiddleware.run(function () {
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = effects_1.all;
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.SET_OPPONENT, function (_a) {
                            var opponentId = _a.payload.opponentId;
                            return tslib_1.__generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, effects_1.put(playerInfo_1.battleUpdated(player_list_player_1.inProgressBattle(opponentId)))];
                                    case 1:
                                        _b.sent();
                                        return [2 /*return*/];
                                }
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(actions_1.PLAYER_FINISH_MATCH, function (_a) {
                            ...
                            return tslib_1.__generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        opponentId = _c.sent();
                                        return [4 /*yield*/, effects_1.put(playerInfo_1.battleUpdated(player_list_player_1.finishedBattle(opponentId, homeScore, awayScore)))];
                                    case 2:
                                        _c.sent();
                                        return [2 /*return*/];
                                }
...
/***/ "../shared/game/player/sagas/playerPropertyUpdates.ts":
/*!************************************************************!*\
  !*** ../shared/game/player/sagas/playerPropertyUpdates.ts ***!
  \************************************************************/
/*! no static exports found */
...
var events_1 = __webpack_require__(/*! events */ "../../node_modules/events/events.js");
var playerInfo_1 = __webpack_require__(/*! ../../../player/playerInfo */ "../shared/player/playerInfo/index.ts");
var actions_1 = __webpack_require__(/*! ../../../player/actions */ "../shared/player/actions.ts");
...
exports.createPropertyUpdateRegistry = function (sagaMiddleware) {
    ...
    sagaMiddleware.run(function () {
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = effects_1.all;
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.HEALTH_UPDATED, function (_a) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.STREAK_UPDATED, function (_a) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.STATUS_UPDATED, function (_a) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.BATTLE_UPDATED, function (_a) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.CLEAR_OPPONENT, function () {
                            return tslib_1.__generator(this, function (_a) {
    ...
    return {
        ...
        onReadyUpdate: function (fn) {
            return events.on(PlayerPropertyUpdateEvent.UPDATE_READY, fn);
        },
...
/***/ "../shared/game/player/sagas/streak.ts":
/*!*********************************************!*\
  !*** ../shared/game/player/sagas/streak.ts ***!
  \*********************************************/
/*! no static exports found */
                        ...
                        return tslib_1.__generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, effects_1.put(playerInfo_1.streakUpdated(type, newAmount))];
                                case 2:
                                    _c.sent();
                                    return [2 /*return*/];
                            }
...
var PlayerList = /** @class */ (function () {
    ...
    PlayerList.prototype.getValue = function () {
        return this.players;
    };
...
var tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.js");
var actions_1 = __webpack_require__(/*! ./actions */ "../shared/game/store/actions.ts");
    ...
    switch (action.type) {
        case actions_1.GAME_PHASE_STARTED:
            if (action.payload.round) {
                return tslib_1.__assign(tslib_1.__assign({}, state), { phase: action.payload.phase, phaseStartedAtSeconds: Math.floor(action.payload.startedAt), round: action.payload.round });
            }
            return tslib_1.__assign(tslib_1.__assign({}, state), { phase: action.payload.phase, phaseStartedAtSeconds: Math.floor(action.payload.startedAt) });
        default:
            return state;
    }
}
...
var redux_1 = __webpack_require__(/*! redux */ "../../node_modules/redux/es/redux.js");
var reducer_1 = __webpack_require__(/*! ./reducer */ "../shared/game/store/reducer.ts");
...
var redux_1 = __webpack_require__(/*! redux */ "../../node_modules/redux/es/redux.js");
var redux_saga_1 = __webpack_require__(/*! redux-saga */ "../../node_modules/redux-saga/dist/redux-saga-core-npm-proxy.esm.js");
var battleSaga_1 = __webpack_require__(/*! ./combat/battleSaga */ "../shared/match/combat/battleSaga.ts");
var board_1 = __webpack_require__(/*! ../board */ "../shared/board/index.ts");
var battleEventChannel_1 = __webpack_require__(/*! ./combat/battleEventChannel */ "../shared/match/combat/battleEventChannel.ts");
var mergeBoards_1 = __webpack_require__(/*! ../board/utils/mergeBoards */ "../shared/board/utils/mergeBoards.ts");
var constants_1 = __webpack_require__(/*! @creature-chess/models/src/constants */ "../models/src/constants.ts");
var Match = /** @class */ (function () {
    function Match(turnSimulator, turnCount, turnDuration, home, away) {
        ...
        var board = mergeBoards_1.mergeBoards(constants_1.GRID_SIZE, home.getBoard().pieces, away.getBoard().pieces);
    ...
    Match.prototype.fight = function (battleTimeout) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.store.dispatch(battleSaga_1.startBattle());
                        return [4 /*yield*/, Promise.race([
                                battleTimeout,
        ...
        var rootSaga = function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = effects_1.all;
                        return [4 /*yield*/, effects_1.fork(battleSaga_1.battle, _this.turnSimulator, _this.turnCount, _this.turnDuration)];
                    case 1:
                        _b = [
                            _c.sent()
                        ];
                        return [4 /*yield*/, effects_1.takeEvery(battleEventChannel_1.BATTLE_FINISHED, function () {
                                return tslib_1.__generator(this, function (_a) {
...
/***/ "../shared/networking/server-to-client-lobby.ts":
/*!******************************************************!*\
  !*** ../shared/networking/server-to-client-lobby.ts ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "../shared/player/playerInfo/actions.ts":
/*!**********************************************!*\
  !*** ../shared/player/playerInfo/actions.ts ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "../shared/player/playerInfo/index.ts":
/*!********************************************!*\
  !*** ../shared/player/playerInfo/index.ts ***!
  \********************************************/
/*! no static exports found */
...
exports.__esModule = true;
var tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.js");
tslib_1.__exportStar(__webpack_require__(/*! ./actions */ "../shared/player/playerInfo/actions.ts"), exports);
var reducer_1 = __webpack_require__(/*! ./reducer */ "../shared/player/playerInfo/reducer.ts");
tslib_1.__createBinding(exports, reducer_1, "playerInfoReducer");


/***/ }),

/***/ "../shared/player/playerInfo/reducer.ts":
/*!**********************************************!*\
  !*** ../shared/player/playerInfo/reducer.ts ***!
  \**********************************************/
/*! no static exports found */
...
var tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.js");
var actions_1 = __webpack_require__(/*! ./actions */ "../shared/player/playerInfo/actions.ts");
var constants_1 = __webpack_require__(/*! @creature-chess/models/src/constants */ "../models/src/constants.ts");
var actions_2 = __webpack_require__(/*! ../actions */ "../shared/player/actions.ts");
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/src/index.ts");
var player_list_player_1 = __webpack_require__(/*! @creature-chess/models/src/player-list-player */ "../models/src/player-list-player.ts");
var initialState = {
    status: player_list_player_1.PlayerStatus.CONNECTED,
    health: constants_1.STARTING_HEALTH,
    roundDiedAt: null,
    streak: {
...
function playerInfoReducer(state, action) {
    ...
    switch (action.type) {
        case actions_1.STATUS_UPDATED:
            {
                return tslib_1.__assign(tslib_1.__assign({}, state), { status: action.payload.status });
            }
            ;
        case actions_1.BATTLE_UPDATED:
            {
                return tslib_1.__assign(tslib_1.__assign({}, state), { battle: action.payload.battle });
            }
            ;
        case actions_1.HEALTH_UPDATED: {
            return tslib_1.__assign(tslib_1.__assign({}, state), { health: action.payload.health });
        }
        case actions_1.STREAK_UPDATED: {
            return tslib_1.__assign(tslib_1.__assign({}, state), { streak: {
                    amount: action.payload.amount,
                    type: action.payload.type
                } });
        }
        case actions_1.ROUND_DIED_AT_UPDATED: {
            return tslib_1.__assign(tslib_1.__assign({}, state), { roundDiedAt: action.payload.roundDiedAt });
        }
        case actions_1.CARDS_UPDATED:
            return tslib_1.__assign(tslib_1.__assign({}, state), { cards: action.payload.cards });
        ...
        case actions_1.SET_OPPONENT:
            return tslib_1.__assign(tslib_1.__assign({}, state), { opponentId: action.payload.opponentId, ready: false });
        case actions_1.CLEAR_OPPONENT:
            return tslib_1.__assign(tslib_1.__assign({}, state), { opponentId: null });
...
/***/ "../shared/player/sagas/cardShop.ts":
/*!******************************************!*\
  !*** ../shared/player/sagas/cardShop.ts ***!
  \******************************************/
/*! no static exports found */
...
var playerInfo_1 = __webpack_require__(/*! ../playerInfo */ "../shared/player/playerInfo/index.ts");
var log_1 = __webpack_require__(/*! ../../log */ "../shared/log.ts");
                        ...
                        return tslib_1.__generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 4:
                                    _b.sent();
                                    _b.label = 5;
                                case 5: return [4 /*yield*/, effects_1.put(playerInfo_1.moneyUpdateAction(money - card.cost))];
                                case 6:
                                    _b.sent();
                                    return [4 /*yield*/, effects_1.put(playerInfo_1.cardsUpdated(remainingCards))];
                                case 7:
                                    _b.sent();
                                    return [2 /*return*/];
                            }
...
/***/ "../shared/player/sagas/fillBoard.ts":
/*!*******************************************!*\
  !*** ../shared/player/sagas/fillBoard.ts ***!
  \*******************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.fillBoardSagaFactory = void 0;
var tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.js");
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../../node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
var actions_1 = __webpack_require__(/*! packages/shared/game/store/actions */ "../shared/game/store/actions.ts");
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/src/index.ts");
var playerSelectors_1 = __webpack_require__(/*! ../playerSelectors */ "../shared/player/playerSelectors.ts");
var actions_2 = __webpack_require__(/*! ../actions */ "../shared/player/actions.ts");
exports.fillBoardSagaFactory = function () {
    return function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeEvery(actions_1.GAME_PHASE_STARTED, function (_a) {
                        var isAlive, state, belowPieceLimit, benchPiece, destination, fromLocation, toLocation;
                        var phase = _a.payload.phase;
                        return tslib_1.__generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    if (phase !== models_1.GamePhase.READY) {
                                        return [2 /*return*/];
                                    }
                                ...
                                case 3:
                                    state = _b.sent();
                                    belowPieceLimit = playerSelectors_1.getPlayerBelowPieceLimit(state, this.id);
                                    if (!belowPieceLimit) {
                                        return [2 /*return*/];
                                    }
                                    ...
                                    return [4 /*yield*/, effects_1.put(actions_2.playerDropPiece(benchPiece.id, fromLocation, toLocation))];
                                case 4:
                                    _b.sent();
                                    return [3 /*break*/, 2];
                            ...
                            return tslib_1.__generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, effects_1.put(playerInfo_1.healthUpdated(newValue))];
                                    case 2:
                                        _c.sent();
                                        if (!(newValue === 0 && oldValue !== 0)) return [3 /*break*/, 4];
                                        // player has just died
                                        return [4 /*yield*/, effects_1.put(playerInfo_1.roundDiedAtUpdated(currentRound))];
                                    case 3:
                                        // player has just died
                                        _c.sent();
                                        _c.label = 4;
...
exports.xpSagaFactory = function () {
    return function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeEvery(ADD_XP_COMMAND, function (_a) {
                        ...
                        return tslib_1.__generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 2:
                                    ...
                                    return [4 /*yield*/, effects_1.put(playerInfo_1.setLevelAction(level, xp))];
                                case 3:
                                    _b.sent();
                                    return [2 /*return*/];
                            }
...
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../../node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
var board_1 = __webpack_require__(/*! ../board */ "../shared/board/index.ts");
var evolution_1 = __webpack_require__(/*! ./sagas/evolution */ "../shared/player/sagas/evolution.ts");
var dropPiece_1 = __webpack_require__(/*! ./sagas/dropPiece */ "../shared/player/sagas/dropPiece.ts");
var bench_1 = __webpack_require__(/*! ./bench */ "../shared/player/bench/index.ts");
var cardShop_1 = __webpack_require__(/*! ./sagas/cardShop */ "../shared/player/sagas/cardShop.ts");
var playerInfo_1 = __webpack_require__(/*! ./playerInfo */ "../shared/player/playerInfo/index.ts");
var definitionProvider_1 = __webpack_require__(/*! ../game/definitionProvider */ "../shared/game/definitionProvider.ts");
var health_1 = __webpack_require__(/*! ./sagas/health */ "../shared/player/sagas/health.ts");
var xp_1 = __webpack_require__(/*! ./sagas/xp */ "../shared/player/sagas/xp.ts");
var fillBoard_1 = __webpack_require__(/*! ./sagas/fillBoard */ "../shared/player/sagas/fillBoard.ts");
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, effects_1.fork(cardShop_1.cardShopSagaFactory(new definitionProvider_1.DefinitionProvider(), playerId))];
                case 2:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                ...
                case 3:
                    ...
                    return [4 /*yield*/, effects_1.fork(health_1.healthSagaFactory())];
                case 4:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                    return [4 /*yield*/, effects_1.fork(xp_1.xpSagaFactory())];
                case 5:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                    return [4 /*yield*/, effects_1.fork(fillBoard_1.fillBoardSagaFactory())];
                case 6: return [4 /*yield*/, _a.apply(void 0, [_b.concat([
                            _c.sent()
                        ])])];
                case 7:
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, effects_1.put(actions_2.closeOverlay())];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
...
var tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.js");
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../../node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
var actions_1 = __webpack_require__(/*! packages/app/src/ui/actions */ "./src/ui/actions.ts");
var actions_2 = __webpack_require__(/*! @creature-chess/shared/game/store/actions */ "../shared/game/store/actions.ts");
var playerInfo_1 = __webpack_require__(/*! @creature-chess/shared/player/playerInfo */ "../shared/player/playerInfo/index.ts");
...
exports.announcement = function () {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeLatest([playerInfo_1.SET_OPPONENT, actions_2.PLAYERS_RESURRECTED], function (action) {
                    var state, opponent, playerIds, state_1, playerNames, message;
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(action.type === playerInfo_1.SET_OPPONENT)) return [3 /*break*/, 3];
                                return [4 /*yield*/, effects_1.select()];
                            case 1:
                                state = _a.sent();
                            ...
                            case 2:
                                ...
                                _a.label = 3;
                            case 3:
                                if (!(action.type === actions_2.PLAYERS_RESURRECTED)) return [3 /*break*/, 8];
...
var cardShop_1 = __webpack_require__(/*! @creature-chess/shared/player/sagas/cardShop */ "../shared/player/sagas/cardShop.ts");
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 6:
                    ...
                    return [4 /*yield*/, effects_1.fork(cardShop_1.cardShopSagaFactory(definitionProvider, playerId))];
                case 7:
                    _b = _b.concat([
                        _c.sent()
                    ]);
...
var server_to_client_lobby_1 = __webpack_require__(/*! @creature-chess/shared/networking/server-to-client-lobby */ "../shared/networking/server-to-client-lobby.ts");
...
var actions_4 = __webpack_require__(/*! @creature-chess/shared/game/store/actions */ "../shared/game/store/actions.ts");
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/src/index.ts");
var overlay_1 = __webpack_require__(/*! packages/app/src/ui/overlay */ "./src/ui/overlay.ts");
var actions_5 = __webpack_require__(/*! ../../features/board/actions */ "./src/game/features/board/actions.ts");
var battleSaga_1 = __webpack_require__(/*! @creature-chess/shared/match/combat/battleSaga */ "../shared/match/combat/battleSaga.ts");
...
var subscribe = function (registry, lobbyRegistry, socket) {
    return redux_saga_1.eventChannel(function (emit) {
        socket.on("reconnect_failed", function () {
            ...
            emit(actions_2.updateConnectionStatus(networking_1.ConnectionStatus.DISCONNECTED));
        });
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.PHASE_UPDATE, function (packet) {
            ...
            switch (packet.phase) {
                case models_1.GamePhase.PREPARING: {
                    ...
                    emit(playerInfo_1.cardsUpdated(cards));
                    emit(boardActions_1.unlockBoard());
                    emit(actions_2.openOverlay(overlay_1.Overlay.SHOP));
                    emit(playerInfo_1.clearOpponent());
                    emit(actions_2.clearAnnouncement());
                    return;
                }
                case models_1.GamePhase.READY: {
                    ...
                    emit(benchActions_1.initialiseBench(bench));
                    emit(boardActions_1.lockBoard());
                    emit(actions_2.closeOverlay());
                    emit(playerInfo_1.setOpponent(opponentId));
                    emit(actions_5.clearSelectedPiece());
                    return;
                }
                case models_1.GamePhase.PLAYING: {
                    emit(battleSaga_1.startBattle());
                    return;
                }
                default:
                    return;
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.LEVEL_UPDATE, function (packet) {
            ...
            emit(playerInfo_1.setLevelAction(packet.level, packet.xp));
        });
        // todo split lobby networking
        lobbyRegistry.on(server_to_client_lobby_1.ServerToClientLobbyPacketOpcodes.JOIN_LOBBY, function (_a) {
        ...
        lobbyRegistry.on(server_to_client_lobby_1.ServerToClientLobbyPacketOpcodes.LOBBY_PLAYER_UPDATE, function (_a) {
            var index = _a.index, player = _a.player;
            emit(actions_3.updateLobbyPlayerAction(index, player));
        });
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.JOIN_GAME, function (_a) {
            var id = _a.id, fullState = _a.fullState;
            emit(actions_2.joinCompleteAction(id));
            if (!fullState) {
                return;
            }
            ...
            emit(playerInfo_1.moneyUpdateAction(money));
            emit(playerInfo_1.cardsUpdated(cards));
            emit(playerListActions_1.playerListUpdated(players));
            emit(playerInfo_1.setLevelAction(level, xp));
            emit(boardActions_1.initialiseBoard(board));
            emit(benchActions_1.initialiseBench(bench));
            if (phase) {
                emit(actions_4.gamePhaseStarted(phase.phase, phase.startedAtSeconds));
            }
            else {
                emit(actions_2.updateConnectionStatus(networking_1.ConnectionStatus.RECONNECTED));
            }
        });
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.FINISH_GAME, function (packet) {
            log_1.log("[FINISH_GAME]", packet);
            emit(actions_4.finishGameAction(packet.winnerName));
            socket.close();
        });
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 25:
                ...
                lobbyRegistry = new incoming_packet_registry_1.IncomingPacketRegistry(function (opcode, handler) { return socket.on(opcode, handler); });
                return [4 /*yield*/, effects_1.put(actions_2.updateConnectionStatus(networking_1.ConnectionStatus.CONNECTED))];
            case 26:
                _a.sent();
...
var playerInfo_1 = __webpack_require__(/*! @creature-chess/shared/player/playerInfo */ "../shared/player/playerInfo/index.ts");
var game_1 = __webpack_require__(/*! @creature-chess/shared/game */ "../shared/game/index.ts");
...
var networking_1 = __webpack_require__(/*! @creature-chess/shared/networking */ "../shared/networking/index.ts");
var actions_3 = __webpack_require__(/*! @creature-chess/shared/game/store/actions */ "../shared/game/store/actions.ts");
var initialState = {
    loading: false,
    currentOverlay: null,
