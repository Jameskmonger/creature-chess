...
var sendPlayerActions = function (registry) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                if (false) {}
                return [4 /*yield*/, effects_1.take(__spread(gamemode_1.PlayerActions.PlayerActionTypesArray, gamemode_1.PlayerGameActions.PlayerGameActionTypesArray))];
            case 2:
                action = _a.sent();
                index = ++lastSentIndex;
...
exports.__esModule = true;
exports.quitGameAction = exports.readyUpAction = exports.playerSellPieceAction = exports.playerClickTileAction = exports.playerDropPieceAction = exports.PlayerActionTypesArray = exports.QUIT_GAME_ACTION = exports.READY_UP_ACTION = exports.PLAYER_SELL_PIECE_ACTION = exports.PLAYER_DROP_PIECE_ACTION = exports.PLAYER_CLICK_TILE_ACTION = void 0;
...
exports.PlayerActionTypesArray = [
    exports.PLAYER_DROP_PIECE_ACTION, exports.PLAYER_SELL_PIECE_ACTION,
    exports.READY_UP_ACTION, exports.QUIT_GAME_ACTION
];
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var board_1 = __webpack_require__(/*! @creature-chess/board */ "../board/lib/index.js");
var createPieceFromCard_1 = __webpack_require__(/*! ../sagas/playerActions/createPieceFromCard */ "../gamemode/lib/player/sagas/playerActions/createPieceFromCard.js");
var playerSelectors_1 = __webpack_require__(/*! ../playerSelectors */ "../gamemode/lib/player/playerSelectors.js");
...
exports.__esModule = true;
exports.PlayerGameActionTypesArray = exports.playerGameActionsSaga = exports.toggleShopLockPlayerAction = exports.rerollCardsPlayerAction = exports.buyXpPlayerAction = exports.buyCardPlayerAction = void 0;
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../gamemode/node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, effects_1.fork(sagas_1.PlayerActionSagas.dropPiecePlayerActionSagaFactory(boardSlices, playerId))];
                case 2:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                    return [4 /*yield*/, effects_1.fork(sagas_1.PlayerActionSagas.sellPiecePlayerActionSagaFactory(boardSlices))];
                case 3:
                    _b = _b.concat([
                        _c.sent()
                    ]);
