...
exports.networking = function () {
    var action, state, idToken, socket, e_1, outgoingRegistry, incomingRegistry, lobbyRegistry;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                _a.label = 3;
            case 3:
                if (!(socket === null)) return [3 /*break*/, 8];
                _a.label = 4;
            case 4:
                _a.trys.push([4, 6, , 7]);
...
exports.__esModule = true;
exports.updateLobbyPlayerAction = exports.joinLobbyAction = exports.UPDATE_LOBBY_PLAYER = exports.JOIN_LOBBY = void 0;
