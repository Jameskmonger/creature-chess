...
var subscribe = function (registry, socket) {
    return redux_saga_1.eventChannel(function (emit) {
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.LOBBY_PLAYER_UPDATE, function (packet) {
            ...
            emit(actions_1.updateLobbyPlayerAction(packet.index, packet.player));
        });
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                chosenNickname = null;
                return [4 /*yield*/, effects_1.put(actions_1.requestNickname("You must choose a unique nickname before you can play!"))];
            case 7:
                _a.sent();
                _a.label = 8;
            case 8:
                if (!(chosenNickname === null)) return [3 /*break*/, 13];
                return [4 /*yield*/, effects_1.take(actions_1.NICKNAME_CHOSEN)];
            case 9:
                nickname = (_a.sent()).payload.nickname;
                error = nickname_1.validateNickname(nickname);
                if (!error) return [3 /*break*/, 11];
                return [4 /*yield*/, effects_1.put(actions_1.requestNickname(error))];
            case 10:
                _a.sent();
                return [3 /*break*/, 12];
            case 11:
            ...
            case 14:
                ...
                chosenNickname = null;
                return [4 /*yield*/, effects_1.put(actions_1.requestNickname("Error: " + e_1.error))];
            case 15:
                _a.sent();
                _a.label = 16;
            case 16:
...
exports.__esModule = true;
exports.finishGameAction = exports.shopLockUpdated = exports.updateConnectionStatus = exports.playersResurrected = exports.enableDebugMode = exports.phaseStartSeconds = exports.joinGameError = exports.findGameAction = void 0;
...
exports.__esModule = true;
exports.clearAnnouncement = exports.updateAnnouncement = exports.closeOverlay = exports.openOverlay = exports.CLEAR_ANNOUNCEMENT = exports.UPDATE_ANNOUNCEMENT = exports.CLOSE_OVERLAY = exports.OPEN_OVERLAY = void 0;
...
exports.__esModule = true;
exports.FINISH_GAME = exports.SHOP_LOCK_UPDATED = exports.UPDATE_CONNECTION_STATUS = exports.ENABLE_DEBUG_MODE = exports.PHASE_START_SECONDS = exports.PLAYERS_RESURRECTED = exports.JOIN_ERROR = exports.FIND_GAME = void 0;
        ...
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, effects_1.takeEvery(localPlayerActionTypes_1.JOIN_COMPLETE, function (_a) {
                        ...
                        return tslib_1.__generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, effects_1.fork(game_1.gameSagaFactory(playerId))];
                                case 1:
                                    _b.sent();
                                    return [2 /*return*/];
                            }
