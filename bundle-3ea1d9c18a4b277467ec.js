...
var TurnSimulator = /** @class */ (function () {
    ...
    TurnSimulator.prototype.attack = function (attacker, defender) {
        ...
        var attackBonus = utils_1.getTypeAttackBonus(attacker.definition.type, defender.definition.type);
        ...
        return {
            attacker: tslib_1.__assign(tslib_1.__assign({}, attacker), { attacking: {
                    ...
                    direction: position_1.getRelativeDirection(attacker.position, defender.position),
                    damage: damage
