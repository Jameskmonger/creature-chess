...
exports.__esModule = true;
exports.isRegistered = exports.usePlayerId = exports.RegistrationPage = exports.LoginPage = void 0;
...
var isRegistered = function (user) { return user["https://creaturechess.jamesmonger.com/playerNickname"] !== null; };
...
var patchUser = function (token, nickname) {
...
var LobbyPage = function () {
    ...
    return (React.createElement("div", { className: "lobby" },
        React.createElement("div", { className: "lobby-info" },
            ...
            React.createElement("div", { className: "players" }, players.map(function (p) {
                var _a;
                return (React.createElement("div", { key: p.id, className: "player" + (p.isBot ? " bot" : "") },
...
var lobbyConnectedEvent = function (lobbyId, players, startTimestamp) { return ({
...
exports.lobbyConnectedEvent = lobbyConnectedEvent;
var gameConnectedEvent = function (payload) { return ({ type: exports.GAME_CONNECTED_EVENT, payload: payload }); };
exports.gameConnectedEvent = gameConnectedEvent;
...
var Game = /** @class */ (function () {
    function Game(createLogger, players, options) {
        ...
        this.getPlayerById = function (playerId) {
            return _this.players.find(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.id === playerId; }) || null;
        };
        ...
        this.dispatchPublicGameEvent = function (event) {
            _this.players.filter(function (p) { return p.getStatus() === models_1.PlayerStatus.CONNECTED; })
        ...
        this.opponentProvider = new opponentProvider_1.OpponentProvider(players);
        this.playerList.onUpdate(function (newPlayers) {
            _this.dispatchPublicGameEvent(events_2.playerListChangedEvent({ players: newPlayers }));
        });
...
var runPlayingPhase = function () {
    var options, players, battleTimeoutDeferred, phase, startedAt, livingPlayers, matches, finishMatchTasks;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                matches = __spreadArray([], __read(new Set(livingPlayers.map(function (p) { return p.getMatch(); }))));
                finishMatchTasks = livingPlayers.map(function (p) { return p.runSaga(waitForFinishMatchSaga); });
                matches.forEach(function (m) { return m.fight(battleTimeoutDeferred.promise); });
...
var runPreparingPhase = function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                _a.sent();
                players.getLiving().forEach(function (p) { return p.receiveGameEvent(events_1.playerRunPreparingPhaseEvent()); });
        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                matchups.forEach(function (_a) {
                    ...
                    homePlayer.receiveGameEvent(events_1.playerRunReadyPhaseEvent({ match: match }));
                    if (!awayIsClone) {
                        awayPlayer.receiveGameEvent(events_1.playerRunReadyPhaseEvent({ match: match }));
                    }
                });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.home.receiveGameEvent(events_1.playerFinishMatchEvent({ homeScore: homeScore, awayScore: awayScore, isHomePlayer: true }));
                        if (!this.awayIsClone) {
                            this.away.receiveGameEvent(events_1.playerFinishMatchEvent({ homeScore: homeScore, awayScore: awayScore, isHomePlayer: false }));
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, effects_1.all([
                            effects_1.fork(battle_1.battleSagaFactory(function (state) { return state.board; }), gameOptions, _this.board),
...
var OpponentProvider = /** @class */ (function () {
    function OpponentProvider(players) {
        ...
        this.getLivingPlayers = function () { return players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.isAlive(); }); };
    }
...
var cardShop_1 = __webpack_require__(/*! ../../player/cardShop */ "../gamemode/lib/player/cardShop.js");
...
var playerGameDeckSagaFactory = function (deck) {
    ...
    var pullNewCards = function (oldCards, level, excludeIds, blessCandidateIds) { return deck.reroll(oldCards, 5, level, blessCandidateIds, excludeIds); };
    // when a player dies, add their cards and pieces back to the deck
    var addToDeck = function (pieces, cards) {
        var e_1, _a;
        try {
            for (var pieces_1 = __values(pieces), pieces_1_1 = pieces_1.next(); !pieces_1_1.done; pieces_1_1 = pieces_1.next()) {
                var piece = pieces_1_1.value;
            ...
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.all([
                        effects_1.takeEvery(player_1.PlayerEvents.playerDeathEvent.toString(), function () {
                            var _a, boardSlice, benchSlice, cards, pieces, remainingCards;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [5 /*yield**/, __values(typed_redux_saga_1.getContext("boardSlices"))];
                                    case 1:
                                        _a = _b.sent(), boardSlice = _a.boardSlice, benchSlice = _a.benchSlice;
                                        return [5 /*yield**/, __values(typed_redux_saga_1.select(function (s) { return s.cardShop.cards; }))];
                                    case 2:
                                        cards = _b.sent();
...
var playerGameActions_1 = __webpack_require__(/*! ../player/playerGameActions */ "../gamemode/lib/player/playerGameActions/index.js");
var events_1 = __webpack_require__(/*! ./events */ "../gamemode/lib/game/events.js");
            ...
            case 0: return [4 /*yield*/, effects_1.takeLatest(roundInfo_1.RoundInfoCommands.setRoundInfoCommand.toString(), function (_a) {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, effects_1.getContext("players")];
                            case 1:
                                broadcast = (_b.sent()).broadcast;
                                broadcast(events_1.gamePhaseStartedEvent(payload));
                                return [2 /*return*/];
                        }
                    });
                })];
...
var gameSaga = function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                logger = _a.sent();
                logger.info("Game started with " + players.getAll().length + " players: " + players.getAll().map(function (p) { return p.name; }).join(", "));
...
exports.__esModule = true;
exports.config = exports.Match = exports.getDefinitionById = exports.GameEvents = exports.RoundInfoCommands = exports.roundInfoReducer = exports.createPlayerStore = exports.playerInfoReducer = exports.PlayerInfoCommands = exports.isPlayerAlive = exports.getPlayerXp = exports.getPlayerMoney = exports.getPlayerLevel = exports.getAllPieces = exports.getPiece = exports.PlayerGameActions = exports.PlayerReducers = exports.PlayerCommands = exports.PlayerSelectors = exports.PlayerSagas = exports.PlayerEvents = exports.PlayerType = exports.Player = exports.Game = void 0;
var game_1 = __webpack_require__(/*! ./game */ "../gamemode/lib/game/index.js");
__createBinding(exports, game_1, "Game");
var player_1 = __webpack_require__(/*! ./player */ "../gamemode/lib/player/index.js");
__createBinding(exports, player_1, "Player");
__createBinding(exports, player_1, "PlayerType");
...
exports.__esModule = true;
exports.updateShopLockCommand = exports.updateCardsCommand = void 0;
...
exports.__esModule = true;
exports.PlayerGameActions = exports.PlayerReducers = exports.PlayerCommands = exports.PlayerSelectors = exports.PlayerSagas = exports.PlayerEvents = exports.PlayerType = exports.Player = void 0;
...
var Player = /** @class */ (function () {
    function Player(id, name, profile) {
        var _this = this;
        this.match = null;
        ...
        var _a = store_1.createPlayerStore(this.getLogger, function () { return _this.match; }, this.id, this.name, {
    ...
    Player.prototype.matchSaga = function () {
        var _this = this;
        var setMatch = function (match) { return _this.match = match; };
        var clearMatch = function () { return _this.match; };
        return function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, effects_1.all([
...
var buyCardPlayerActionSaga = function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _loop_1 = function () {
                    var playerId, name_1, getLogger, _b, boardSlice, benchSlice, action, index, sortPositions, cards, money, card, destination, piece, remainingCards, _c, x, y;
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0: return [5 /*yield**/, __values(typed_redux_saga_1.getContext("playerId"))];
                            case 1:
                                playerId = _d.sent();
                                return [5 /*yield**/, __values(typed_redux_saga_1.getContext("playerName"))];
                            case 2:
                                name_1 = _d.sent();
                                return [5 /*yield**/, __values(typed_redux_saga_1.getContext("dependencies"))];
                            case 3:
                                getLogger = (_d.sent()).getLogger;
                                return [5 /*yield**/, __values(typed_redux_saga_1.getContext("boardSlices"))];
                            case 4:
                                _b = _d.sent(), boardSlice = _b.boardSlice, benchSlice = _b.benchSlice;
                            ...
                            case 10:
                                if (!(money < card.cost)) return [3 /*break*/, 13];
                            ...
                            case 12:
                                _d.sent();
                                return [2 /*return*/, "continue"];
                            case 13: return [5 /*yield**/, __values(typed_redux_saga_1.select(function (state) { return getCardDestination(state, playerId, sortPositions); }))];
                            case 14:
                                destination = _d.sent();
                                // no valid slots
                                if (destination === null) {
                                ...
                                if (!(destination.type === "board")) return [3 /*break*/, 16];
                                _c = destination.location, x = _c.x, y = _c.y;
                                return [4 /*yield*/, effects_1.put(boardSlice.commands.addBoardPieceCommand({ piece: piece, x: x, y: y }))];
                            case 15:
                                _d.sent();
                                return [3 /*break*/, 18];
                            case 16:
                                if (!(destination.type === "bench")) return [3 /*break*/, 18];
                                return [4 /*yield*/, effects_1.put(benchSlice.commands.addBoardPieceCommand({ piece: piece, x: destination.location.x, y: 0 }))];
                            case 17:
                                _d.sent();
                                _d.label = 18;
                            case 18: return [4 /*yield*/, effects_1.put(commands_1.updateMoneyCommand(money - card.cost))];
                            case 19:
                                _d.sent();
...
var buyXpPlayerActionSaga = function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (false) {}
                return [5 /*yield**/, __values(typed_redux_saga_1.getContext("playerId"))];
            case 1:
                playerId = _a.sent();
                return [5 /*yield**/, __values(typed_redux_saga_1.getContext("playerName"))];
            case 2:
...
exports.__esModule = true;
exports.cardShopReducer = void 0;
var cardShop_1 = __webpack_require__(/*! ./cardShop */ "../gamemode/lib/player/cardShop.js");
...
var clientFinishMatch_1 = __webpack_require__(/*! ./clientFinishMatch */ "../gamemode/lib/player/sagas/clientFinishMatch.js");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.all([
                    ...
                    effects_1.fork(matchRewards_1.playerMatchRewards),
                    effects_1.fork(clientFinishMatch_1.clientFinishMatch)
                ])];
            case 1:
                _a.sent();
                return [2 /*return*/];
...
/***/ "../gamemode/lib/player/sagas/clientFinishMatch.js":
/*!*********************************************************!*\
  !*** ../gamemode/lib/player/sagas/clientFinishMatch.js ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var clientFinishMatch = function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [5 /*yield**/, __values(typed_redux_saga_1.getContext("dependencies"))];
            case 1:
                getMatch = (_a.sent()).getMatch;
...
var evolutionSagaFactory = function (_a) {
    var boardSlice = _a.boardSlice, benchSlice = _a.benchSlice;
    return function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [5 /*yield**/, __values(typed_redux_saga_1.select(function (s) { return s.board.locked; }))];
                                case 1:
                                    boardLocked = _b.sent();
...
exports.evolutionSagaFactory = evolutionSagaFactory;
...
var fillBoardSagaFactory = function (playerId) {
    return function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.fillBoardSagaFactory = fillBoardSagaFactory;
...
var healthSagaFactory = function () {
    return function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.all([
...
exports.healthSagaFactory = healthSagaFactory;
...
exports.__esModule = true;
exports.setStatusOnQuit = exports.playerMatchRewards = exports.playerBattle = exports.xpSagaFactory = exports.addXpCommand = exports.healthSagaFactory = exports.subtractHealthCommand = exports.fillBoardSagaFactory = exports.fillBoardCommand = exports.evolutionSagaFactory = void 0;
...
var setStatusOnQuit_1 = __webpack_require__(/*! ./setStatusOnQuit */ "../gamemode/lib/player/sagas/setStatusOnQuit.js");
__createBinding(exports, setStatusOnQuit_1, "setStatusOnQuit");
...
/***/ "../gamemode/lib/player/sagas/phases/index.js":
/*!****************************************************!*\
  !*** ../gamemode/lib/player/sagas/phases/index.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var effects_1 = __webpack_require__(/*! redux-saga/effects */ "../gamemode/node_modules/redux-saga/dist/redux-saga-effects-npm-proxy.esm.js");
var preparing_1 = __webpack_require__(/*! ./preparing */ "../gamemode/lib/player/sagas/phases/preparing.js");
var ready_1 = __webpack_require__(/*! ./ready */ "../gamemode/lib/player/sagas/phases/ready.js");
...
/***/ "../gamemode/lib/player/sagas/phases/preparing.js":
/*!********************************************************!*\
  !*** ../gamemode/lib/player/sagas/phases/preparing.js ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    if (!matchRewards) return [3 /*break*/, 7];
                                    return [5 /*yield**/, __values(typed_redux_saga_1.select(function (state) { return state.playerInfo.money; }))];
                                case 3:
                                    currentMoney = _a.sent();
                                    return [5 /*yield**/, __values(typed_redux_saga_1.select(function (state) { return state.playerInfo.matchRewards.rewardMoney.total; }))];
                                case 4:
                                    totalMatchReward = _a.sent();
                                ...
                                case 6:
                                    _a.sent();
                                    _a.label = 7;
                                case 7: return [5 /*yield**/, __values(typed_redux_saga_1.select(playerSelectors_1.isPlayerShopLocked))];
                                case 8:
                                    locked = _a.sent();
                                    if (!!locked) return [3 /*break*/, 10];
                                    return [4 /*yield*/, effects_1.put(events_2.afterRerollCardsEvent())];
                                case 9:
                                    _a.sent();
                                    _a.label = 10;
                                case 10:
                                    if (!matchRewards) return [3 /*break*/, 13];
                                ...
                                case 12:
                                    _a.sent();
                                    _a.label = 13;
                                case 13: return [5 /*yield**/, __values(typed_redux_saga_1.select(playerSelectors_1.getPlayerLevel))];
                                case 14:
                                    level = _a.sent();
...
/***/ "../gamemode/lib/player/sagas/phases/ready.js":
/*!****************************************************!*\
  !*** ../gamemode/lib/player/sagas/phases/ready.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "../gamemode/lib/player/sagas/setStatusOnQuit.js":
/*!*******************************************************!*\
  !*** ../gamemode/lib/player/sagas/setStatusOnQuit.js ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.xpSagaFactory = xpSagaFactory;
...
var cardShop_1 = __webpack_require__(/*! ./cardShop */ "../gamemode/lib/player/cardShop.js");
var playerGameActions_1 = __webpack_require__(/*! ./playerGameActions */ "../gamemode/lib/player/playerGameActions/index.js");
var phases_1 = __webpack_require__(/*! ./sagas/phases */ "../gamemode/lib/player/sagas/phases/index.js");
var createPlayerStore = function (getLogger, getMatch, playerId, playerName, boardSlices) {
    var rootSaga = function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.all([
                        effects_1.call(phases_1.playerPhases),
                        effects_1.fork(playerGameActions_1.playerGameActionsSaga),
                        effects_1.fork(sagas_1.evolutionSagaFactory(boardSlices)),
                        effects_1.fork(sagas_1.healthSagaFactory()),
                        effects_1.fork(sagas_1.xpSagaFactory(boardSlices)),
                        effects_1.fork(sagas_1.fillBoardSagaFactory(playerId)),
                        effects_1.fork(sagas_1.setStatusOnQuit),
                        effects_1.fork(sagas_1.playerBattle)
                    ])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
...
exports.createPlayerStore = createPlayerStore;
...
var finishedBattle = function (opponentId, homeScore, awayScore) { return ({
...
exports.__esModule = true;
exports.Menu = exports.Lobby = exports.Game = void 0;
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/index.tsx","vendors-node_modules_auth0_auth0-react_dist_auth0-react_esm_js-node_modules_fortawesome_free--b28173"]
/******/ 		];
