...
(function (GamePhase) {
    ...
    GamePhase[GamePhase["DEAD"] = 3] = "DEAD";
...
__createBinding(exports, position_1, "TileStyle");
...
__createBinding(exports, position_1, "getAdjacentPositions");
...
exports.__esModule = true;
exports.unlockBoard = exports.lockBoard = exports.moveBoardPiece = exports.updateBoardPieces = exports.updateBoardPiece = exports.removeBoardPieces = exports.removeBoardPiece = exports.addBoardPiece = exports.initialiseBoard = exports.UNLOCK_BOARD = exports.LOCK_BOARD = exports.MOVE_BOARD_PIECE = exports.UPDATE_BOARD_PIECES = exports.UPDATE_BOARD_PIECE = exports.INITIALISE_BOARD = exports.ADD_BOARD_PIECE = exports.REMOVE_BOARD_PIECES = exports.REMOVE_BOARD_PIECE = void 0;
...
exports.initialiseBoard = function (pieces) { return ({
    type: exports.INITIALISE_BOARD,
    payload: {
        pieces: pieces
    }
}); };
exports.addBoardPiece = function (piece, x, y) { return ({
    type: exports.ADD_BOARD_PIECE,
    payload: {
        piece: piece,
        x: x,
        y: y
...
exports.lockBoard = function () { return ({ type: exports.LOCK_BOARD }); };
exports.unlockBoard = function () { return ({ type: exports.UNLOCK_BOARD }); };


/***/ }),

/***/ "../shared/lib/board/can-drop-piece.js":
/*!*********************************************!*\
  !*** ../shared/lib/board/can-drop-piece.js ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "../shared/lib/board/get-first-empty-bench-slot.js":
/*!*********************************************************!*\
  !*** ../shared/lib/board/get-first-empty-bench-slot.js ***!
  \*********************************************************/
/*! no static exports found */
...
exports.__esModule = true;
var can_drop_piece_1 = __webpack_require__(/*! ./can-drop-piece */ "../shared/lib/board/can-drop-piece.js");
__createBinding(exports, can_drop_piece_1, "canDropPiece");
var get_first_empty_bench_slot_1 = __webpack_require__(/*! ./get-first-empty-bench-slot */ "../shared/lib/board/get-first-empty-bench-slot.js");
...
exports.BoardActions = __webpack_require__(/*! ./actions */ "../shared/lib/board/actions.js");
...
var actions_1 = __webpack_require__(/*! ../actions */ "../shared/lib/board/actions.js");
var initialState = false;
var locked = function (state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case actions_1.LOCK_BOARD:
            return true;
        case actions_1.UNLOCK_BOARD:
            return false;
        default:
            return state;
    }
...
var piecePositions = function (state, action) {
    ...
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case actions_1.INITIALISE_BOARD:
        ...
        case actions_1.UPDATE_BOARD_PIECES: {
        ...
        case actions_1.UPDATE_BOARD_PIECE: {
...
var pieces = function (state, action) {
    ...
    switch (action.type) {
        case actions_1.INITIALISE_BOARD: {
            return __assign({}, action.payload.pieces);
        }
        case actions_1.UPDATE_BOARD_PIECE: {
            var piece = action.payload.piece;
        ...
        case actions_1.UPDATE_BOARD_PIECES: {
            var newState = __assign({}, state);
            try {
                for (var _e = __values(action.payload.pieces), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var piece = _f.value;
...
var GameEvents;
(function (GameEvents) {
    GameEvents["FINISH_GAME"] = "FINISH_GAME";
...
var Game = /** @class */ (function () {
    function Game(players, options) {
        ...
        this.startGame = function () { return __awaiter(_this, void 0, void 0, function () {
            var startTime, startTimeMs, duration, winner, gamePlayers;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.players.forEach(function (p) { return p.onStartGame(_this.id); });
                        _a.label = 1;
                    case 1:
                        if (false) {}
                    ...
                    case 5:
                        ...
                        this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT; }).forEach(function (p) { return p.onFinishGame(winner); });
        ...
        this.turnSimulator = new match_1.TurnSimulator();
        this.playerList.onUpdate(function (playerList) {
            return _this.players
                .filter(function (p) { return p.getStatus() === models_1.PlayerStatus.CONNECTED; })
                .forEach(function (p) { return p.onPlayerListUpdate(playerList); });
        });
    ...
    Game.prototype.runPreparingPhase = function () {
        return __awaiter(this, void 0, void 0, function () {
            var round, livingPlayers, notifier;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        round = this.store.getState().round;
                        this.store.dispatch(store_1.GameActions.preparingPhaseStarted(round + 1, Date.now() / 1000));
    ...
    Game.prototype.runReadyPhase = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.store.dispatch(store_1.GameActions.gamePhaseStarted(models_1.GamePhase.READY, Date.now() / 1000));
                        this.updateOpponentProvider();
                        this.getLivingPlayers().forEach(function (player) {
                            var opponent = _this.opponentProvider.getOpponent(player.id);
                            var match = new match_1.Match(_this.turnSimulator, _this.options.turnCount, _this.options.turnDuration, player, opponent);
    ...
    Game.prototype.runPlayingPhase = function () {
        return __awaiter(this, void 0, void 0, function () {
            var battleTimeoutDeferred, _a, round, newPhaseStartedAt, promises, justDiedPlayers, justDiedPlayers_1, justDiedPlayers_1_1, player, justDiedPlayerIds, _b, _c, player, _d, _e, player;
            var e_1, _f, e_2, _g, e_3, _h;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        this.store.dispatch(store_1.GameActions.gamePhaseStarted(models_1.GamePhase.PLAYING, Date.now() / 1000));
...
var player_1 = __webpack_require__(/*! ./player/player */ "../shared/lib/game/player/player.js");
...
__createBinding(exports, playerInfo_1, "PlayerInfoActions");
...
__createBinding(exports, bench_1, "BenchActions");
...
exports.PlayerActions = __webpack_require__(/*! ./player/actions */ "../shared/lib/game/player/actions.js");
exports.PlayerSagas = __webpack_require__(/*! ./player/sagas */ "../shared/lib/game/player/sagas/index.js");
var store_2 = __webpack_require__(/*! ./store */ "../shared/lib/game/store/index.js");
__createBinding(exports, store_2, "gameReducer");
__createBinding(exports, store_2, "GameActions");
var match_1 = __webpack_require__(/*! ./match */ "../shared/lib/game/match/index.js");
__createBinding(exports, match_1, "TurnSimulator");
__createBinding(exports, match_1, "BATTLE_FINISHED");
__createBinding(exports, match_1, "battle");
...
/***/ "../shared/lib/game/match/combat/battleEventChannel.js":
/*!*************************************************************!*\
  !*** ../shared/lib/game/match/combat/battleEventChannel.js ***!
  \*************************************************************/
/*! no static exports found */
...
var addBattleBrains = function (pieces) {
    return Object.entries(pieces)
        .reduce(function (acc, _a) {
        var _b = __read(_a, 2), pieceId = _b[0], piece = _b[1];
        acc[pieceId] = __assign(__assign({}, piece), { battleBrain: {
                canMoveAtTurn: null,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        emit(board_1.BoardActions.initialiseBoard(board.pieces));
...
var battleEventChannel_1 = __webpack_require__(/*! ./battleEventChannel */ "../shared/lib/game/match/combat/battleEventChannel.js");
...
__createBinding(exports, turnSimulator_1, "TurnSimulator");
var battleSaga_1 = __webpack_require__(/*! ./battleSaga */ "../shared/lib/game/match/combat/battleSaga.js");
__createBinding(exports, battleSaga_1, "battle");
__createBinding(exports, battleSaga_1, "startBattle");
var battleEventChannel_1 = __webpack_require__(/*! ./battleEventChannel */ "../shared/lib/game/match/combat/battleEventChannel.js");
__createBinding(exports, battleEventChannel_1, "BATTLE_FINISHED");


/***/ }),

/***/ "../shared/lib/game/match/combat/movement.js":
/*!***************************************************!*\
  !*** ../shared/lib/game/match/combat/movement.js ***!
  \***************************************************/
/*! no static exports found */
...
var range = function (start, end) { return Array.from({ length: end - start }, function (_, i) { return i + 1; }); };
var applyVector = function (position, vector) {
    var newX = position.x + vector.x;
    var newY = position.y + vector.y;
    var maxX = models_1.GRID_SIZE.width - 1;
    var maxY = models_1.GRID_SIZE.height - 1;
...
var getAttackingTiles = function (facingUp, attackType) {
    var attackDirections = facingUp
        ? [models_1.Directions.UP, models_1.Directions.RIGHT, models_1.Directions.LEFT, models_1.Directions.DOWN]
        : [models_1.Directions.DOWN, models_1.Directions.LEFT, models_1.Directions.RIGHT, models_1.Directions.UP];
    var distances = range(1, attackType.range + 1);
    var tilesForDistance = distances.map(function (r) { return attackDirections.map(function (d) { return ({ x: d.x * r, y: d.y * r }); }); });
    return tilesForDistance.reduce(function (a, b) { return a.concat(b); });
};
var getLivingEnemies = function (piece, board) {
    var e_1, _a;
    var output = [];
    try {
        for (var _b = __values(Object.entries(board.pieces)), _c = _b.next(); !_c.done; _c = _b.next()) {
            var _d = __read(_c.value, 2), id = _d[0], other = _d[1];
...
exports.getAttackableEnemyFromCurrentPosition = function (piece, attackType, board) {
    ...
    try {
        for (var attackDirections_1 = __values(attackDirections), attackDirections_1_1 = attackDirections_1.next(); !attackDirections_1_1.done; attackDirections_1_1 = attackDirections_1.next()) {
...
exports.getNextPiecePosition = function (piece, target, board) {
    var targetTiles = models_1.getAdjacentPositions(target);
...
var movement_1 = __webpack_require__(/*! ./movement */ "../shared/lib/game/match/combat/movement.js");
...
var TurnSimulator = /** @class */ (function () {
    ...
    TurnSimulator.prototype.takePieceTurn = function (currentTurn, pieceId, board) {
        ...
        if (attacker.battleBrain.removeFromBoardAtTurn === currentTurn) {
            return board_1.boardReducer(board, board_1.BoardActions.removeBoardPiece(pieceId));
        }
        if (attacker.currentHealth === 0) {
            ...
            return board_1.boardReducer(board, board_1.BoardActions.updateBoardPiece(attacker));
        }
        ...
        if (attackableEnemy) {
            ...
            return board_1.boardReducer(board, board_1.BoardActions.updateBoardPieces([attackResult.attacker, attackResult.defender]));
        }
        ...
        var attackerDirection = models_1.getRelativeDirection(attacker.position, targetPosition);
    ...
    TurnSimulator.prototype.attack = function (attacker, defender) {
        ...
        var attackerDirection = models_1.getRelativeDirection(attacker.position, defender.position);
        return {
            attacker: __assign(__assign({}, attacker), { attacking: {
                    attackType: attackerStats.attackType,
                    distance: models_1.getDistance(attacker.position, defender.position),
            ...
            defender: __assign(__assign({}, defender), { currentHealth: newDefenderHealth, hit: {
                    direction: models_1.getRelativeDirection(defender.position, attacker.position),
                    damage: damage
                } })
        };
    };
...
var turnSimulator_1 = __webpack_require__(/*! ./combat/turnSimulator */ "../shared/lib/game/match/combat/turnSimulator.js");
__createBinding(exports, turnSimulator_1, "TurnSimulator");
var battleSaga_1 = __webpack_require__(/*! ./combat/battleSaga */ "../shared/lib/game/match/combat/battleSaga.js");
__createBinding(exports, battleSaga_1, "battle");
__createBinding(exports, battleSaga_1, "startBattle");
var battleEventChannel_1 = __webpack_require__(/*! ./combat/battleEventChannel */ "../shared/lib/game/match/combat/battleEventChannel.js");
__createBinding(exports, battleEventChannel_1, "BATTLE_FINISHED");
...
var Match = /** @class */ (function () {
    function Match(turnSimulator, turnCount, turnDuration, home, away) {
        ...
        this.store.dispatch(board_1.BoardActions.initialiseBoard(board));
    }
    ...
    Match.prototype.createStore = function () {
        ...
        var rootSaga = function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = effects_1.all;
                        return [4 /*yield*/, effects_1.fork(combat_1.battle, _this.turnSimulator, _this.turnCount, _this.turnDuration)];
                    case 1:
                        _b = [
                            _c.sent()
                        ];
                        return [4 /*yield*/, effects_1.takeEvery(combat_1.BATTLE_FINISHED, function () {
                                return __generator(this, function (_a) {
...
exports.__esModule = true;
exports.quitGame = exports.readyUpAction = exports.buyXpAction = exports.toggleShopLock = exports.buyCard = exports.rerollCards = exports.playerSellPiece = exports.playerDropPiece = exports.PlayerActionTypesArray = exports.QUIT_GAME = exports.TOGGLE_SHOP_LOCK = exports.READY_UP = exports.BUY_XP = exports.BUY_CARD = exports.REROLL_CARDS = exports.PLAYER_SELL_PIECE = exports.PLAYER_DROP_PIECE = exports.afterRerollCards = exports.AFTER_REROLL_CARDS = exports.afterSellPiece = exports.AFTER_SELL_PIECE = exports.playerFinishMatch = exports.PLAYER_FINISH_MATCH = void 0;
exports.PLAYER_FINISH_MATCH = "PLAYER_FINISH_MATCH";
exports.playerFinishMatch = function (homeScore, awayScore) { return ({
    type: exports.PLAYER_FINISH_MATCH,
    payload: { homeScore: homeScore, awayScore: awayScore }
}); };
exports.AFTER_SELL_PIECE = "AFTER_SELL_PIECE";
exports.afterSellPiece = function (piece) { return ({ type: exports.AFTER_SELL_PIECE, payload: { piece: piece } }); };
exports.AFTER_REROLL_CARDS = "AFTER_REROLL_CARDS";
exports.afterRerollCards = function () { return ({ type: exports.AFTER_REROLL_CARDS }); };
...
/***/ "../shared/lib/game/player/bench/actions.js":
/*!**************************************************!*\
  !*** ../shared/lib/game/player/bench/actions.js ***!
  \**************************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.unlockBench = exports.lockBench = exports.moveBenchPiece = exports.removeBenchPieces = exports.removeBenchPiece = exports.addBenchPiece = exports.initialiseBench = exports.MOVE_BENCH_PIECE = exports.UNLOCK_BENCH = exports.LOCK_BENCH = exports.INITIALISE_BENCH = exports.ADD_BENCH_PIECE = exports.REMOVE_BENCH_PIECES = exports.REMOVE_BENCH_PIECE = void 0;
...
exports.initialiseBench = function (state) { return ({
    type: exports.INITIALISE_BENCH,
    payload: {
        state: state
    }
}); };
exports.addBenchPiece = function (piece, slot) { return ({
    type: exports.ADD_BENCH_PIECE,
    payload: {
        piece: piece,
        slot: slot
    }
...
exports.lockBench = function () { return ({ type: exports.LOCK_BENCH }); };
exports.unlockBench = function () { return ({ type: exports.UNLOCK_BENCH }); };
...
exports.BenchActions = __webpack_require__(/*! ./actions */ "../shared/lib/game/player/bench/actions.js");
...
exports.__esModule = true;
exports.locked = void 0;
var actions_1 = __webpack_require__(/*! ../actions */ "../shared/lib/game/player/bench/actions.js");
var initialState = false;
var locked = function (state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case actions_1.LOCK_BENCH:
            return true;
        case actions_1.UNLOCK_BENCH:
            return false;
        default:
            return state;
    }
...
var pieces = function (state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case actions_1.INITIALISE_BENCH:
            return __spread(action.payload.state.pieces);
        case actions_1.ADD_BENCH_PIECE: {
        ...
        case actions_1.REMOVE_BENCH_PIECE: {
            return removePieces(state, [action.payload.pieceId]);
        }
        case actions_1.REMOVE_BENCH_PIECES: {
            return removePieces(state, action.payload.pieceIds);
        }
        case actions_1.MOVE_BENCH_PIECE: {
...
var Player = /** @class */ (function () {
    function Player(id, name) {
        ...
        this.rerollCards = function () {
            ...
            _this.store.dispatch(playerInfo_1.PlayerInfoActions.cardsUpdated(newCards));
        };
        ...
        this.sagaMiddleware.run(sagas_1.sellPiece);
        this.sagaMiddleware.run(sagas_1.rerollCards);
    ...
    Player.prototype.onFinishGame = function (winner) {
        this.events.removeAllListeners();
    };
    ...
    Player.prototype.enterPreparingPhase = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                this.store.dispatch(playerInfo_1.PlayerInfoActions.clearOpponent());
                this.store.dispatch(bench_1.BenchActions.unlockBench());
    ...
    Player.prototype.enterReadyPhase = function (match) {
        this.store.dispatch(bench_1.BenchActions.lockBench());
        this.store.dispatch(playerInfo_1.PlayerInfoActions.setOpponent(match.away.id));
        this.match = match;
        this.onEnterReadyPhase();
    };
    Player.prototype.fightMatch = function (startedAt, battleTimeout) {
        return __awaiter(this, void 0, void 0, function () {
            var finalMatchBoard, pieces, surviving, homeScore, awayScore, damage;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.onEnterPlayingPhase(startedAt);
                        return [4 /*yield*/, this.match.fight(battleTimeout.promise)];
                    case 1:
                        ...
                        this.store.dispatch(actions_1.playerFinishMatch(homeScore, awayScore));
                        return [2 /*return*/, {
                                homePlayer: this,
    ...
    Player.prototype.clearPieces = function () {
        ...
        this.store.dispatch(board_1.BoardActions.initialiseBoard({}));
        // todo this is ugly
        this.store.dispatch(bench_1.BenchActions.initialiseBench({
            pieces: [],
        ...
        this.store.dispatch(playerInfo_1.PlayerInfoActions.cardsUpdated([]));
    ...
    Player.prototype.resurrect = function (startingHealth) {
        this.store.dispatch(playerInfo_1.PlayerInfoActions.roundDiedAtUpdated(null));
        this.store.dispatch(playerInfo_1.PlayerInfoActions.healthUpdated(startingHealth));
    };
    ...
    Player.prototype.quitGame = function () {
        this.store.dispatch(playerInfo_1.PlayerInfoActions.statusUpdated(models_1.PlayerStatus.QUIT));
        // todo combine these
        this.events.emit(PlayerEvent.QUIT_GAME, this);
    };
    Player.prototype.afterSellPieceSaga = function () {
        var _this = this;
        ...
        return function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, effects_1.takeEvery(actions_1.AFTER_SELL_PIECE, function (_a) {
    ...
    Player.prototype.afterRerollCardsSaga = function () {
        var thisRerollCards = this.rerollCards;
        return function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, effects_1.takeEvery(actions_1.AFTER_REROLL_CARDS, function () {
                            return __generator(this, function (_a) {
                                thisRerollCards();
                                return [2 /*return*/];
                            });
...
/***/ "../shared/lib/game/player/playerInfo/actions.js":
/*!*******************************************************!*\
  !*** ../shared/lib/game/player/playerInfo/actions.js ***!
  \*******************************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.cardsUpdated = exports.setLevelAction = exports.clearOpponent = exports.setOpponent = exports.moneyUpdateAction = exports.shopLockUpdated = exports.roundDiedAtUpdated = exports.streakUpdated = exports.healthUpdated = exports.battleUpdated = exports.statusUpdated = exports.CARDS_UPDATED = exports.LEVEL_UPDATE = exports.CLEAR_OPPONENT = exports.SET_OPPONENT = exports.MONEY_UPDATE = exports.SHOP_LOCK_UPDATED = exports.ROUND_DIED_AT_UPDATED = exports.STREAK_UPDATED = exports.HEALTH_UPDATED = exports.BATTLE_UPDATED = exports.STATUS_UPDATED = void 0;
exports.STATUS_UPDATED = "STATUS_UPDATED";
exports.BATTLE_UPDATED = "BATTLE_UPDATED";
exports.HEALTH_UPDATED = "HEALTH_UPDATED";
exports.STREAK_UPDATED = "STREAK_UPDATED";
exports.ROUND_DIED_AT_UPDATED = "ROUND_DIED_AT_UPDATED";
exports.SHOP_LOCK_UPDATED = "SHOP_LOCK_UPDATED";
exports.MONEY_UPDATE = "MONEY_UPDATE";
exports.SET_OPPONENT = "SET_OPPONENT";
exports.CLEAR_OPPONENT = "CLEAR_OPPONENT";
exports.LEVEL_UPDATE = "LEVEL_UPDATE";
exports.CARDS_UPDATED = "CARDS_UPDATED";
exports.statusUpdated = function (status) { return ({ type: exports.STATUS_UPDATED, payload: { status: status } }); };
exports.battleUpdated = function (battle) { return ({ type: exports.BATTLE_UPDATED, payload: { battle: battle } }); };
exports.healthUpdated = function (health) { return ({ type: exports.HEALTH_UPDATED, payload: { health: health } }); };
exports.streakUpdated = function (type, amount) { return ({
    type: exports.STREAK_UPDATED,
    payload: { type: type, amount: amount }
}); };
exports.roundDiedAtUpdated = function (roundDiedAt) { return ({ type: exports.ROUND_DIED_AT_UPDATED, payload: { roundDiedAt: roundDiedAt } }); };
exports.shopLockUpdated = function (locked) { return ({ type: exports.SHOP_LOCK_UPDATED, payload: { locked: locked } }); };
exports.moneyUpdateAction = function (money) { return ({ type: exports.MONEY_UPDATE, payload: { money: money } }); };
exports.setOpponent = function (opponentId) { return ({ type: exports.SET_OPPONENT, payload: { opponentId: opponentId } }); };
exports.clearOpponent = function () { return ({ type: exports.CLEAR_OPPONENT }); };
...
exports.__esModule = true;
exports.PlayerInfoActions = __webpack_require__(/*! ./actions */ "../shared/lib/game/player/playerInfo/actions.js");
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var actions_1 = __webpack_require__(/*! ./actions */ "../shared/lib/game/player/playerInfo/actions.js");
var actions_2 = __webpack_require__(/*! ../actions */ "../shared/lib/game/player/actions.js");
var initialState = {
...
function playerInfoReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case actions_1.STATUS_UPDATED:
            {
                return __assign(__assign({}, state), { status: action.payload.status });
            }
            ;
        case actions_1.BATTLE_UPDATED:
            {
                return __assign(__assign({}, state), { battle: action.payload.battle });
            }
            ;
        case actions_1.HEALTH_UPDATED: {
            return __assign(__assign({}, state), { health: action.payload.health });
        }
        case actions_1.STREAK_UPDATED: {
            return __assign(__assign({}, state), { streak: {
                    amount: action.payload.amount,
                    type: action.payload.type
                } });
        }
        case actions_1.ROUND_DIED_AT_UPDATED: {
            return __assign(__assign({}, state), { roundDiedAt: action.payload.roundDiedAt });
        }
        case actions_1.CARDS_UPDATED:
            return __assign(__assign({}, state), { cards: action.payload.cards });
        case actions_1.LEVEL_UPDATE:
            return __assign(__assign({}, state), { level: action.payload.level, xp: action.payload.xp });
        case actions_1.MONEY_UPDATE:
            return __assign(__assign({}, state), { money: action.payload.money });
        case actions_1.SET_OPPONENT:
            return __assign(__assign({}, state), { opponentId: action.payload.opponentId, ready: false });
        case actions_1.CLEAR_OPPONENT:
            return __assign(__assign({}, state), { opponentId: null });
        case actions_1.SHOP_LOCK_UPDATED:
            {
                return __assign(__assign({}, state), { shopLocked: action.payload.locked });
            }
            ;
...
exports.__esModule = true;
exports.getOpponentId = exports.getMostExpensiveBenchPiece = exports.getPlayerFirstEmptyBoardSlot = exports.getPlayerBelowPieceLimit = exports.isPlayerAlive = exports.getPlayerXp = exports.getPlayerLevel = exports.getPlayerMoney = void 0;
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var pieceSelectors_1 = __webpack_require__(/*! ./pieceSelectors */ "../shared/lib/game/player/pieceSelectors.js");
    ...
    sagaMiddleware.run(function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = effects_1.all;
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.PlayerInfoActions.SET_OPPONENT, function (_a) {
                            var opponentId = _a.payload.opponentId;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, effects_1.put(playerInfo_1.PlayerInfoActions.battleUpdated(models_1.inProgressBattle(opponentId)))];
                                    case 1:
                                        _b.sent();
                                        return [2 /*return*/];
                                }
                ...
                case 1:
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(actions_1.PLAYER_FINISH_MATCH, function (_a) {
                            var opponentId;
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        opponentId = _c.sent();
                                        return [4 /*yield*/, effects_1.put(playerInfo_1.PlayerInfoActions.battleUpdated(models_1.finishedBattle(opponentId, homeScore, awayScore)))];
                                    case 2:
                                        _c.sent();
                                        return [2 /*return*/];
                                }
...
/***/ "../shared/lib/game/player/sagas/cardShop.js":
/*!***************************************************!*\
  !*** ../shared/lib/game/player/sagas/cardShop.js ***!
  \***************************************************/
/*! no static exports found */
...
var board_1 = __webpack_require__(/*! ../../../board */ "../shared/lib/board/index.js");
var piece_utils_1 = __webpack_require__(/*! ../../../utils/piece-utils */ "../shared/lib/utils/piece-utils.js");
var actions_2 = __webpack_require__(/*! ../bench/actions */ "../shared/lib/game/player/bench/actions.js");
var log_1 = __webpack_require__(/*! ../../../log */ "../shared/lib/log.js");
var playerSelectors_1 = __webpack_require__(/*! ../playerSelectors */ "../shared/lib/game/player/playerSelectors.js");
var actions_3 = __webpack_require__(/*! ../playerInfo/actions */ "../shared/lib/game/player/playerInfo/actions.js");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeEvery(actions_1.BUY_CARD, function (_a) {
                        var state, card, money, destination, piece, remainingCards;
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, effects_1.put(board_1.BoardActions.addBoardPiece(piece, destination.location.x, destination.location.y))];
                                case 2:
                                    _b.sent();
                                    return [3 /*break*/, 5];
                                case 3:
                                    if (!(destination.type === "bench")) return [3 /*break*/, 5];
                                    return [4 /*yield*/, effects_1.put(actions_2.addBenchPiece(piece, destination.location.slot))];
                                case 4:
                                    _b.sent();
                                    _b.label = 5;
                                case 5: return [4 /*yield*/, effects_1.put(actions_3.moneyUpdateAction(money - card.cost))];
                                case 6:
                                    _b.sent();
                                    return [4 /*yield*/, effects_1.put(actions_3.cardsUpdated(remainingCards))];
                                case 7:
                                    _b.sent();
                                    return [2 /*return*/];
                            }
...
/***/ "../shared/lib/game/player/sagas/dropPiece.js":
/*!****************************************************!*\
  !*** ../shared/lib/game/player/sagas/dropPiece.js ***!
  \****************************************************/
/*! no static exports found */
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, effects_1.put(board_1.BoardActions.moveBoardPiece(pieceId, from.location, to.location))];
                                case 2:
                                    _c.sent();
                                    return [3 /*break*/, 11];
                                case 3:
                                    if (!(from.type !== "board" && to.type !== "board")) return [3 /*break*/, 5];
                                    return [4 /*yield*/, effects_1.put(actions_2.moveBenchPiece(pieceId, from.location, to.location))];
                                case 4:
                                    _c.sent();
                                    return [3 /*break*/, 11];
                                case 5:
                                    if (!(from.type === "board" && to.type !== "board")) return [3 /*break*/, 8];
                                    return [4 /*yield*/, effects_1.put(board_1.BoardActions.removeBoardPiece(pieceId))];
                                case 6:
                                    _c.sent();
                                    return [4 /*yield*/, effects_1.put(actions_2.addBenchPiece(fromPiece, to.location.slot))];
                                case 7:
                                    _c.sent();
                                    return [3 /*break*/, 11];
                                case 8:
                                    if (!(from.type !== "board" && to.type === "board")) return [3 /*break*/, 11];
                                    return [4 /*yield*/, effects_1.put(actions_2.removeBenchPiece(pieceId))];
                                case 9:
                                    _c.sent();
                                    return [4 /*yield*/, effects_1.put(board_1.BoardActions.addBoardPiece(fromPiece, to.location.x, to.location.y))];
                                case 10:
                                    _c.sent();
                                    _c.label = 11;
...
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../shared/node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var actions_1 = __webpack_require__(/*! ../bench/actions */ "../shared/lib/game/player/bench/actions.js");
var definitionProvider_1 = __webpack_require__(/*! ../../definitions/definitionProvider */ "../shared/lib/game/definitions/definitionProvider.js");
var board_1 = __webpack_require__(/*! ../../../board */ "../shared/lib/board/index.js");
var pieceSelectors = __webpack_require__(/*! ../pieceSelectors */ "../shared/lib/game/player/pieceSelectors.js");
var actions_2 = __webpack_require__(/*! ../../../board/actions */ "../shared/lib/board/actions.js");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeLatest(
                    ...
                    [actions_1.ADD_BENCH_PIECE, board_1.BoardActions.ADD_BOARD_PIECE, board_1.BoardActions.UPDATE_BOARD_PIECE], function (_a) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, effects_1.take(board_1.BoardActions.UNLOCK_BOARD)];
                                case 2:
                                    // todo check if we have 3 evolvable pieces on the bench and evolve those? maybe
                                    _b.sent();
                                ...
                                case 5:
                                    ...
                                    return [4 /*yield*/, effects_1.put(actions_2.removeBoardPieces(boardPieceIds))];
                                case 6:
                                    _b.sent();
                                    benchPieceIds = matchingBenchPieces.map(function (p) { return p.id; });
                                    return [4 /*yield*/, effects_1.put(actions_1.removeBenchPieces(__spread(benchPieceIds, [piece.id])))];
                                case 7:
                                    _b.sent();
                                    newPiece = __assign(__assign({}, pieceToReplace), { stage: targetStage + 1 });
                                    return [4 /*yield*/, effects_1.put(actions_2.updateBoardPiece(newPiece))];
                                case 8:
                                    _b.sent();
                                    return [3 /*break*/, 13];
                                case 9:
                                    benchPieceIds = matchingBenchPieces.map(function (p) { return p.id; });
                                    return [4 /*yield*/, effects_1.put(actions_1.removeBenchPieces(benchPieceIds))];
                                case 10:
                                    _b.sent();
                                    newPiece = __assign(__assign({}, piece), { stage: targetStage + 1 });
                                    // todo make updateBenchPiece action
                                    return [4 /*yield*/, effects_1.put(actions_1.removeBenchPiece(piece.id))];
                                case 11:
                                    // todo make updateBenchPiece action
                                    _b.sent();
                                    return [4 /*yield*/, effects_1.put(actions_1.addBenchPiece(newPiece, null))];
                                case 12:
                                    _b.sent();
                                    _b.label = 13;
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 3:
                                    ...
                                    return [4 /*yield*/, effects_1.put(actions_1.playerDropPiece(benchPiece.id, fromLocation, toLocation))];
                                case 4:
                                    _a.sent();
                                    return [3 /*break*/, 2];
...
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../shared/node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
var actions_1 = __webpack_require__(/*! ../playerInfo/actions */ "../shared/lib/game/player/playerInfo/actions.js");
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, effects_1.put(actions_1.healthUpdated(newValue))];
                                    case 2:
                                        _c.sent();
                                        if (!(newValue === 0 && oldValue !== 0)) return [3 /*break*/, 4];
                                        // player has just died
                                        return [4 /*yield*/, effects_1.put(actions_1.roundDiedAtUpdated(currentRound))];
                                    case 3:
                                        // player has just died
                                        _c.sent();
                                        _c.label = 4;
...
exports.__esModule = true;
var cardShop_1 = __webpack_require__(/*! ./cardShop */ "../shared/lib/game/player/sagas/cardShop.js");
__createBinding(exports, cardShop_1, "cardShopSagaFactory");
var dropPiece_1 = __webpack_require__(/*! ./dropPiece */ "../shared/lib/game/player/sagas/dropPiece.js");
__createBinding(exports, dropPiece_1, "dropPieceSagaFactory");
...
var rerollCards_1 = __webpack_require__(/*! ./rerollCards */ "../shared/lib/game/player/sagas/rerollCards.js");
__createBinding(exports, rerollCards_1, "rerollCards");
var sellPiece_1 = __webpack_require__(/*! ./sellPiece */ "../shared/lib/game/player/sagas/sellPiece.js");
__createBinding(exports, sellPiece_1, "sellPiece");
...
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../shared/node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
var actions_1 = __webpack_require__(/*! ../actions */ "../shared/lib/game/player/actions.js");
var actions_2 = __webpack_require__(/*! ../playerInfo/actions */ "../shared/lib/game/player/playerInfo/actions.js");
var xp_1 = __webpack_require__(/*! ./xp */ "../shared/lib/game/player/sagas/xp.js");
...
exports.playerMatchRewards = function (sagaMiddleware) {
    sagaMiddleware.run(function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeLatest(actions_1.PLAYER_FINISH_MATCH, function (_a) {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, effects_1.take(actions_2.CLEAR_OPPONENT)];
                                case 1:
                                    // wait for preparing phase to give money
                                    _c.sent();
                                ...
                                case 3:
                                    ...
                                    return [4 /*yield*/, effects_1.put(actions_2.moneyUpdateAction(currentMoney + rewardMoney))];
                                case 4:
                                    // todo make addMoneyCommand
                                    _c.sent();
    ...
    sagaMiddleware.run(function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = effects_1.all;
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.PlayerInfoActions.HEALTH_UPDATED, function (_a) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.PlayerInfoActions.STREAK_UPDATED, function (_a) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.PlayerInfoActions.STATUS_UPDATED, function (_a) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.PlayerInfoActions.BATTLE_UPDATED, function (_a) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(actions_1.READY_UP, function () {
                            return __generator(this, function (_a) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, effects_1.takeLatest(playerInfo_1.PlayerInfoActions.CLEAR_OPPONENT, function () {
                            return __generator(this, function (_a) {
...
/***/ "../shared/lib/game/player/sagas/rerollCards.js":
/*!******************************************************!*\
  !*** ../shared/lib/game/player/sagas/rerollCards.js ***!
  \******************************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.rerollCards = void 0;
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../shared/node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
var actions_1 = __webpack_require__(/*! ../actions */ "../shared/lib/game/player/actions.js");
var actions_2 = __webpack_require__(/*! ../playerInfo/actions */ "../shared/lib/game/player/playerInfo/actions.js");
var actions_3 = __webpack_require__(/*! ../actions */ "../shared/lib/game/player/actions.js");
var playerSelectors_1 = __webpack_require__(/*! ../playerSelectors */ "../shared/lib/game/player/playerSelectors.js");
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
exports.rerollCards = function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeEvery(actions_1.REROLL_CARDS, function () {
                    var isAlive, money;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, effects_1.select(playerSelectors_1.isPlayerAlive)];
                            ...
                            case 2:
                                ...
                                return [4 /*yield*/, effects_1.put(actions_2.moneyUpdateAction(money - models_1.REROLL_COST))];
                            case 3:
                                _a.sent();
                                return [4 /*yield*/, effects_1.put(actions_3.afterRerollCards())];
                            case 4:
                                _a.sent();
                                return [2 /*return*/];
                        }
...
/***/ "../shared/lib/game/player/sagas/sellPiece.js":
/*!****************************************************!*\
  !*** ../shared/lib/game/player/sagas/sellPiece.js ***!
  \****************************************************/
/*! no static exports found */
...
var actions_1 = __webpack_require__(/*! ../actions */ "../shared/lib/game/player/actions.js");
var actions_2 = __webpack_require__(/*! ../playerInfo/actions */ "../shared/lib/game/player/playerInfo/actions.js");
var actions_3 = __webpack_require__(/*! ../bench/actions */ "../shared/lib/game/player/bench/actions.js");
var board_1 = __webpack_require__(/*! ../../../board */ "../shared/lib/board/index.js");
var actions_4 = __webpack_require__(/*! ../actions */ "../shared/lib/game/player/actions.js");
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                ...
                                return [4 /*yield*/, effects_1.put(actions_2.moneyUpdateAction(currentMoney + (pieceCost * piecesUsed)))];
                            case 3:
                                _b.sent();
                                if (!(piece.position.y === null)) return [3 /*break*/, 5];
                                return [4 /*yield*/, effects_1.put(actions_3.removeBenchPiece(pieceId))];
                            case 4:
                                _b.sent();
                                return [3 /*break*/, 7];
                            case 5: return [4 /*yield*/, effects_1.put(board_1.BoardActions.removeBoardPiece(pieceId))];
                            case 6:
                                _b.sent();
                                _b.label = 7;
                            case 7: return [4 /*yield*/, effects_1.put(actions_4.afterSellPiece(piece))];
                            case 8:
                                _b.sent();
                                return [2 /*return*/];
                        }
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, effects_1.put(actions_2.streakUpdated(type, newAmount))];
                                case 2:
                                    _c.sent();
                                    return [2 /*return*/];
                            }
    ...
    return function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = effects_1.all;
                    return [4 /*yield*/, effects_1.takeEvery(ADD_XP_COMMAND, function (_a) {
                            var level, xp, i, toNextLevel, newXp;
                            var amount = _a.payload.amount;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, effects_1.select(function (state) { return state.playerInfo.level; })];
                                    case 1:
                                        level = _b.sent();
                                    ...
                                    case 2:
                                        ...
                                        return [4 /*yield*/, effects_1.put(actions_1.setLevelAction(level, xp))];
                                    case 3:
                                        _b.sent();
                                        return [2 /*return*/];
                                }
                ...
                case 1:
                    ...
                    return [4 /*yield*/, effects_1.takeEvery(actions_2.BUY_XP, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, effects_1.put(exports.addXpCommand(models_1.BUY_XP_AMOUNT))];
                                    case 4:
                                        _a.sent();
                                        return [4 /*yield*/, effects_1.put(actions_1.moneyUpdateAction(money - models_1.BUY_XP_COST))];
                                    case 5:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, effects_1.fork(sagas_1.cardShopSagaFactory(new definitionProvider_1.DefinitionProvider(), playerId))];
                case 2:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                    return [4 /*yield*/, effects_1.fork(sagas_1.dropPieceSagaFactory(playerId))];
                case 3:
                    _b = _b.concat([
                        _c.sent()
                    ]);
...
/***/ "../shared/lib/game/store/actions.js":
/*!*******************************************!*\
  !*** ../shared/lib/game/store/actions.js ***!
  \*******************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.finishGameAction = exports.playersResurrected = exports.preparingPhaseStarted = exports.gamePhaseStarted = exports.FINISH_GAME = exports.PLAYERS_RESURRECTED = exports.GAME_PHASE_STARTED = void 0;
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
exports.GAME_PHASE_STARTED = "GAME_PHASE_STARTED";
exports.PLAYERS_RESURRECTED = "PLAYERS_RESURRECTED";
exports.FINISH_GAME = "FINISH_GAME";
exports.gamePhaseStarted = function (phase, startedAt) { return ({
    type: exports.GAME_PHASE_STARTED,
    payload: { phase: phase, startedAt: startedAt }
}); };
exports.preparingPhaseStarted = function (round, startedAt) { return ({
    type: exports.GAME_PHASE_STARTED,
    payload: { phase: models_1.GamePhase.PREPARING, round: round, startedAt: startedAt }
}); };
...
exports.GameActions = __webpack_require__(/*! ./actions */ "../shared/lib/game/store/actions.js");
...
var actions_1 = __webpack_require__(/*! ./actions */ "../shared/lib/game/store/actions.js");
...
function reducer(state, action) {
    ...
    switch (action.type) {
        case actions_1.GAME_PHASE_STARTED:
            if (action.payload.round) {
                return __assign(__assign({}, state), { phase: action.payload.phase, phaseStartedAtSeconds: Math.floor(action.payload.startedAt), round: action.payload.round });
            }
            return __assign(__assign({}, state), { phase: action.payload.phase, phaseStartedAtSeconds: Math.floor(action.payload.startedAt) });
        default:
            return state;
    }
}
...
var board_1 = __webpack_require__(/*! ./board */ "../shared/lib/board/index.js");
__createBinding(exports, board_1, "BoardActions");
__createBinding(exports, board_1, "canDropPiece");
__createBinding(exports, board_1, "boardReducer");
var game_1 = __webpack_require__(/*! ./game */ "../shared/lib/game/index.js");
__createBinding(exports, game_1, "TurnSimulator");
__createBinding(exports, game_1, "DefinitionProvider");
__createBinding(exports, game_1, "GameActions");
__createBinding(exports, game_1, "battle");
__createBinding(exports, game_1, "startBattle");
__createBinding(exports, game_1, "BATTLE_FINISHED");
...
__createBinding(exports, game_1, "PlayerInfoActions");
__createBinding(exports, game_1, "playerInfoReducer");
__createBinding(exports, game_1, "BenchActions");
...
(function (ServerToClientLobbyPacketOpcodes) {
    ServerToClientLobbyPacketOpcodes["JOIN_LOBBY"] = "joinLobby";
...
var Bench = function () {
    ...
    var tileStyle = models_1.TileStyle.DEFAULT;
    var tiles = [];
    for (var x = 0; x < models_2.Constants.GRID_SIZE.width; x++) {
...
var Board = function (props) {
    ...
    var localPlayerStyle = models_2.TileStyle.DEFAULT;
    var opponentStyle = models_2.TileStyle.DEFAULT;
    var rows = [];
...
exports.getClassForTileStyle = function (style) {
    switch (style) {
        case models_1.TileStyle.JAMES:
        // return "style-james";
        case models_1.TileStyle.DEFAULT:
        default:
...
var ReconnectModal = function () {
    ...
    return (React.createElement("div", { className: "reconnect" },
        connectionStatus === shared_1.ConnectionStatus.DISCONNECTED
        ...
        connectionStatus === shared_1.ConnectionStatus.RECONNECTED
            && (React.createElement(React.Fragment, null,
...
var SellPieceButton = function (_a) {
    ...
    var dispatch = react_redux_1.useDispatch();
    var onClick = function () { return dispatch(shared_1.PlayerActions.playerSellPiece(pieceId)); };
...
var BenchTile = function (props) {
    return (React.createElement(tile_1.Tile, { type: models_1.TileType.BENCH, x: props.slot, y: null, tileStyle: props.tileStyle }));
};
...
var BoardTile = function (props) {
    return (React.createElement(tile_1.Tile, { type: models_1.TileType.BOARD, x: props.x, y: props.y, tileStyle: props.tileStyle }));
};
...
var onDropPiece = function (dispatch, piece, type, x, y) {
    ...
    dispatch(shared_2.PlayerActions.playerDropPiece(piece.id, from, to));
...
var CardShop = function (_a) {
    ...
    var canUseShop = react_redux_1.useSelector(function (state) { return state.game.phase !== models_1.GamePhase.DEAD; });
    var createCard = function (card, index) {
        if (card === null) {
            return null;
        }
        var onClick = function () { return dispatch(shared_1.PlayerActions.buyCard(index)); };
...
exports.closeShopOnFirstBuy = function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.take(shared_1.PlayerActions.BUY_CARD)];
            case 1:
                _a.sent();
...
var RerollButton = function () {
    ...
    var onBuy = function () { return dispatch(shared_1.PlayerActions.rerollCards()); };
...
var QuitGameButton = function () {
    ...
    var onClick = (areYouSure
        ? function () {
            dispatch(shared_1.PlayerActions.quitGame());
        }
        : function () {
            setAreYouSure(true);
        });
...
exports.announcement = function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeLatest([shared_1.PlayerInfoActions.SET_OPPONENT, shared_1.GameActions.PLAYERS_RESURRECTED], function (action) {
                    var state, opponent, playerIds, state_1, playerNames, message;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(action.type === shared_1.PlayerInfoActions.SET_OPPONENT)) return [3 /*break*/, 3];
                                return [4 /*yield*/, effects_1.select()];
                            case 1:
                                state = _a.sent();
                            ...
                            case 2:
                                ...
                                _a.label = 3;
                            case 3:
                                if (!(action.type === shared_1.GameActions.PLAYERS_RESURRECTED)) return [3 /*break*/, 8];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, effects_1.take(shared_1.PlayerActions.QUIT_GAME)];
            case 1:
                _a.sent();
...
exports.gameSagaFactory = function (playerId) {
    var turnSimulator = new shared_1.TurnSimulator();
    var definitionProvider = new shared_1.DefinitionProvider();
    return function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, effects_1.fork(shared_1.PlayerSagas.sellPiece)];
                case 4:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                    return [4 /*yield*/, effects_1.fork(shared_1.PlayerSagas.rerollCards)];
                case 5:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                ...
                case 6:
                    ...
                    return [4 /*yield*/, effects_1.fork(shared_1.PlayerSagas.cardShopSagaFactory(definitionProvider, playerId))];
                case 7:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                    return [4 /*yield*/, effects_1.fork(shared_1.PlayerSagas.dropPieceSagaFactory(playerId))];
                case 8:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                ...
                case 9:
                    ...
                    return [4 /*yield*/, effects_1.fork(shared_1.battle, turnSimulator, constants_1.DEFAULT_TURN_COUNT, constants_1.DEFAULT_TURN_DURATION)];
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var overlay_1 = __webpack_require__(/*! ../../../ui/overlay */ "./src/ui/overlay.ts");
var actions_3 = __webpack_require__(/*! ../../features/board/actions */ "./src/game/features/board/actions.ts");
...
var subscribe = function (registry, lobbyRegistry, socket) {
    return redux_saga_1.eventChannel(function (emit) {
        socket.on("reconnect_failed", function () {
            emit(actions_1.clearAnnouncement());
        ...
        registry.on(shared_1.ServerToClientPacketOpcodes.CARDS_UPDATE, function (packet) {
            ...
            emit(shared_1.PlayerInfoActions.cardsUpdated(packet));
        });
        registry.on(shared_1.ServerToClientPacketOpcodes.MONEY_UPDATE, function (packet) {
            log_1.log("[MONEY_UPDATE]", packet);
            emit(shared_1.PlayerInfoActions.moneyUpdateAction(packet));
        });
        registry.on(shared_1.ServerToClientPacketOpcodes.PHASE_UPDATE, function (packet) {
            log_1.log("[PHASE_UPDATE]", packet);
            emit(actions_1.updateConnectionStatus(shared_1.ConnectionStatus.CONNECTED));
            emit(shared_1.GameActions.gamePhaseStarted(packet.phase, packet.startedAtSeconds));
            switch (packet.phase) {
                case models_1.GamePhase.PREPARING: {
                    var _a = packet.payload, cards = _a.cards, _b = _a.pieces, board = _b.board, bench = _b.bench;
                    emit(shared_1.BoardActions.initialiseBoard(board.pieces));
                    emit(shared_1.BenchActions.initialiseBench(bench));
                    emit(shared_1.PlayerInfoActions.cardsUpdated(cards));
                    emit(shared_1.PlayerInfoActions.clearOpponent());
                    emit(shared_1.BoardActions.unlockBoard());
                ...
                case models_1.GamePhase.READY: {
                    ...
                    emit(shared_1.BenchActions.initialiseBench(bench));
                    emit(shared_1.BoardActions.lockBoard());
                    emit(actions_1.closeOverlay());
                    emit(shared_1.PlayerInfoActions.setOpponent(opponentId));
                    emit(actions_3.clearSelectedPiece());
                    return;
                }
        ...
        registry.on(shared_1.ServerToClientPacketOpcodes.LEVEL_UPDATE, function (packet) {
            ...
            emit(shared_1.PlayerInfoActions.setLevelAction(packet.level, packet.xp));
        });
        // todo split lobby networking
        lobbyRegistry.on(shared_1.ServerToClientLobbyPacketOpcodes.JOIN_LOBBY, function (_a) {
            var playerId = _a.playerId, lobbyId = _a.lobbyId, players = _a.players, startTimestamp = _a.startTimestamp;
            emit(actions_2.joinLobbyAction(playerId, lobbyId, players, startTimestamp));
        });
        lobbyRegistry.on(shared_1.ServerToClientLobbyPacketOpcodes.LOBBY_PLAYER_UPDATE, function (_a) {
            var index = _a.index, player = _a.player;
            emit(actions_2.updateLobbyPlayerAction(index, player));
        });
        registry.on(shared_1.ServerToClientPacketOpcodes.JOIN_GAME, function (_a) {
            var id = _a.id, fullState = _a.fullState;
            emit(actions_1.joinCompleteAction(id));
            if (!fullState) {
                return;
            }
            var money = fullState.money, cards = fullState.cards, players = fullState.players, _b = fullState.level, level = _b.level, xp = _b.xp, board = fullState.board, bench = fullState.bench, phase = fullState.phase;
            emit(shared_1.PlayerInfoActions.moneyUpdateAction(money));
            emit(shared_1.PlayerInfoActions.cardsUpdated(cards));
            emit(playerListActions_1.playerListUpdated(players));
            emit(shared_1.PlayerInfoActions.setLevelAction(level, xp));
            emit(shared_1.BoardActions.initialiseBoard(board));
            emit(shared_1.BenchActions.initialiseBench(bench));
            if (phase) {
                emit(shared_1.GameActions.gamePhaseStarted(phase.phase, phase.startedAtSeconds));
            }
            else {
                emit(actions_1.updateConnectionStatus(shared_1.ConnectionStatus.RECONNECTED));
            }
        });
        registry.on(shared_1.ServerToClientPacketOpcodes.FINISH_GAME, function (packet) {
            log_1.log("[FINISH_GAME]", packet);
            emit(shared_1.GameActions.finishGameAction(packet.winnerName));
            socket.close();
        });
        registry.on(shared_1.ServerToClientPacketOpcodes.SHOP_LOCK_UPDATE, function (packet) {
            log_1.log("[SHOP_LOCK_UPDATE]", packet);
            emit(shared_1.PlayerInfoActions.shopLockUpdated(packet.locked));
        });
        registry.on(shared_1.ServerToClientPacketOpcodes.PLAYERS_RESURRECTED, function (_a) {
            var playerIds = _a.playerIds;
            emit(shared_1.GameActions.playersResurrected(playerIds));
        });
        // tslint:disable-next-line:no-empty
        return function () { };
    });
};
var readPacketsToActions = function (incomingRegistry, lobbyRegistry, socket) {
    var channel;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.call(subscribe, incomingRegistry, lobbyRegistry, socket)];
            case 1:
                channel = _a.sent();
        ...
        switch (_a.label) {
            case 0:
                ...
                emitPendingActions = function () {
                    ...
                    var actions = __spread(pendingActions);
                    pendingActions = [];
                    var timeout;
                    var sendPacket = function () {
                        registry.emit(shared_1.ClientToServerPacketOpcodes.SEND_PLAYER_ACTIONS, { index: index, actions: actions }, function (accepted, packetIndex) {
                        ...
                        timeout = setTimeout(sendPacket, shared_1.SEND_PLAYER_ACTIONS_PACKET_RETRY_TIME_MS);
                    };
                    sendPacket();
                };
                ...
                return [4 /*yield*/, effects_1.takeEvery(shared_1.PlayerActions.PlayerActionTypesArray, function (action) {
                        return __generator(this, function (_a) {
                            queueAction(action);
                            return [2 /*return*/];
                        });
...
var writeActionsToPackets = function (registry) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = effects_1.all;
                _b = [effects_1.takeEvery(shared_1.BATTLE_FINISHED, function () {
                        return __generator(this, function (_a) {
...
exports.networking = function () {
    var action, state, idToken, socket, chosenNickname, e_1, nickname, error, nickname, error, outgoingRegistry, incomingRegistry, lobbyRegistry;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                chosenNickname = null;
                return [4 /*yield*/, effects_1.put(actions_2.requestNickname("You must choose a unique nickname before you can play!"))];
            case 7:
                _a.sent();
                _a.label = 8;
            case 8:
                if (!(chosenNickname === null)) return [3 /*break*/, 13];
                return [4 /*yield*/, effects_1.take(actions_2.NICKNAME_CHOSEN)];
            case 9:
                nickname = (_a.sent()).payload.nickname;
                error = shared_1.validateNickname(nickname);
                if (!error) return [3 /*break*/, 11];
                return [4 /*yield*/, effects_1.put(actions_2.requestNickname(error))];
            case 10:
                _a.sent();
                return [3 /*break*/, 12];
            case 11:
            ...
            case 14:
                ...
                chosenNickname = null;
                return [4 /*yield*/, effects_1.put(actions_2.requestNickname("Error: " + e_1.error))];
            case 15:
                _a.sent();
                _a.label = 16;
            case 16:
            ...
            case 25:
                outgoingRegistry = new shared_1.OutgoingPacketRegistry(function (opcode, payload, ack) { return socket.emit(opcode, payload, ack); });
                incomingRegistry = new shared_1.IncomingPacketRegistry(function (opcode, handler) { return socket.on(opcode, handler); });
                lobbyRegistry = new shared_1.IncomingPacketRegistry(function (opcode, handler) { return socket.on(opcode, handler); });
                return [4 /*yield*/, effects_1.put(actions_1.updateConnectionStatus(shared_1.ConnectionStatus.CONNECTED))];
            case 26:
                _a.sent();
                return [4 /*yield*/, effects_1.fork(readPacketsToActions, incomingRegistry, lobbyRegistry, socket)];
            case 27:
                _a.sent();
...
function reducer(state, action) {
    ...
    switch (action.type) {
        case actions_1.REQUEST_NICKNAME: {
            return __assign(__assign({}, state), { requestNicknameMessage: action.payload.reason });
        }
...
exports.log = function (message) {
    ...
    return console.log.apply(console, __spread([message], optionalParams));
};
...
var NicknameRequestPage = function (_a) {
    ...
    return (React.createElement("div", { className: "menu" },
        React.createElement("div", { className: "join-game" },
            ...
            React.createElement("input", { value: nickname, onChange: onNameChange, maxLength: models_1.MAX_NAME_LENGTH, placeholder: "Nickname", className: "name-input" }),
            React.createElement("div", { className: "join-options" },
                React.createElement("div", { className: "option" },
...
exports.__esModule = true;
exports.updateConnectionStatus = exports.enableDebugMode = exports.clearAnnouncement = exports.updateAnnouncement = exports.closeOverlay = exports.openOverlay = exports.joinGameError = exports.joinCompleteAction = exports.findGameAction = exports.JOIN_ERROR = exports.JOIN_COMPLETE = exports.UPDATE_CONNECTION_STATUS = exports.ENABLE_DEBUG_MODE = exports.CLEAR_ANNOUNCEMENT = exports.UPDATE_ANNOUNCEMENT = exports.CLOSE_OVERLAY = exports.OPEN_OVERLAY = exports.FIND_GAME = void 0;
...
function reducer(state, action) {
    ...
    switch (action.type) {
        ...
        case shared_1.GameActions.FINISH_GAME: {
