...
exports.__esModule = true;
exports.inFriendlyBoard = exports.inBench = exports.TileType = exports.getRelativeDirection = exports.getAdjacentPositions = exports.Directions = exports.getDistance = exports.subtract = exports.arePositionsEqual = exports.createTileCoordinates = void 0;
                ...
                channel = redux_saga_1.eventChannel(function (emit) {
                    ...
                    registry.on(shared_1.ServerToClientPacketOpcodes.JOIN_GAME, function (_a) {
                        ...
                        if (phase) {
                            ...
                            emit(actions_2.updateConnectionStatus(shared_1.ConnectionStatus.RECONNECTED));
                        }
                    });
...
exports.findGame = function () {
    var findGameAction, state, idToken, socket, registry, channel, _a, lobby, game, playerId, _b, board, bench, players, _c, phase, phaseStartedAtSeconds, _d, money, cards, level, xp;
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 9:
                _e.sent();
                _b = game.payload, board = _b.board, bench = _b.bench, players = _b.players, _c = _b.game, phase = _c.phase, phaseStartedAtSeconds = _c.phaseStartedAtSeconds, _d = _b.playerInfo, money = _d.money, cards = _d.cards, level = _d.level, xp = _d.xp;
