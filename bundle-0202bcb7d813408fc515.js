...
exports.gameSaga = function (playerId, socket, boardSlice) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = effects_1.all;
                return [4 /*yield*/, effects_1.fork(saga_1.gameNetworking, socket, boardSlice)];
            case 1:
                _b = [
                    _c.sent()
                ];
                return [4 /*yield*/, effects_1.fork(shared_1.battleSaga, shared_1.defaultGameOptions, boardSlice)];
            case 2:
                _b = _b.concat([
                    _c.sent()
                ]);
...
var overlay_1 = __webpack_require__(/*! ../../../ui/overlay */ "./src/ui/overlay.ts");
var readPacketsToActions = function (registry, socket, boardSlice) {
    var channel;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
exports.incomingGameNetworking = function (socket, boardSlice) {
    var registry;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                registry = new shared_1.IncomingPacketRegistry(function (opcode, handler) { return socket.on(opcode, handler); });
                return [4 /*yield*/, effects_1.fork(readPacketsToActions, registry, socket, boardSlice)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.gameNetworking = function (socket, boardSlice) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, effects_1.fork(incoming_1.incomingGameNetworking, socket, boardSlice)];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.lobbyNetworking = function (socket, boardSlice) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                playerId = _a.sent();
                return [4 /*yield*/, effects_1.fork(game_1.gameSaga, playerId, socket, boardSlice)];
            case 5:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.findGame = function (getAccessTokenSilently, loginWithRedirect, boardSlice) {
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 9:
                ...
                return [4 /*yield*/, effects_1.fork(networking_1.lobbyNetworking, socket, boardSlice)];
            case 10:
                _e.sent();
                return [3 /*break*/, 22];
            case 11:
...
exports.createReducers = function (_a) {
    var boardReducer = _a.boardReducer;
    return ({
        board: boardReducer,
...
exports.rootSaga = function (getAccessTokenSilently, loginWithRedirect, boardSlice) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.all([
                    effects_1.call(saga_1.loadUserSaga),
                    effects_1.call(findGame_1.findGame, getAccessTokenSilently, loginWithRedirect, boardSlice)
                ])];
            case 1:
                _a.sent();
                return [2 /*return*/];
...
exports.createAppStore = function (getAccessTokenSilently, loginWithRedirect) {
    ...
    var boardSlice = shared_1.createBoardSlice("local-board", { width: 7, height: 3 });
    var store = redux_1.createStore(redux_1.combineReducers(reducers_1.createReducers(boardSlice)), redux_devtools_extension_1.composeWithDevTools(redux_1.applyMiddleware(sagaMiddleware)));
    sagaMiddleware.run(saga_1.rootSaga, getAccessTokenSilently, loginWithRedirect, boardSlice);
    return store;
};
...
var Match = /** @class */ (function () {
    function Match(home, away, gameOptions) {
        ...
        var board = board_1.mergeBoards(this.boardId, home.getBoard(), away.getBoard());
        ...
        var rootSaga = function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = effects_1.all;
                        return [4 /*yield*/, effects_1.fork(combat_1.battleSaga, gameOptions, _this.board)];
                    case 1:
                        _b = [
                            _c.sent()
                        ];
...
var Player = /** @class */ (function () {
    function Player(id, name, picture) {
        ...
        this.boardSlice = board_1.createBoardSlice("player-" + this.id, { width: 7, height: 3 });
        var _a = store_1.createPlayerStore(this.getLogger, this.id, this.name, this.boardSlice), store = _a.store, sagaMiddleware = _a.sagaMiddleware;
        this.store = store;
...
exports.evolutionSagaFactory = function (board) {
    return function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeLatest(
                    ...
                    [commands_1.ADD_BENCH_PIECE_COMMAND, board.commands.addBoardPieceCommand], function (_a) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, effects_1.take(board.commands.unlockBoardCommand)];
                                case 2:
                                    // todo check if we have 3 evolvable pieces on the bench and evolve those? maybe
                                    _b.sent();
                                ...
                                case 6:
                                    ...
                                    return [4 /*yield*/, effects_1.put(board.commands.removeBoardPiecesCommand(boardPieceIds))];
                                case 7:
                                    _b.sent();
                                ...
                                case 8:
                                    ...
                                    return [4 /*yield*/, effects_1.put(board.commands.addBoardPieceCommand({ x: x, y: y, piece: newPiece }))];
                                case 9:
                                    _b.sent();
                                    return [3 /*break*/, 14];
                                case 10:
...
exports.buyCardPlayerActionSagaFactory = function (getLogger, definitionProvider, boardSlice, playerId, name) {
    return function () {
        var _loop_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.dropPiecePlayerActionSagaFactory = function (boardSlice, playerId) {
    return function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
var events_1 = __webpack_require__(/*! ../../events */ "../shared/lib/game/player/events.js");
exports.sellPiecePlayerActionSagaFactory = function (boardSlice) {
    return function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.xpSagaFactory = function (boardSlice) {
    return function () {
...
var store_1 = __webpack_require__(/*! ../store */ "../shared/lib/game/store/index.js");
var cardShop_1 = __webpack_require__(/*! ./cardShop */ "../shared/lib/game/player/cardShop.js");
exports.createPlayerStore = function (getLogger, playerId, name, boardSlice) {
    var rootSaga = function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = effects_1.all;
                    return [4 /*yield*/, effects_1.fork(sagas_1.PlayerActionSagas.buyCardPlayerActionSagaFactory(getLogger, new definitionProvider_1.DefinitionProvider(), boardSlice, playerId, name))];
                case 1:
                    _b = [
                        _c.sent()
                    ];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, effects_1.fork(sagas_1.PlayerActionSagas.dropPiecePlayerActionSagaFactory(boardSlice, playerId))];
                case 3:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                ...
                case 5:
                    ...
                    return [4 /*yield*/, effects_1.fork(sagas_1.PlayerActionSagas.sellPiecePlayerActionSagaFactory(boardSlice))];
                case 6:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                    return [4 /*yield*/, effects_1.fork(sagas_1.evolutionSagaFactory(boardSlice))];
                case 7:
                    _b = _b.concat([
                        _c.sent()
                    ]);
                ...
                case 8:
                    ...
                    return [4 /*yield*/, effects_1.fork(sagas_1.xpSagaFactory(boardSlice))];
                case 9:
                    _b = _b.concat([
                        _c.sent()
                    ]);
...
var board_1 = __webpack_require__(/*! ./board */ "../shared/lib/board/index.js");
__createBinding(exports, board_1, "createBoardSlice");
