...
var BoardItems_1 = __webpack_require__(/*! ./BoardItems */ "./src/game/board/BoardItems.tsx");
...
var BoardRows = function (_a) {
    var _b = _a.className, className = _b === void 0 ? "" : _b, onDrop = _a.onDrop, onClick = _a.onClick;
    var _c = context_1.useBoard(), locked = _c.locked, piecePositions = _c.piecePositions, _d = _c.size, width = _d.width, height = _d.height;
    var rows = [];
    for (var y = 0; y < height; y++) {
        var tiles = [];
        for (var x = 0; x < width; x++) {
            var tileClassName = className + " " + getClassName(x, y);
            var piecePositionKey = x + "," + y;
            var tileContainsPiece = Boolean(piecePositions[piecePositionKey]);
            tiles.push((!tileContainsPiece && !locked)
                ? React.createElement(DroppableTile_1.DroppableTile, { key: "tile-" + x, className: tileClassName, x: x, y: y, onDrop: onDrop, onClick: onClick })
                : React.createElement(UndroppableTile_1.UndroppableTile, { key: "tile-" + x, className: tileClassName }));
        }
...
var BoardGrid = function (_a) {
    var state = _a.state, _b = _a.className, className = _b === void 0 ? "" : _b, renderItem = _a.renderItem, onDrop = _a.onDrop, onClick = _a.onClick;
    return (React.createElement(context_1.BoardContextProvider, { value: state },
        React.createElement(BoardRows, { className: className, onDrop: onDrop, onClick: onClick }),
...
var DroppableTile = function (_a) {
    ...
    return (React.createElement("div", { ref: drop, className: "tile " + className + " style-default", "touch-action": "none", onPointerUp: function () { return onClick(x, y); } },
...
var getLocationForPiece = function (pieceId, board, bench) {
    ...
    if (bench) {
        var benchPiecePosition = shared_1.BoardSelectors.getPiecePosition(bench, pieceId);
...
var BoardContainer = function (_a) {
    ...
    return (React.createElement("div", { className: "group board-container" },
        ...
        React.createElement("div", { className: "bench" },
            React.createElement(BoardGrid_1.BoardGrid, { state: bench, className: "bench", onDrop: onDropPiece(dispatch, "bench", board, bench), onClick: onTileClick(dispatch, "bench"), renderItem: function (id) { return (React.createElement(pieceComponent_1.PieceComponent, { id: id, draggable: true, animate: false, selected: id === selectedPieceId, pieceIsOnBench: true })); } }))));
};
...
exports.gameSaga = function (playerId, socket, slices) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = effects_1.all;
                return [4 /*yield*/, effects_1.fork(saga_1.gameNetworking, socket, slices)];
            case 1:
                _b = [
                    _c.sent()
                ];
                return [4 /*yield*/, effects_1.fork(shared_1.battleSaga, shared_1.defaultGameOptions, slices.boardSlice)];
            case 2:
                _b = _b.concat([
                    _c.sent()
                ]);
...
exports.lobbyNetworking = function (socket, slices) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                playerId = _a.sent();
                return [4 /*yield*/, effects_1.fork(game_1.gameSaga, playerId, socket, slices)];
            case 5:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.findGame = function (getAccessTokenSilently, loginWithRedirect, slices) {
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 9:
                ...
                return [4 /*yield*/, effects_1.fork(networking_1.lobbyNetworking, socket, slices)];
            case 10:
                _e.sent();
                return [3 /*break*/, 22];
            case 11:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.all([
                    ...
                    effects_1.call(findGame_1.findGame, getAccessTokenSilently, loginWithRedirect, slices)
                ])];
            case 1:
                _a.sent();
                return [2 /*return*/];
...
exports.createAppStore = function (getAccessTokenSilently, loginWithRedirect) {
    ...
    var benchSlice = shared_1.createBoardSlice("local-bench", { width: 7, height: 1 });
...
exports.__esModule = true;
exports.playersResurrected = exports.finishGameAction = exports.updateConnectionStatus = exports.clearAnnouncement = exports.updateAnnouncement = exports.closeOverlay = exports.openOverlay = exports.joinGameError = exports.findGameAction = exports.clearSelectedPiece = exports.selectPiece = exports.CLEAR_SELECTED_PIECE = exports.SELECT_PIECE = exports.PLAYERS_RESURRECTED = exports.FINISH_GAME = exports.JOIN_ERROR = exports.UPDATE_CONNECTION_STATUS = exports.CLEAR_ANNOUNCEMENT = exports.UPDATE_ANNOUNCEMENT = exports.CLOSE_OVERLAY = exports.OPEN_OVERLAY = exports.FIND_GAME = void 0;
...
exports.getAllPieces = function (state) { return __spread(Object.values(state.board.pieces), Object.values(state.bench.pieces)); };
...
exports.getBenchPiecesForDefinition = function (state, definitionId) {
    return Object.values(state.bench.pieces).filter(function (p) { return p.definitionId === definitionId; });
};
...
exports.getBenchPiecesByStage = function (state, stage) {
    return Object.values(state.bench.pieces).filter(function (p) { return p.stage === stage; });
};
...
exports.getFirstEmptyBenchSlot = function (state) {
    for (var x = 0; x < state.bench.size.width; x++) {
