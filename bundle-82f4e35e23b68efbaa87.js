...
var selectedPieceSelector = function (state) {
    return state.ui.selectedPieceId
        ? shared_1.getPiece(state.game, state.ui.selectedPieceId)
        : null;
};
...
var StageIndicator = function (_a) {
    var pieceId = _a.pieceId;
    var piece = react_redux_1.useSelector(function (state) { return shared_1.getPiece(state.game, pieceId); });
...
var PieceComponent = function (props) {
    ...
    var localPlayerId = react_redux_1.useSelector(selectors_1.getUserId);
    var piece = react_redux_1.useSelector(function (state) { return shared_1.getPiece(state.game, id); });
    var inPreparingPhase = react_redux_1.useSelector(function (state) { return state.game.gameInfo.phase === models_1.GamePhase.PREPARING; });
...
var CardShop = function (_a) {
    ...
    var money = react_redux_1.useSelector(function (state) { return shared_1.getPlayerMoney(state.game); });
...
var PlayerList = function () {
    ...
    var localPlayerMoney = react_redux_1.useSelector(function (state) { return shared_1.getPlayerMoney(state.game); });
    var localPlayerLevel = react_redux_1.useSelector(function (state) { return shared_1.getPlayerLevel(state.game); });
...
var PieceCount = function (props) {
    var level = react_redux_1.useSelector(function (state) { return shared_1.getPlayerLevel(state.game); });
...
var Profile = function () {
    var dispatch = react_redux_1.useDispatch();
    var level = react_redux_1.useSelector(function (state) { return shared_1.getPlayerLevel(state.game); });
    var xp = react_redux_1.useSelector(function (state) { return shared_1.getPlayerXp(state.game); });
    var money = react_redux_1.useSelector(function (state) { return shared_1.getPlayerMoney(state.game); });
    // todo reselect
...
var GameOverlay = function (_a) {
    ...
    var currentBalance = react_redux_1.useSelector(function (state) { return shared_1.getPlayerMoney(state.game); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, effects_1.select(function (state) { return state.ui.selectedPieceId ? shared_1.getPiece(state.game, state.ui.selectedPieceId) : null; })];
            case 2:
                piece = _a.sent();
                if (!piece) {
                    return [3 /*break*/, 0];
...
exports.createReducers = function (_a) {
    ...
    return ({
        ...
        game: redux_1.combineReducers({
            gameInfo: shared_1.gameReducer,
