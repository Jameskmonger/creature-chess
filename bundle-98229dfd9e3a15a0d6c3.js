...
var GameBoard = function (_a) {
    ...
    var createHandleClick = function (locationType) {
        return function (_a) {
            var x = _a.x, y = _a.y;
            if (!onClick) {
                return;
            }
            onClick(createClickEvent({ locationType: locationType, x: x, y: y }));
        };
    };
    var createHandleDrop = function (locationType) {
        return function (_a) {
            var id = _a.id, x = _a.x, y = _a.y;
            if (!onDropPiece) {
                return;
            }
            onDropPiece(createDropPieceEvent(id, { locationType: locationType, x: x, y: y }));
        };
    };
    var createRenderer = function (locationType) {
        return function (item) {
            var piece = item;
            var isBoard = locationType === "board";
            var state = isBoard ? board : bench;
            var renderer = isBoard ? renderBoardPiece : renderBenchPiece;
            var draggable = !state.locked;
            return {
                item: renderer(piece),
                draggable: draggable
            };
    ...
    return (React.createElement("div", { className: styles.gameBoard },
        React.createElement("div", { className: styles.chessboard },
            React.createElement("div", { className: styles.boardGrid },
                React.createElement(board_react_1.BoardGrid, { state: board, onDropItem: createHandleDrop("board"), onClickTile: createHandleClick("board"), renderItem: createRenderer("board") })),
            React.createElement("div", { className: styles.benchGrid },
                React.createElement(board_react_1.BoardGrid, { state: bench, onDropItem: createHandleDrop("bench"), onClickTile: createHandleClick("bench"), renderItem: createRenderer("bench") })))));
};
...
/***/ "../../modules/@creature-chess/ui/piece/animated/AnimatedPiece.styles.tsx":
/*!********************************************************************************!*\
  !*** ../../modules/@creature-chess/ui/piece/animated/AnimatedPiece.styles.tsx ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "../../modules/@creature-chess/ui/piece/animated/AnimatedPiece.tsx":
/*!*************************************************************************!*\
  !*** ../../modules/@creature-chess/ui/piece/animated/AnimatedPiece.tsx ***!
  \*************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var PieceContext_1 = __webpack_require__(/*! ../PieceContext */ "../../modules/@creature-chess/ui/piece/PieceContext.ts");
var AnimatedPiece_styles_1 = __webpack_require__(/*! ./AnimatedPiece.styles */ "../../modules/@creature-chess/ui/piece/animated/AnimatedPiece.styles.tsx");
var animation_1 = __webpack_require__(/*! ./animation */ "../../modules/@creature-chess/ui/piece/animated/animation.ts");
...
var AnimatedPiece = function () {
    var _a = (0, PieceContext_1.usePiece)(), piece = _a.piece, viewingPlayerId = _a.viewingPlayerId;
    var animationStyles = (0, AnimatedPiece_styles_1.useAnimationStyles)();
    var styles = (0, AnimatedPiece_styles_1.usePieceStyles)();
    ...
    var runAnimation = function (name, keyframesName, variables) {
        return setCurrentAnimations(function (oldAnimations) {
            ...
            if (oldAnimations.some(function (a) { return a.name === name; })) {
                return oldAnimations;
            }
            var newAnimation = { name: name, keyframesName: keyframesName, variables: variables };
            return __spreadArray(__spreadArray([], __read(oldAnimations), false), [newAnimation], false);
        });
    };
    var removeAnimation = function (name) {
        return setCurrentAnimations(function (oldAnimations) { return oldAnimations.filter(function (animation) { return animation.name !== name; }); });
    };
    var onAnimationEnd = function (event) {
        setCurrentAnimations(function (oldAnimations) { return oldAnimations.filter(function (a) { return !animationEventMatchesAnimation(event, a); }); });
    };
    var runAnimations = function (newPiece) {
        ...
        if (attacking && !lastRenderedPiece.attacking) {
            if (attacking.attackType === models_1.attackTypes.basic) {
    ...
    return (React.createElement("div", { className: className, style: (0, animation_1.getAnimationCssVariables)(currentAnimations), 
        ...
        React.createElement(Piece_1.Piece, { healthbar: getHealthbar(piece.ownerId, viewingPlayerId) },
            React.createElement(piece_1.Projectile, null))));
};
...
/***/ "../../modules/@creature-chess/ui/piece/animated/animation.ts":
/*!********************************************************************!*\
  !*** ../../modules/@creature-chess/ui/piece/animated/animation.ts ***!
  \********************************************************************/
/***/ (function(__unused_webpack_module, exports) {
...
/***/ "../../modules/@creature-chess/ui/piece/animated/index.ts":
/*!****************************************************************!*\
  !*** ../../modules/@creature-chess/ui/piece/animated/index.ts ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
exports.AnimatedPiece = void 0;
var AnimatedPiece_1 = __webpack_require__(/*! ./AnimatedPiece */ "../../modules/@creature-chess/ui/piece/animated/AnimatedPiece.tsx");
__createBinding(exports, AnimatedPiece_1, "AnimatedPiece");
...
exports.__esModule = true;
exports.usePiece = exports.PieceContextProvider = exports.Piece = void 0;
var Piece_1 = __webpack_require__(/*! ./Piece */ "../../modules/@creature-chess/ui/piece/Piece.tsx");
...
__exportStar(__webpack_require__(/*! ./animated */ "../../modules/@creature-chess/ui/piece/animated/index.ts"), exports);
...
var display_1 = __webpack_require__(/*! ../../src/display */ "../../modules/@creature-chess/ui/src/display/index.ts");
var react_jss_1 = __webpack_require__(/*! react-jss */ "../../node_modules/react-jss/dist/react-jss.esm.js");
var layout_1 = __webpack_require__(/*! ../../src/layout */ "../../modules/@creature-chess/ui/src/layout/index.ts");
...
var PieceMeta = function (_a) {
    ...
    return (React.createElement(layout_1.Layout, { grow: true, direction: "column", noSpacer: true },
        ...
        React.createElement("div", { className: classes.healthbarContainer },
            healthbarColor !== "none"
                && (React.createElement(PieceHealthbar_1.PieceHealthbar, { color: healthbarColor, current: piece.currentHealth, max: piece.maxHealth }, stageIndicator)),
            healthbarColor === "none"
                && stageIndicator)));
};
        ...
        React.createElement("div", { className: styles.row },
            React.createElement("p", { className: (0, classnames_1["default"])(styles.item, styles.level) },
                ...
                React.createElement("span", null,
                    "$",
                    money)),
            level !== models_1.MAX_PLAYER_LEVEL
                && (React.createElement(progressBar_1.ProgressBar, { className: styles.xpProgress, fillClassName: styles.xpProgressFill, contentClassName: styles.xpProgressContent, current: xp, max: (0, models_1.getXpToNextLevel)(level), renderContents: renderProgressBar }))),
        React.createElement("div", { className: styles.row },
            React.createElement(PieceCount, { level: level, pieceCount: pieceCount }),
            level !== models_1.MAX_PLAYER_LEVEL
                && (React.createElement("button", { className: styles.buyXpButton, onClick: onBuyXpClick },
                    "Buy ",
...
var TypeIndicator = function (_a) {
    var type = _a.type;
    return React.createElement("img", { src: ICON_FOR_TYPE[type] });
};
...
var CreatureImage = function (_a) {
    ...
    return (React.createElement("img", { className: useStyles().image, src: "".concat(baseUrl, "/images/").concat(facing || "front", "/").concat(definitionId, ".png") }));
};
...
var getSize = function (grow) { return grow ? { width: "100%", height: "100%" } : {}; };
var useStyles = (0, react_jss_1.createUseStyles)({
    layout: function (_a) {
...
var BoardGrid = function (props) {
    ...
    return (React.createElement("div", { className: styles.boardGrid },
...
var useStyles = (0, react_jss_1.createUseStyles)({
    tileRow: function (props) { return ({
        width: "100%",
        height: "".concat((100 / props.height).toFixed(2), "%"),
        boxSizing: "border-box",
        lineHeight: "0",
        whiteSpace: "nowrap"
    }); }
...
var BoardGridRows = function (_a) {
    ...
    var _b = (0, context_1.useBoardState)(), locked = _b.locked, piecePositions = _b.piecePositions, _c = _b.size, width = _c.width, height = _c.height;
    ...
    for (var y = 0; y < height; y++) {
        ...
        for (var x = 0; x < width; x++) {
            ...
            tiles.push(canDropPiece
                ? react_1["default"].createElement(DroppableTile_1.DroppableTile, { key: "tile-".concat(x), x: x, y: y, onDrop: onDropItem, onClick: onClickTile })
                : react_1["default"].createElement(UndroppableTile_1.UndroppableTile, { key: "tile-".concat(x), x: x, y: y }));
        }
        rows.push(react_1["default"].createElement("div", { key: "row-".concat(y), className: styles.tileRow }, tiles));
    }
...
var classnames_1 = __importDefault(__webpack_require__(/*! classnames */ "../../node_modules/classnames/index.js"));
var context_1 = __webpack_require__(/*! ../../context */ "../../modules/@shoki/board-react/src/context.ts");
var useTileWidth_1 = __webpack_require__(/*! ./useTileWidth */ "../../modules/@shoki/board-react/src/components/tile/useTileWidth.ts");
// eslint-disable-next-line no-bitwise
var isBoardTileDark = function (x, y) { return ((y ^ x) & 1) !== 0; };
var useStyles = (0, react_jss_1.createUseStyles)({
    tile: function (props) { return ({
        width: "".concat((100 / props.boardWidth).toFixed(2), "%"),
        height: "".concat(props.tileWidth, "px"),
        position: "relative",
        display: "inline-block",
        boxSizing: "border-box",
        userSelect: "none"
...
exports.Tile = react_1["default"].forwardRef(function (_a, ref) {
    ...
    var tileWidth = (0, useTileWidth_1.useTileWidth)(tileInnerRef);
    var styles = useStyles({ boardWidth: boardWidth, tileWidth: tileWidth });
...
/***/ "../../modules/@shoki/board-react/src/components/tile/useTileWidth.ts":
/*!****************************************************************************!*\
  !*** ../../modules/@shoki/board-react/src/components/tile/useTileWidth.ts ***!
  \****************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
exports.useTileWidth = void 0;
var react_1 = __webpack_require__(/*! react */ "../../node_modules/react/index.js");
var useTileWidth = function (tileInnerRef) {
    var _a = __read((0, react_1.useState)(0), 2), tileWidth = _a[0], setTileWidth = _a[1];
    ...
    (0, react_1.useLayoutEffect)(function () {
        ...
        if (typeof ResizeObserver === "function") {
            ...
            resizeObserver_1.observe(tileInnerRef.current);
            return function () {
...
exports.useTileWidth = useTileWidth;
...
var useBelowPieceLimit = function () {
    ...
    return boardState.pieceLimit === null || board_1.BoardSelectors.isBelowPieceLimit(boardState);
};
...
/******/ })()
;
//# sourceMappingURL=bundle-98229dfd9e3a15a0d6c3.js.map