...
const renderPhaseInfoCountdown = (secondsRemaining: number) => <span>({secondsRemaining})</span>;
...
const PhaseInfo: React.FunctionComponent = () => {
	...
	return <InfoChip>{GamePhase[phase]} <Countdown countdownToSeconds={phaseEndTime} render={renderPhaseInfoCountdown} /></InfoChip>;
};
