...
export const getCurrent =
	...
	async (req: Request, res: Response<SanitizedUser>) => {
...
type PatchCurrentUserRequest = Request<
	{},
	PatchResponse,
	{ nickname: string; picture: number }
>;
...
export const patchCurrent =
	...
	async (req: PatchCurrentUserRequest, res: Response<PatchResponse>) => {
		const {
			body,
