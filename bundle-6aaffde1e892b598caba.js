...
/***/ "../shared/game/events/eventManager.ts":
/*!*********************************************!*\
  !*** ../shared/game/events/eventManager.ts ***!
  \*********************************************/
/*! no static exports found */
...
var Events;
(function (Events) {
    Events["ENTER_PREPARING_PHASE"] = "ENTER_PREPARING_PHASE";
    Events["FINISH_ROUND"] = "FINISH_ROUND";
})(Events || (Events = {}));
var EventManager = /** @class */ (function () {
    function EventManager() {
        ...
        this.triggers = {
            enterPreparingPhase: function (players) {
                _this.events.emit(Events.ENTER_PREPARING_PHASE, players);
            },
            finishRound: function (players) {
                _this.events.emit(Events.FINISH_ROUND, players);
            }
        };
    }
    EventManager.prototype.deconstructor = function () {
        this.events.removeAllListeners();
        this.events = null;
    };
    EventManager.prototype.getTriggers = function () {
        return this.triggers;
    };
    EventManager.prototype.onEnterPreparingPhase = function (fn) {
        this.events.on(Events.ENTER_PREPARING_PHASE, fn);
    };
    EventManager.prototype.onFinishRound = function (fn) {
...
var eventManager_1 = __webpack_require__(/*! ./events/eventManager */ "../shared/game/events/eventManager.ts");
var matchRewards_1 = __webpack_require__(/*! ./plugins/matchRewards */ "../shared/game/plugins/matchRewards.ts");
var resetPlayer_1 = __webpack_require__(/*! ./plugins/resetPlayer */ "../shared/game/plugins/resetPlayer.ts");
...
var defaultPhaseLengths = constants_1.PHASE_LENGTHS;
var Game = /** @class */ (function () {
    function Game(players, phaseLengths, turnCount, turnDuration) {
        var _this = this;
        this.round = 0;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        log_1.log("Match complete in " + (duration) + " ms (" + this.round + " rounds)");
                        // teardown
        ...
        this.phaseLengths = tslib_1.__assign(tslib_1.__assign({}, defaultPhaseLengths), phaseLengths);
        this.turnCount = turnCount >= 0 ? turnCount : constants_1.DEFAULT_TURN_COUNT;
        this.turnDuration = turnDuration >= 0 ? turnDuration : constants_1.DEFAULT_TURN_DURATION;
        this.phase = null;
    ...
    Game.prototype.setPhase = function (value) {
        this.phase = {
            value: value,
            startedAt: Date.now()
        };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.round++;
                        this.setPhase(game_phase_1.GamePhase.PREPARING);
                        ...
                        promises = this.players
                            ...
                            .map(function (p) { return p.enterPreparingPhase(_this.phase.startedAt, _this.round); });
                        return [4 /*yield*/, Promise.race([
                                Promise.all(promises),
                                delay_1["default"](this.phaseLengths[game_phase_1.GamePhase.PREPARING] * 1000)
                            ])];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    Game.prototype.runReadyPhase = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.setPhase(game_phase_1.GamePhase.READY);
                        this.updateLivingPlayers();
                        this.players
                            .filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT; })
                            .forEach(function (p) { return p.enterReadyPhase(_this.turnSimulator, _this.opponentProvider, _this.phase.startedAt); });
                        return [4 /*yield*/, delay_1["default"](this.phaseLengths[game_phase_1.GamePhase.READY] * 1000)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Game.prototype.runPlayingPhase = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.setPhase(game_phase_1.GamePhase.PLAYING);
    ...
    Game.prototype.fightBattles = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var maxTimeMs, battleTimeoutDeferred, livingPlayers, onPlayerFinishBattle, promises, newLivingPlayers, justDiedPlayers, justDiedPlayers_1, justDiedPlayers_1_1, player, justDiedPlayerIds, _a, _b, player, _c, _d, player;
            var e_1, _e, e_2, _f, e_3, _g;
            var _this = this;
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        maxTimeMs = this.phaseLengths[game_phase_1.GamePhase.PLAYING] * 1000;
                        battleTimeoutDeferred = pDefer();
                        delay_1["default"](maxTimeMs).then(function () { return battleTimeoutDeferred.resolve(); });
                        livingPlayers = this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.isAlive(); });
                        onPlayerFinishBattle = function (results) {
                            var damage = results.awayScore * 3;
                            results.homePlayer.subtractHealth(damage);
                        };
                        promises = livingPlayers.map(function (p) { return p.fightMatch(_this.phase.startedAt, battleTimeoutDeferred).then(onPlayerFinishBattle); });
                    ...
                    case 1:
                        ...
                        if (newLivingPlayers.length === 0) {
                            justDiedPlayers = this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.getRoundDiedAt() === _this.round; });
                            try {
                                ...
                                try {
                                    if (justDiedPlayers_1_1 && !justDiedPlayers_1_1.done && (_e = justDiedPlayers_1["return"])) _e.call(justDiedPlayers_1);
                                }
                                finally { if (e_1) throw e_1.error; }
                            }
                            justDiedPlayerIds = justDiedPlayers.map(function (p) { return p.id; });
                            try {
                                for (_a = tslib_1.__values(this.players), _b = _a.next(); !_b.done; _b = _a.next()) {
                                    player = _b.value;
                        ...
                        try {
                            for (_c = tslib_1.__values(this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.getRoundDiedAt() === _this.round; })), _d = _c.next(); !_d.done; _d = _c.next()) {
                                player = _d.value;
                                player.kill();
    ...
    Game.prototype.registerPlugins = function () {
        matchRewards_1.matchRewards(this.eventManager);
        resetPlayer_1.resetPlayer(this.eventManager);
    };
    return Game;
}());
exports.Game = Game;
...
var playerPieces_1 = __webpack_require__(/*! ./playerPieces */ "../shared/game/player/playerPieces.ts");
...
var player_1 = __webpack_require__(/*! ../../player */ "../shared/player/index.ts");
...
(function (PlayerEvent) {
    PlayerEvent["UPDATE_HEALTH"] = "UPDATE_HEALTH";
    PlayerEvent["UPDATE_READY"] = "UPDATE_READY";
    PlayerEvent["UPDATE_STREAK"] = "UPDATE_STREAK";
    PlayerEvent["START_LOBBY_GAME"] = "START_LOBBY_GAME";
    PlayerEvent["UPDATE_BATTLE"] = "UPDATE_BATTLE";
    PlayerEvent["UPDATE_STATUS"] = "UPDATE_STATUS";
    PlayerEvent["QUIT_GAME"] = "QUIT_GAME";
})(PlayerEvent || (PlayerEvent = {}));
var Player = /** @class */ (function () {
    function Player(id, name, saga) {
        var _this = this;
        this.health = constants_1.STARTING_HEALTH;
        this.ready = false;
        this.streak = {
        ...
        this.status = player_list_player_1.PlayerStatus.CONNECTED;
        this.battleTimeout = null;
        this.toggleShopLock = function () {
            _this.shopLocked = !_this.shopLocked;
            _this.onShopLockUpdate();
        };
        this.sellPiece = function (pieceId) {
            ...
            _this.deck.shuffle();
            _this.pieces.removePiece(pieceId);
        };
        this.buyXp = function () {
            ...
            _this.addXp(constants_1.BUY_XP_AMOUNT);
        ...
        this.readyUp = function () {
            if (_this.ready || _this.readyUpDeferred === null) {
                return;
            }
            _this.setReady(true);
            _this.readyUpDeferred.resolve();
        };
        this.onDropPiece = function (_a) {
            var payload = _a.payload;
            if (!payload || !payload.pieceId || !payload.from || !payload.to) {
                // packet malformed
                return;
            }
            _this.pieces.dispatchAction(player_1.PlayerActions.playerDropPiece(payload.pieceId, payload.from, payload.to));
        };
        this.id = id;
        this.name = name;
        var _a = store_1.createPlayerStore(this.id, saga), store = _a.store, sagaMiddleware = _a.sagaMiddleware;
        this.store = store;
        this.sagaMiddleware = sagaMiddleware;
        this.pieces = new playerPieces_1.PlayerPieces(this.store);
    }
    Player.prototype.setDefinitionProvider = function (definitionProvider) {
        this.definitionProvider = definitionProvider;
    };
    Player.prototype.setTurnCount = function (turnCount) {
        this.turnCount = turnCount;
    };
    Player.prototype.setTurnDuration = function (turnDuration) {
        this.turnDuration = turnDuration;
    };
    Player.prototype.getMatch = function () {
        return this.match;
    };
    Player.prototype.getBattleBoard = function (away) {
        return mergeBoards_1.mergeBoards(constants_1.GRID_SIZE, this.store.getState().board.pieces, away.store.getState().board.pieces);
    };
    Player.prototype.addXp = function (amount) {
        var _a = this.store.getState().playerInfo, level = _a.level, xp = _a.xp;
        for (var i = 0; i < amount; i++) {
            var toNextLevel = utils_1.getXpToNextLevel(level);
            var newXp = xp + 1;
        ...
        this.store.dispatch(playerInfo_1.setLevelAction(level, xp));
    };
    ...
    Player.prototype.enterPreparingPhase = function (startedAt, round) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Player.prototype.enterReadyPhase = function (turnSimulator, opponentProvider, startedAt) {
        ...
        if (this.isAlive()) {
            ...
            this.battle = player_list_player_1.inProgressBattle(opponent.id);
            this.events.emit(PlayerEvent.UPDATE_BATTLE, this.battle);
            this.match = new match_1.Match(turnSimulator, this.turnCount, this.turnDuration, this, opponent);
            this.onEnterReadyPhase(startedAt);
        }
    };
    Player.prototype.fightMatch = function (startedAt, battleTimeout) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var finalMatchBoard, pieces, surviving, homeScore, awayScore;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        this.battle = player_list_player_1.finishedBattle(this.match.away.id, homeScore, awayScore);
                        this.events.emit(PlayerEvent.UPDATE_BATTLE, this.battle);
                        return [2 /*return*/, {
                                homePlayer: this,
    ...
    Player.prototype.onStartLobbyGame = function (fn) {
        this.events.on(PlayerEvent.START_LOBBY_GAME, fn);
    };
    Player.prototype.onHealthUpdate = function (fn) {
        this.events.on(PlayerEvent.UPDATE_HEALTH, fn);
        fn(this.health);
    };
    Player.prototype.onReadyUpdate = function (fn) {
        this.events.on(PlayerEvent.UPDATE_READY, fn);
        fn(this.ready);
    };
    Player.prototype.onStreakUpdate = function (fn) {
        this.events.on(PlayerEvent.UPDATE_STREAK, fn);
        fn(this.streak);
    };
    Player.prototype.onBattleUpdate = function (fn) {
        this.events.on(PlayerEvent.UPDATE_BATTLE, fn);
        fn(this.battle);
    };
    Player.prototype.onStatusUpdate = function (fn) {
    ...
    Player.prototype.adjustStreak = function (win) {
        var type = win ? models_1.StreakType.WIN : models_1.StreakType.LOSS;
    ...
    Player.prototype.subtractHealth = function (value) {
        var oldValue = this.health;
        var newValue = this.health - value;
    ...
    Player.prototype.quitGame = function () {
        this.status = player_list_player_1.PlayerStatus.QUIT;
        // todo combine these
    ...
    Player.prototype.belowPieceLimit = function () {
        return pieceSelectors_1.getBoardPieceCount(this.store.getState()) < this.store.getState().playerInfo.level;
    };
    ...
    Player.prototype.fillBoard = function () {
        while (true) {
            ...
            var belowPieceLimit = playerSelectors_1.getPlayerBelowPieceLimit(state, this.id);
            if (!belowPieceLimit) {
                return;
            }
            var benchPiece = playerSelectors_1.getMostExpensiveBenchPiece(state);
            if (!benchPiece) {
                return;
            }
            var destination = playerSelectors_1.getPlayerFirstEmptyBoardSlot(state);
            if (!destination) {
                return;
            }
            var fromLocation = {
            ...
            this.store.dispatch(player_1.PlayerActions.playerDropPiece(benchPiece.id, fromLocation, toLocation));
        }
    };
    return Player;
}());
...
/***/ "../shared/game/player/playerPieces.ts":
/*!*********************************************!*\
  !*** ../shared/game/player/playerPieces.ts ***!
  \*********************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.PlayerPieces = void 0;
var tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.js");
var benchActions_1 = __webpack_require__(/*! ../../player/bench/benchActions */ "../shared/player/bench/benchActions.ts");
var boardActions_1 = __webpack_require__(/*! ../../board/actions/boardActions */ "../shared/board/actions/boardActions.ts");
var PlayerPieces = /** @class */ (function () {
    function PlayerPieces(store) {
        this.store = store;
    }
    PlayerPieces.prototype.addBenchPiece = function (piece) {
        this.store.dispatch(benchActions_1.addBenchPiece(piece, null));
    };
    PlayerPieces.prototype.removePiece = function (pieceId) {
        this.store.dispatch(benchActions_1.removeBenchPiece(pieceId));
        this.store.dispatch(boardActions_1.removeBoardPiece(pieceId));
    };
    PlayerPieces.prototype.clear = function () {
    ...
    PlayerPieces.prototype.unlockEvolutions = function () {
        this.store.dispatch(benchActions_1.unlockBench());
    };
    PlayerPieces.prototype.lockEvolutions = function () {
        this.store.dispatch(benchActions_1.lockBench());
    };
    PlayerPieces.prototype.dispatchAction = function (action) {
        this.store.dispatch(action);
    };
    PlayerPieces.prototype.dispatchActions = function (actions) {
        var e_1, _a;
        try {
...
/***/ "../shared/game/plugins/matchRewards.ts":
/*!**********************************************!*\
  !*** ../shared/game/plugins/matchRewards.ts ***!
  \**********************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.matchRewards = void 0;
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/src/index.ts");
var getNewStreakBonus = function (player, win) {
...
var getMoneyForMatch = function (player, win) {
    var base = 3;
    var winBonus = win ? 1 : 0;
    var streakBonus = getNewStreakBonus(player, win);
    var interest = Math.min(Math.floor(player.getMoney() / 10), 5);
    var total = base + winBonus + streakBonus + interest;
    return total;
};
exports.matchRewards = function (eventManager) {
    eventManager.onFinishRound(function (players) {
        players
            .filter(function (player) { return player.getStatus() !== models_1.PlayerStatus.QUIT && player.isAlive(); })
            .forEach(function (player) {
            var match = player.getMatch();
            var results = match.getFinalBoard();
            var pieces = Object.values(results.pieces);
            var surviving = {
                home: pieces.filter(function (p) { return p.currentHealth > 0 && p.ownerId === player.id; }),
                away: pieces.filter(function (p) { return p.currentHealth > 0 && p.ownerId !== player.id; })
            };
            var win = surviving.home.length > surviving.away.length;
            var money = getMoneyForMatch(player, win);
...
/***/ "../shared/game/plugins/resetPlayer.ts":
/*!*********************************************!*\
  !*** ../shared/game/plugins/resetPlayer.ts ***!
  \*********************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.resetPlayer = void 0;
exports.resetPlayer = function (eventManager) {
    eventManager.onEnterPreparingPhase(function (players) {
        players.forEach(function (p) { return p.reset(); });
    });
};
...
exports.__esModule = true;
exports.phaseStartSeconds = exports.finishGameAction = exports.playersResurrected = exports.gamePhaseUpdate = exports.PHASE_START_SECONDS = exports.FINISH_GAME = exports.PLAYERS_RESURRECTED = exports.GAME_PHASE_UPDATE = void 0;
    ...
    switch (action.type) {
        case actions_1.GAME_PHASE_UPDATE:
            if (action.payload.phase === models_1.GamePhase.PREPARING) {
                return tslib_1.__assign(tslib_1.__assign({}, state), { phase: action.payload.phase, round: action.payload.payload.round });
            }
...
var Match = /** @class */ (function () {
    function Match(turnSimulator, turnCount, turnDuration, home, away) {
        ...
        var board = home.getBattleBoard(away);
...
exports.__esModule = true;
exports.cardsUpdated = exports.setLevelAction = exports.clearOpponent = exports.setOpponent = exports.moneyUpdateAction = exports.shopLockUpdated = exports.CARDS_UPDATED = exports.LEVEL_UPDATE = exports.CLEAR_OPPONENT = exports.SET_OPPONENT = exports.MONEY_UPDATE = exports.SHOP_LOCK_UPDATED = void 0;
...
var playerInfo_1 = __webpack_require__(/*! ./playerInfo */ "../shared/player/playerInfo/index.ts");
var definitionProvider_1 = __webpack_require__(/*! ../game/definitionProvider */ "../shared/game/definitionProvider.ts");
exports.createPlayerStore = function (playerId, otherSaga) {
    var rootSaga = function () {
        var _a, _b;
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!otherSaga) return [3 /*break*/, 2];
                    return [4 /*yield*/, effects_1.fork(otherSaga)];
                case 1:
                    _c.sent();
                    _c.label = 2;
                case 2:
...
exports.announcement = function () {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeLatest([actions_2.GAME_PHASE_UPDATE, actions_2.PLAYERS_RESURRECTED], function (action) {
                    var state, opponentId_1, opponent, playerIds, state_1, playerNames, message;
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(action.type === actions_2.GAME_PHASE_UPDATE)) return [3 /*break*/, 5];
                            ...
                            case 4:
                                ...
                                _a.label = 5;
                            case 5:
                                if (!(action.type === actions_2.PLAYERS_RESURRECTED)) return [3 /*break*/, 10];
...
var actions_1 = __webpack_require__(/*! ../../../ui/actions */ "./src/ui/actions.ts");
var overlay_1 = __webpack_require__(/*! ../../../ui/overlay */ "./src/ui/overlay.ts");
var actions_2 = __webpack_require__(/*! ../../features/board/actions */ "./src/game/features/board/actions.ts");
...
var isGamePhaseUpdate = function (phase) {
    return function (action) { return action.type === actions_3.GAME_PHASE_UPDATE && action.payload.phase === phase; };
};
                ...
                return [4 /*yield*/, effects_1.takeEvery(isGamePhaseUpdate(models_1.GamePhase.PREPARING), function (action) {
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    _a.sent();
                                    return [4 /*yield*/, effects_1.put(playerInfo_1.cardsUpdated(payload.cards))];
                                case 3:
                                    _a.sent();
                                    return [4 /*yield*/, effects_1.put(boardActions_1.unlockBoard())];
                                case 4:
                                    _a.sent();
                                    return [4 /*yield*/, effects_1.put(actions_1.openOverlay(overlay_1.Overlay.SHOP))];
                                case 5:
                                    _a.sent();
                                    return [4 /*yield*/, effects_1.put(playerInfo_1.clearOpponent())];
                                case 6:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                ...
                return [4 /*yield*/, effects_1.takeEvery(isGamePhaseUpdate(models_1.GamePhase.READY), function (action) {
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 5:
                                    _a.sent();
                                    return [4 /*yield*/, effects_1.put(playerInfo_1.setOpponent(payload.opponentId))];
                                case 6:
                                    _a.sent();
                                    return [4 /*yield*/, effects_1.select()];
                                case 7:
                                    ...
                                    if (!(selectedPiece && selectedPiece.position.y !== null)) return [3 /*break*/, 9];
                                    return [4 /*yield*/, effects_1.put(actions_2.clearSelectedPiece())];
                                case 8:
                                    _a.sent();
                                    _a.label = 9;
...
var tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.js");
var actions_1 = __webpack_require__(/*! @creature-chess/shared/game/store/actions */ "../shared/game/store/actions.ts");
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../../node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
exports.phaseTimer = function () {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeLatest(actions_1.GAME_PHASE_UPDATE, function (action) {
                    var nowMs, seconds;
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, effects_1.put(actions_1.phaseStartSeconds(seconds))];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
...
var subscribe = function (registry, socket) {
    return redux_saga_1.eventChannel(function (emit) {
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.PHASE_UPDATE, function (packet) {
            ...
            emit(actions_4.gamePhaseUpdate(packet));
        });
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.JOIN_GAME, function (packet) {
            ...
            if (packet.type === "game") {
                ...
                if (phase) {
                    emit(actions_4.gamePhaseUpdate(phase));
                }
                else {
