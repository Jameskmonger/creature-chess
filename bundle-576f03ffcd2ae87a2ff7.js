            ...
            case 1:
                ...
                return [4 /*yield*/, effects_2.all([
                        ...
                        effects_2.call(function () {
                            var _a, board, bench, players, battleTurn, _b, phase, phaseStartedAtSeconds, _c, money, cards, level, xp, update;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        if (!(action && action.payload)) return [3 /*break*/, 9];
                                    ...
                                    case 7:
                                        _d.sent();
                                        if (!(battleTurn !== null)) return [3 /*break*/, 9];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.all([
                        ...
                        effects_1.call(sagas_1.evolutionSagaFactory(boardSlices)),
                        effects_1.call(sagas_1.healthSagaFactory()),
                        effects_1.call(sagas_1.xpSagaFactory(boardSlices)),
                        effects_1.call(sagas_1.fillBoardSagaFactory(playerId)),
                        effects_1.call(sagas_1.setStatusOnQuit),
                        effects_1.call(sagas_1.playerBattle)
                    ])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/index.tsx","vendors-node_modules_auth0_auth0-react_dist_auth0-react_esm_js-node_modules_fortawesome_free--5f3152"]
/******/ 		];
