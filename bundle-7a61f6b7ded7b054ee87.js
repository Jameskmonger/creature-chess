...
exports.__esModule = true;
exports.inFriendlyBoard = exports.inBench = exports.TileType = exports.getRelativeDirection = exports.getAdjacentPositions = exports.Directions = exports.getDistance = exports.getDelta = exports.subtract = exports.arePositionsEqual = exports.createTileCoordinates = void 0;
...
var takePieceTurn = function (currentTurn, pieceId, board) {
    ...
    if (!targetAlive) {
        ...
        var nextPosition = pathfinding_1.getNextPiecePosition(attacker, target, board);
        if (!nextPosition) {
            return board_1.boardReducer(board, board_1.BoardCommands.updateBoardPiece(attacker));
        }
        var attackerDirection = models_1.getRelativeDirection(attacker.position, target.position);
