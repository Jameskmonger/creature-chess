...
var getPlayers = function (state) { return state.playerList; };
...
exports.ownedPieceCountSelector = function (state) {
    ...
    return board_1.BoardSelectors.getAllPieces(state.board).filter(function (p) { return p.ownerId === playerId; }).length;
};
...
var PieceCount = function (props) {
    ...
    var pieceCount = react_redux_1.useSelector(function (state) { return ownedPieceCountSelector_1.ownedPieceCountSelector(state); });
    if (pieceCount !== level) {
