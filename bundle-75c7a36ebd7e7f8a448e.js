                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, effects_1.takeLatest(roundInfo_1.RoundInfoCommands.setRoundInfoCommand.toString(), function (_a) {
                                ...
                                return __generator(this, function (_b) {
                                    thisRef.dispatchPublicGameEvent(events_2.gamePhaseStartedEvent(payload));
                                    return [2 /*return*/];
                                });
                            })];
                        case 1:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            thisRef.logger.info("Game started with " + players.length + " players: " + players.map(function (p) { return p.name; }).join(", "));
                            sagaDependencies = {
                                ...
                                players: {
                                    getAll: function () { return thisRef.players; },
                                    getLiving: thisRef.getLivingPlayers,
                                    getById: function (id) { return thisRef.players.find(function (p) { return p.id === id; }) || null; }
                                }
                            };
                        ...
                        case 1:
                            ...
                            winner = thisRef.players.find(function (p) { return p.id === winnerId; });
                            event = events_2.gameFinishEvent({ winnerName: winner.name });
                            thisRef.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT; }).forEach(function (p) { return p.receiveGameEvent(event); });
                            gamePlayers = thisRef.players.map(function (p) { return ({
                                id: p.id,
                                name: p.name
                            }); });
