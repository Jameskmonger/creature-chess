...
var subscribe = function (registry, socket) {
    return redux_saga_1.eventChannel(function (emit) {
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.START_GAME, function (packet) {
            ...
            emit(localPlayerActions_1.joinCompleteAction(packet.localPlayerId, packet.gameId, packet.name));
...
exports.networking = function () {
    var action, state, isLoggedIn, idToken, socket, chosenNickname, e_1, nickname, error, nickname, error, outgoingRegistry, incomingRegistry, _a, error, response, _b, playerId, lobbyId, players, startTimestamp, _c, localPlayerId, gameId, name_1, _d, money, cards, players, _e, level, xp, board, bench, phase;
    return tslib_1.__generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 30:
                ...
                _f.label = 31;
            case 31:
                if (!(response.type === "game")) return [3 /*break*/, 42];
                _c = response.payload, localPlayerId = _c.localPlayerId, gameId = _c.gameId, name_1 = _c.name;
                return [4 /*yield*/, effects_1.put(localPlayerActions_1.joinCompleteAction(localPlayerId, gameId, name_1))];
            case 32:
                _f.sent();
            ...
            case 38:
                _f.sent();
                if (!phase) return [3 /*break*/, 40];
                return [4 /*yield*/, effects_1.put(gameInfo_1.gamePhaseUpdate(phase))];
            case 39:
                _f.sent();
                return [3 /*break*/, 42];
            case 40: return [4 /*yield*/, effects_1.put(gameActions_1.updateConnectionStatus(networking_1.ConnectionStatus.RECONNECTED))];
            case 41:
                _f.sent();
                _f.label = 42;
            case 42: return [3 /*break*/, 46];
            case 43: return [4 /*yield*/, effects_1.put(gameActions_1.joinGameError(error))];
            case 44:
                _f.sent();
            ...
            case 45:
                action = _f.sent();
                return [3 /*break*/, 28];
            case 46: return [4 /*yield*/, effects_1.fork(writeActionsToPackets, outgoingRegistry)];
            case 47:
                _f.sent();
                return [2 /*return*/];
        }
