...
var definitionProvider = new gamemode_1.DefinitionProvider();
...
var gamemode_1 = __webpack_require__(/*! @creature-chess/gamemode */ "../gamemode/lib/index.js");
var selectors_1 = __webpack_require__(/*! ../../../../menu/auth/store/selectors */ "./src/menu/auth/store/selectors.ts");
var playerListItem_1 = __webpack_require__(/*! ./playerListItem */ "./src/game/features/playerList/components/playerListItem.tsx");
// todo move this
...
/***/ "./src/game/features/playerList/components/playerListItem.tsx":
/*!********************************************************************!*\
  !*** ./src/game/features/playerList/components/playerListItem.tsx ***!
  \********************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.gameSaga = function (slices) {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 12:
                _d.sent();
                return [4 /*yield*/, effects_1.put(gamemode_1.GameEvents.gamePhaseStartedEvent(phase, phaseStartedAtSeconds))];
            case 13:
                _d.sent();
                ...
                channel = redux_saga_1.eventChannel(function (emit) {
                    ...
                    registry.on(networking_1.ServerToClient.Game.PacketOpcodes.PHASE_UPDATE, function (packet) {
                        ...
                        if (packet.phase === models_1.GamePhase.PREPARING) {
                            emit(gamemode_1.GameEvents.gamePhaseStartedEvent(packet.phase, packet.startedAtSeconds, packet.payload.round));
                        }
                        else {
                            emit(gamemode_1.GameEvents.gamePhaseStartedEvent(packet.phase, packet.startedAtSeconds));
                        }
                        switch (packet.phase) {
                            case models_1.GamePhase.PREPARING: {
                                ...
                                emit(gamemode_1.GameEvents.gamePhaseStartedEvent(packet.phase, packet.startedAtSeconds, round));
...
function reducer(state, action) {
    ...
    switch (action.type) {
        ...
        case gamemode_1.GameEvents.GAME_PHASE_STARTED_EVENT:
...
/***/ "../gamemode/lib/definitions/definitionProvider.js":
/*!*********************************************************!*\
  !*** ../gamemode/lib/definitions/definitionProvider.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var definitions_1 = __webpack_require__(/*! ./definitions */ "../gamemode/lib/definitions/definitions.js");
...
/***/ "../gamemode/lib/definitions/definitions.js":
/*!**************************************************!*\
  !*** ../gamemode/lib/definitions/definitions.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var log_1 = __webpack_require__(/*! ./log */ "../gamemode/lib/log.js");
var definitionProvider_1 = __webpack_require__(/*! ./definitions/definitionProvider */ "../gamemode/lib/definitions/definitionProvider.js");
...
var store_1 = __webpack_require__(/*! ./store */ "../gamemode/lib/store/index.js");
...
var events_2 = __webpack_require__(/*! ./store/events */ "../gamemode/lib/store/events.js");
...
var Game = /** @class */ (function () {
    function Game(options) {
        ...
        this.addPlayer = function (player) {
            ...
            player.setGetGameInfoState(_this.store.getState);
...
var store_2 = __webpack_require__(/*! ./store */ "../gamemode/lib/store/index.js");
__createBinding(exports, store_2, "gameInfoReducer");
...
exports.createPlayerStore = function (getLogger, playerId, name, slices) {
    ...
    var store = redux_1.createStore(redux_1.combineReducers({
        ...
        gameInfo: store_1.gameInfoReducer,
...
exports.__esModule = true;
var store_1 = __webpack_require__(/*! ./store */ "../gamemode/lib/store/store.js");
__createBinding(exports, store_1, "createGameStore");
var reducer_1 = __webpack_require__(/*! ./reducer */ "../gamemode/lib/store/reducer.js");
__createBinding(exports, reducer_1, "reducer", "gameInfoReducer");
exports.GameEvents = __webpack_require__(/*! ./events */ "../gamemode/lib/store/events.js");


/***/ }),

/***/ "../gamemode/lib/store/reducer.js":
/*!****************************************!*\
  !*** ../gamemode/lib/store/reducer.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var events_1 = __webpack_require__(/*! ./events */ "../gamemode/lib/store/events.js");
