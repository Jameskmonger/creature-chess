...
exports.userAuthenticated = function (token, expiry) { return ({
...
function authReducer(state, action) {
    ...
    switch (action.type) {
        case actions_1.USER_AUTHENTICATED:
            var _a = action.payload, token = _a.token, expiry = _a.expiry;
            return tslib_1.__assign(tslib_1.__assign({}, state), { checkingSession: false, token: token, tokenExpiry: expiry });
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, effects_1.put(actions_1.userAuthenticated(existingSession.token, existingSession.expiry))];
            case 2:
                _a.sent();
                return [2 /*return*/];
            ...
            case 6:
                newSession = _a.sent();
                return [4 /*yield*/, effects_1.put(actions_1.userAuthenticated(newSession.token, newSession.expiry))];
            case 7:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.isLoggedIn = function (state) { return state.auth.token !== null; };
