...
var getUser_1 = __webpack_require__(/*! ./getUser */ "./src/getUser.ts");
...
function useUser() {
    ...
    var _a = __read(React.useState(null), 2), currentUser = _a[0], setCurrentUser = _a[1];
    var _b = __read(React.useState(false), 2), isFetching = _b[0], setIsFetching = _b[1];
    var _c = __read(React.useState(null), 2), error = _c[0], setError = _c[1];
    var _d = __read(React.useState(true), 2), shouldRefresh = _d[0], setShouldRefresh = _d[1];
        ...
        var getUser = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        return [4 /*yield*/, (0, getUser_1.getCurrentUser)(token)];
                    case 2:
                        response = _a.sent();
                        setIsFetching(false);
...
var AuthenticatedRootPage = function () {
    ...
    var _b = useUser(), user = _b.user, refresh = _b.refresh;
    if (!user) {
        return React.createElement("span", null, "an error occured");
    }
...
exports.__esModule = true;
exports.usePlayerId = exports.Auth0ContextProvider = exports.AuthContextProvider = exports.AuthProvider = void 0;
...
var _a;
exports.__esModule = true;
exports.AVAILABLE_PROFILE_PICTURES = exports.LOBBY_WAIT_TIME = exports.MAX_PLAYERS_IN_GAME = exports.MAX_NAME_LENGTH = exports.DEFAULT_TURN_DURATION = exports.DEFAULT_TURN_COUNT = exports.PIECES_TO_EVOLVE = exports.BUY_XP_AMOUNT = exports.BUY_XP_COST = exports.HEALTH_LOST_PER_PIECE = exports.MAX_PLAYER_LEVEL = exports.STARTING_HEALTH = exports.STARTING_LEVEL = exports.STARTING_MONEY = exports.REROLL_COST = exports.PHASE_LENGTHS = exports.BENCH_SLOT_COUNT = exports.GRID_SIZE = exports.APP_BASE_URL = void 0;
...
var TypeIndicator = function (_a) {
    var type = _a.type;
    return React.createElement("img", { src: models_1.APP_BASE_URL + "game/" + ICON_FOR_TYPE[type] });
};
...
function CreatureImage(_a) {
    ...
    // TODO these shouldn't come from /game/ server
    return (React.createElement("img", { className: useStyles().image, src: "".concat(models_1.APP_BASE_URL, "game/images/").concat(facing || "front", "/").concat(definitionId, ".png") }));
}
...
function PlayerAvatar(_a) {
    ...
    // TODO these shouldn't come from /game/ server
    return (React.createElement("img", { className: (0, classnames_1["default"])(classes.image, "avatar"), src: "".concat(models_1.APP_BASE_URL, "game/images/front/").concat(player.profile.picture, ".png") }));
}
...
/******/ })()
;
//# sourceMappingURL=bundle-c3765d603ba35bfbdfce.js.map