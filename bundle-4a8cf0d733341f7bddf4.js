...
var Healthbar = function (_a) {
    ...
    return (React.createElement("div", { className: "info" },
        ...
        React.createElement(progressBar_1.ProgressBar, { className: "cooldownbar", current: coolDown, max: models_1.Constants.COOLDOWN_FULL })));
};
...
var TurnSimulator = /** @class */ (function () {
    ...
    TurnSimulator.prototype.takePieceTurn = function (currentTurn, pieceId, board) {
        ...
        if (attacker.coolDown < constants_1.COOLDOWN_FULL) {
            attacker.coolDown += attackerCombatInfo.stats.speed * 2;
            if (attacker.coolDown > constants_1.COOLDOWN_FULL) {
                attacker.coolDown = constants_1.COOLDOWN_FULL;
            }
        }
        // try to find an enemy in attack range
        var attackableEnemy = movement_1.getAttackableEnemy(attacker, attackerCombatInfo.stats.attackType, board);
        if (attackableEnemy) {
            ...
            var defenderCombatInfo = this.getPieceCombatInfo(attackableEnemy);
            ...
            return board_1.boardReducer(board, boardActions_1.updateBoardPieces([updatedFighters.attacker, updatedFighters.defender]));
        }
    ...
    TurnSimulator.prototype.attack = function (attacker, defender) {
        ...
        var damage = (attacker.stats.attack / defender.stats.defense) * attackBonus * 5; // 5 is a magic number
        var newDefenderHealth = Math.max(defender.piece.currentHealth - damage, 0);
        return {
            attacker: tslib_1.__assign(tslib_1.__assign({}, attacker.piece), { coolDown: 0, attacking: {
...
exports.createPiece = function (definitionProvider, ownerId, definitionId, position, id, stage) {
    ...
    return {
        ...
        coolDown: constants_1.COOLDOWN_FULL / 2,
        stage: stage,
        targetPieceId: null
    };
};
