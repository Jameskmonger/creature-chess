...
var useChessboardStyles = (0, react_jss_1.createUseStyles)({
    chessboard: function (_a) {
...
var GameBoard = function (_a) {
    ...
    var _c = __read(React.useState(0), 2), clientHeight = _c[0], setClientHeight = _c[1];
    var _d = __read(React.useState(0), 2), clientWidth = _d[0], setClientWidth = _d[1];
    var isPortrait = clientWidth <= clientHeight;
    var isHalfHeight = board.size.height === 3;
    var styles = useStyles({ portrait: isPortrait, halfHeight: isHalfHeight });
    var chessboardStyles = useChessboardStyles({
        width: isPortrait ? "".concat(clientWidth, "px") : "".concat(clientHeight, "px"),
        height: isPortrait ? "".concat(clientWidth, "px") : "100%"
    });
    ...
    var createRenderer = function (locationType) { return function (item) {
        var piece = item;
    ...
    var chessboardRef = React.useRef(null);
    React.useLayoutEffect(function () {
        var _a;
        if (!((_a = chessboardRef.current) === null || _a === void 0 ? void 0 : _a.parentElement)) {
            return;
        }
        var _b = chessboardRef.current.parentElement, clientWidth = _b.clientWidth, clientHeight = _b.clientHeight;
        setClientHeight(clientHeight);
        setClientWidth(clientWidth);
        // TODO handle resize here
    }, [chessboardRef.current]);
    return (React.createElement("div", { className: styles.boardContainer },
        React.createElement("div", { className: chessboardStyles.chessboard, ref: chessboardRef },
...
function CreatureImage(_a) {
    ...
    return (React.createElement("img", { className: useStyles().image, src: "images/".concat(facing || "front", "/").concat(definitionId, ".png") }));
}
...
function PlayerAvatar(_a) {
    ...
    return (React.createElement("img", { className: (0, classnames_1["default"])(classes.image, "avatar"), src: "images/front/".concat(player.profile.picture, ".png") }));
}
                ...
                React.createElement(layout_1.Layout, { direction: "row" },
                    React.createElement(layout_1.Half, { className: classes.badges },
                        ...
                        React.createElement(display_1.Label, null,
                            "Lv ",
                            player.level)),
                    React.createElement(layout_1.Half, null, currentlySpectating || isExpanded ? (React.createElement(button_1.Button, { onClick: onSpectateClick }, currentlySpectating ? "Stop spectating" : "Spectate")) : (React.createElement(layout_1.Layout, { direction: "row", noSpacer: true },
...
var BoardGridRows = function (_a) {
    ...
    for (var y = 0; y < height; y++) {
        ...
        for (var x = 0; x < width; x++) {
            ...
            tiles.push(canDropPiece ? (react_1["default"].createElement(DroppableTile_1.DroppableTile, { key: "tile-".concat(x), x: x, y: y, onDrop: onDropItem, onClick: onClickTile })) : (react_1["default"].createElement(UndroppableTile_1.UndroppableTile, { key: "tile-".concat(x), x: x, y: y })));
        }
...
/******/ })()
;
//# sourceMappingURL=bundle-8248782c13fb552c2588.js.map