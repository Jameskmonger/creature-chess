...
var BoardGrid = function (_a) {
    ...
    if (showOpponentHalf) {
        for (var y = 0; y < playerHeight; y++) {
            ...
            rows.push(React.createElement("div", { className: "tile-row style-default" }, tiles));
        }
    }
...
var MatchRewardsOverlay = function () {
    ...
    if (justDied) {
        return (React.createElement("div", { className: "victory match-rewards" },
            React.createElement("h2", { className: "game-over" }, "You Died"),
            React.createElement("p", null,
                React.createElement("span", { className: "winner" }, damage),
                " health lost"),
    ...
    if (damage === 0) {
        return (React.createElement("div", { className: "victory match-rewards" },
            React.createElement("h2", { className: "game-over" }, "Round Won"),
    ...
    return (React.createElement("div", { className: "victory match-rewards" },
        React.createElement("h2", { className: "game-over" }, "Round Lost"),
        React.createElement("p", null,
            React.createElement("span", { className: "winner" }, damage),
            " health lost"),
        React.createElement("div", { className: "money" },
...
var StageIndicator = function (_a) {
    ...
    var stars = [];
    for (var i = 1; i <= piece.stage; i++) {
        stars.push(React.createElement("img", { src: "https://creaturechess.local-dev.com:8090/images/ui/star.svg" }));
    }
...
var PlayerListItem = function (props) {
    ...
    var className = "player-list-item " + (props.isLocal ? "local" : "") + " " + (props.isOpponent ? "opponent" : "") + " " + (inPreparingPhase ? readyClassName : "");
...
var CardDeck = /** @class */ (function () {
    ...
    CardDeck.prototype.reroll = function (input, level, count, excludeCards) {
        if (excludeCards === void 0) { excludeCards = []; }
        this.addCards(input);
        this.shuffle();
        return this.take(level, count, excludeCards);
    };
    CardDeck.prototype.take = function (level, count, excludeCards) {
        if (excludeCards === void 0) { excludeCards = []; }
        var output = [];
    ...
    CardDeck.prototype.takeCard = function (level, excludeDefinitions) {
...
var Player = /** @class */ (function () {
    function Player(dependencies, id, name) {
        var _this = this;
        this.match = null;
        this.events = new events_1.EventEmitter();
        ...
        this.rerollCards = function () {
            ...
            var newCards = _this.deck.reroll(cards, _this.getLevel(), 5, excludeIds);
            _this.store.dispatch(playerInfo_1.PlayerInfoCommands.updateCardsCommand(newCards));
        };
        this.id = id;
        this.name = name;
        var _a = store_1.createPlayerStore(dependencies.logger, this.id), store = _a.store, sagaMiddleware = _a.sagaMiddleware;
        this.store = store;
...
exports.buyCardPlayerActionSagaFactory = function (logger, definitionProvider, playerId) {
    return function () {
        var _loop_1, state_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _loop_1 = function () {
                        var action, index, sortPositions, state, card, money, destination, piece, remainingCards;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
...
var commands_1 = __webpack_require__(/*! ../../playerInfo/commands */ "../shared/lib/game/player/playerInfo/commands.js");
var xp_1 = __webpack_require__(/*! ../xp */ "../shared/lib/game/player/sagas/xp.js");
exports.buyXpPlayerActionSagaFactory = function (logger) {
    return function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    logger.info("Player attempted to buy xp costing $" + models_1.BUY_XP_COST + " but only had $" + money);
...
var sagas_1 = __webpack_require__(/*! ./sagas */ "../shared/lib/game/player/sagas/index.js");
var store_1 = __webpack_require__(/*! ../store */ "../shared/lib/game/store/index.js");
exports.createPlayerStore = function (logger, playerId) {
    var rootSaga = function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = effects_1.all;
                    return [4 /*yield*/, effects_1.fork(sagas_1.PlayerActionSagas.buyCardPlayerActionSagaFactory(logger, new definitionProvider_1.DefinitionProvider(), playerId))];
                case 1:
                    _b = [
                        _c.sent()
                    ];
                    return [4 /*yield*/, effects_1.fork(sagas_1.PlayerActionSagas.buyXpPlayerActionSagaFactory(logger))];
                case 2:
                    _b = _b.concat([
                        _c.sent()
                    ]);
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/index.tsx","vendors-node_modules_auth0_auth0-react_dist_auth0-react_esm_js-node_modules_fortawesome_free--85829c"]
/******/ 		];
