...
var readyNotifier_1 = __webpack_require__(/*! ./readyNotifier */ "../shared/game/readyNotifier.ts");
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.race([
                                notifier.promise,
                                this.delayPhaseLength(game_phase_1.GamePhase.PREPARING)
                            ])];
                    case 1:
                        _a.sent();
                        notifier.dispose();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.delayPhaseLength(game_phase_1.GamePhase.READY)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib_1.__generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        this.delayPhaseLength(game_phase_1.GamePhase.PLAYING).then(function () { return battleTimeoutDeferred.resolve(); });
...
exports.__esModule = true;
exports.afterRerollCards = exports.AFTER_REROLL_CARDS = exports.afterSellPiece = exports.AFTER_SELL_PIECE = exports.playerFinishMatch = exports.PLAYER_FINISH_MATCH = void 0;
...
var matchRewards_1 = __webpack_require__(/*! ./sagas/matchRewards */ "../shared/game/player/sagas/matchRewards.ts");
var fillBoard_1 = __webpack_require__(/*! packages/shared/player/sagas/fillBoard */ "../shared/player/sagas/fillBoard.ts");
var sellPiece_1 = __webpack_require__(/*! ../../player/sagas/sellPiece */ "../shared/player/sagas/sellPiece.ts");
var rerollCards_1 = __webpack_require__(/*! ../../player/sagas/rerollCards */ "../shared/player/sagas/rerollCards.ts");
var PlayerEvent;
...
var Player = /** @class */ (function () {
    function Player(id, name) {
        ...
        this.rerollCards = function () {
            ...
            _this.store.dispatch(playerInfo_1.cardsUpdated(newCards));
        };
        ...
        this.sagaMiddleware.run(sellPiece_1.sellPiece);
        this.sagaMiddleware.run(rerollCards_1.rerollCards);
        streak_1.playerStreak(this.sagaMiddleware);
        battle_1.playerBattle(this.sagaMiddleware);
        matchRewards_1.playerMatchRewards(this.sagaMiddleware);
    ...
    Player.prototype.fillBoard = function () {
        this.store.dispatch(fillBoard_1.fillBoardCommand());
    };
    Player.prototype.enterReadyPhase = function (match) {
        this.store.dispatch(benchActions_1.lockBench());
        this.store.dispatch(playerInfo_1.setOpponent(match.away.id));
        this.match = match;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        damage = awayScore * 3;
                        this.store.dispatch(health_1.subtractHealthCommand(this.getGameState().round, damage));
    ...
    Player.prototype.afterRerollCardsSaga = function () {
        var rerollCards = this.rerollCards;
        return function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
...
/***/ "../shared/game/player/sagas/matchRewards.ts":
/*!***************************************************!*\
  !*** ../shared/game/player/sagas/matchRewards.ts ***!
  \***************************************************/
/*! no static exports found */
...
var actions_1 = __webpack_require__(/*! ../actions */ "../shared/game/player/actions.ts");
var playerInfo_1 = __webpack_require__(/*! ../../../player/playerInfo */ "../shared/player/playerInfo/index.ts");
var xp_1 = __webpack_require__(/*! ../../../player/sagas/xp */ "../shared/player/sagas/xp.ts");
                        ...
                        return tslib_1.__generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, effects_1.take(playerInfo_1.CLEAR_OPPONENT)];
                                case 1:
                                    // wait for preparing phase to give money
                                    _c.sent();
                                ...
                                case 3:
                                    ...
                                    return [4 /*yield*/, effects_1.put(playerInfo_1.moneyUpdateAction(currentMoney + rewardMoney))];
                                case 4:
                                    // todo make addMoneyCommand
                                    _c.sent();
...
var limitedQueue_1 = __webpack_require__(/*! ../utils/limitedQueue */ "../shared/utils/limitedQueue.ts");
...
/***/ "../shared/player/sagas/rerollCards.ts":
/*!*********************************************!*\
  !*** ../shared/player/sagas/rerollCards.ts ***!
  \*********************************************/
/*! no static exports found */
...
var actions_1 = __webpack_require__(/*! ../actions */ "../shared/player/actions.ts");
var playerInfo_1 = __webpack_require__(/*! packages/shared/player/playerInfo */ "../shared/player/playerInfo/index.ts");
var actions_2 = __webpack_require__(/*! ../../game/player/actions */ "../shared/game/player/actions.ts");
var playerSelectors_1 = __webpack_require__(/*! ../playerSelectors */ "../shared/player/playerSelectors.ts");
var constants_1 = __webpack_require__(/*! @creature-chess/models/src/constants */ "../models/src/constants.ts");
                        ...
                        switch (_a.label) {
                            ...
                            case 2:
                                ...
                                if (money < constants_1.REROLL_COST) {
                                    console.log("Attempted to reroll costing $" + constants_1.REROLL_COST + " but only had $" + money);
                                    return [2 /*return*/];
                                }
                                return [4 /*yield*/, effects_1.put(playerInfo_1.moneyUpdateAction(money - constants_1.REROLL_COST))];
                            case 3:
                                _a.sent();
                                return [4 /*yield*/, effects_1.put(actions_2.afterRerollCards())];
                            case 4:
                                _a.sent();
                                return [2 /*return*/];
                        }
...
/***/ "../shared/player/sagas/sellPiece.ts":
/*!*******************************************!*\
  !*** ../shared/player/sagas/sellPiece.ts ***!
  \*******************************************/
/*! no static exports found */
                    ...
                    return tslib_1.__generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                ...
                                return [4 /*yield*/, effects_1.put(playerInfo_1.moneyUpdateAction(currentMoney + (pieceCost * piecesUsed)))];
                            case 3:
                                _b.sent();
                            ...
                            case 4:
                                _b.sent();
                                return [3 /*break*/, 7];
                            case 5: return [4 /*yield*/, effects_1.put(boardActions_1.removeBoardPiece(pieceId))];
                            case 6:
                                _b.sent();
                                _b.label = 7;
                            case 7: return [4 /*yield*/, effects_1.put(actions_2.afterSellPiece(piece))];
                            case 8:
                                _b.sent();
                                return [2 /*return*/];
                        }
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, effects_1.takeEvery(actions_1.BUY_XP, function () {
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        if (currentLevel === constants_1.MAX_PLAYER_LEVEL) {
                                    ...
                                    case 3:
                                        ...
                                        if (money < constants_1.BUY_XP_COST) {
                                            console.log("Attempted to buy xp costing $" + constants_1.BUY_XP_COST + " but only had $" + money);
                                            return [2 /*return*/];
                                        }
                                        return [4 /*yield*/, effects_1.put(exports.addXpCommand(constants_1.BUY_XP_AMOUNT))];
                                    case 4:
                                        _a.sent();
                                        return [4 /*yield*/, effects_1.put(playerInfo_1.moneyUpdateAction(money - constants_1.BUY_XP_COST))];
                                    case 5:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, effects_1.fork(fillBoard_1.fillBoardSagaFactory(playerId))];
                case 6: return [4 /*yield*/, _a.apply(void 0, [_b.concat([
                            _c.sent()
                        ])])];
                case 7:
...
var sellPiece_1 = __webpack_require__(/*! @creature-chess/shared/player/sagas/sellPiece */ "../shared/player/sagas/sellPiece.ts");
var rerollCards_1 = __webpack_require__(/*! @creature-chess/shared/player/sagas/rerollCards */ "../shared/player/sagas/rerollCards.ts");
var xp_1 = __webpack_require__(/*! @creature-chess/shared/player/sagas/xp */ "../shared/player/sagas/xp.ts");
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, effects_1.fork(rerollCards_1.rerollCards)];
                case 4:
                    _b = _b.concat([
                        _c.sent()
                    ]);
...
exports.getAnimationCssVariables = function (animations) {
    var variables = Object.assign.apply(Object, tslib_1.__spread([{}], animations.filter(function (a) { return a.variables; }).map(function (a) { return a.variables; })));
    return Object.assign.apply(Object, tslib_1.__spread([{}], Object.keys(variables).map(function (key) {
        var _a;
