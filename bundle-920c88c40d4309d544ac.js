...
var MatchRewardsOverlay = function () {
    ...
    var damage = matchRewards.damage, justDied = matchRewards.justDied, rewardMoney = matchRewards.rewardMoney;
    if (justDied) {
    ...
    if (damage === 0) {
        return (React.createElement("div", { className: "victory" },
            ...
            React.createElement("p", null,
                React.createElement("span", { className: "winner" },
                    "$",
                    rewardMoney),
                " gained")));
    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeLatest(events_1.PLAYER_FINISH_MATCH_EVENT, function (_a) {
                        var win, damage, oldValue, newValue, justDied, currentRound, currentMoney, streak, rewardMoney;
                        var _b = _a.payload, homeScore = _b.homeScore, awayScore = _b.awayScore;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
