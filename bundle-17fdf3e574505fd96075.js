...
var gameStateSelector = function (state) {
    if (state.game.gameInfo.phase !== null) {
...
var onDropPiece = function (dispatch, locationType, board, bench) {
    return function (item, x, y) {
        ...
        dispatch(gamemode_1.PlayerActions.playerDropPieceAction(piece.id, from, location));
        dispatch(actions_1.clearSelectedPiece());
    };
};
var onTileClick = function (dispatch, locationType) {
    return function (x, y) { return dispatch(gamemode_1.PlayerActions.playerClickTileAction({ type: locationType, location: { x: x, y: y } })); };
};
var BoardContainer = function (_a) {
    ...
    var inPreparingPhase = react_redux_1.useSelector(function (state) { return state.game.gameInfo.phase === models_1.GamePhase.PREPARING; });
...
var ReadyUpButton = function () {
    var canReadyUp = react_redux_1.useSelector(function (state) { return state.game.gameInfo.phase === models_1.GamePhase.PREPARING && state.game.playerInfo.ready === false; });
    var dispatch = react_redux_1.useDispatch();
    if (!canReadyUp) {
        return null;
    }
    var onReadyUp = function () { return dispatch(gamemode_1.PlayerActions.readyUpAction()); };
...
var ReconnectOverlay = function () {
    ...
    return (React.createElement(boardOverlay_1.BoardOverlay, null,
        React.createElement("div", { className: "reconnect-overlay" }, connectionStatus === networking_1.ConnectionStatus.DISCONNECTED
...
var selectedPieceSelector = function (state) {
    return state.ui.selectedPieceId
        ? gamemode_1.getPiece(state.game, state.ui.selectedPieceId)
        : null;
};
var SellPieceButton = function (_a) {
    ...
    var onClick = (areYouSure
        ? function () {
            dispatch(gamemode_1.PlayerActions.playerSellPieceAction(pieceId));
        }
        : function () {
            setAreYouSure(true);
        });
...
var Healthbar = function (_a) {
    ...
    var showHealthbar = react_redux_1.useSelector(function (state) { return (state.game.gameInfo.phase === models_1.GamePhase.READY
        || state.game.gameInfo.phase === models_1.GamePhase.PLAYING); });
    var piece = react_redux_1.useSelector(function (state) { return gamemode_1.getPiece(state.game, pieceId); });
...
var React = __importStar(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var use_window_size_1 = __webpack_require__(/*! ./use-window-size */ "./src/game/features/board/use-window-size.ts");
...
/***/ "./src/game/features/board/use-window-size.ts":
/*!****************************************************!*\
  !*** ./src/game/features/board/use-window-size.ts ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var CardShop = function (_a) {
    ...
    var money = react_redux_1.useSelector(function (state) { return gamemode_1.getPlayerMoney(state.game); });
    var canUseShop = react_redux_1.useSelector(function (state) { return state.game.playerInfo.dead === false; });
    ...
    var onBuy = function () {
        ...
        dispatch(gamemode_1.PlayerActions.buyCardAction(currentCardIndex));
        setCurrentCardIndex(null);
    };
...
var RerollButton = function (_a) {
    ...
    var onBuy = function () {
        dispatch(gamemode_1.PlayerActions.rerollCardsAction());
        afterReroll();
    };
...
var ToggleLockButton = function () {
    ...
    var onToggleLock = function () { return dispatch(gamemode_1.PlayerActions.toggleShopLock()); };
...
exports.__esModule = true;
var playerList_1 = __webpack_require__(/*! ./playerList */ "./src/game/features/playerList/index.ts");
...
var NowPlaying = function () {
    var phase = react_redux_1.useSelector(function (state) { return state.game.gameInfo.phase; });
...
var PhaseInfo = function () {
    var phase = react_redux_1.useSelector(function (state) { return state.game.gameInfo.phase; });
    var phaseStartedAtSeconds = react_redux_1.useSelector(function (state) { return state.game.gameInfo.phaseStartedAtSeconds; });
    var isDead = react_redux_1.useSelector(function (state) { return state.game.playerInfo.dead; });
    if (isDead) {
...
/***/ "./src/game/features/playerList/components/battleInfo.tsx":
/*!****************************************************************!*\
  !*** ./src/game/features/playerList/components/battleInfo.tsx ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var selectors_1 = __webpack_require__(/*! ./selectors */ "./src/game/features/playerList/components/selectors.ts");
var playerName_1 = __webpack_require__(/*! ./playerName */ "./src/game/features/playerList/components/playerName.tsx");
...
/***/ "./src/game/features/playerList/components/items/playerListItem.tsx":
/*!**************************************************************************!*\
  !*** ./src/game/features/playerList/components/items/playerListItem.tsx ***!
  \**************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var display_1 = __webpack_require__(/*! ../../../../../ui/display */ "./src/ui/display/index.ts");
var playerName_1 = __webpack_require__(/*! ../playerName */ "./src/game/features/playerList/components/playerName.tsx");
var playerTitle_1 = __webpack_require__(/*! ../playerTitle */ "./src/game/features/playerList/components/playerTitle.tsx");
var battleInfo_1 = __webpack_require__(/*! ../battleInfo */ "./src/game/features/playerList/components/battleInfo.tsx");
var playerPicture_1 = __webpack_require__(/*! ../playerPicture */ "./src/game/features/playerList/components/playerPicture.tsx");
...
/***/ "./src/game/features/playerList/components/items/statusPlayerListItem.tsx":
/*!********************************************************************************!*\
  !*** ./src/game/features/playerList/components/items/statusPlayerListItem.tsx ***!
  \********************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./src/game/features/playerList/components/playerList.tsx":
/*!****************************************************************!*\
  !*** ./src/game/features/playerList/components/playerList.tsx ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var gamemode_1 = __webpack_require__(/*! @creature-chess/gamemode */ "../gamemode/lib/index.js");
var selectors_1 = __webpack_require__(/*! ../../../../menu/auth/store/selectors */ "./src/menu/auth/store/selectors.ts");
var playerListItem_1 = __webpack_require__(/*! ./items/playerListItem */ "./src/game/features/playerList/components/items/playerListItem.tsx");
var statusPlayerListItem_1 = __webpack_require__(/*! ./items/statusPlayerListItem */ "./src/game/features/playerList/components/items/statusPlayerListItem.tsx");
// todo move this
...
var PlayerList = function () {
    ...
    var localPlayerId = react_redux_1.useSelector(selectors_1.getUserId);
    var showReadyIndicators = react_redux_1.useSelector(function (state) { return state.game.gameInfo.phase === models_1.GamePhase.PREPARING; });
...
/***/ "./src/game/features/playerList/components/playerName.tsx":
/*!****************************************************************!*\
  !*** ./src/game/features/playerList/components/playerName.tsx ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./src/game/features/playerList/components/playerPicture.tsx":
/*!*******************************************************************!*\
  !*** ./src/game/features/playerList/components/playerPicture.tsx ***!
  \*******************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./src/game/features/playerList/components/playerTitle.tsx":
/*!*****************************************************************!*\
  !*** ./src/game/features/playerList/components/playerTitle.tsx ***!
  \*****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./src/game/features/playerList/components/selectors.ts":
/*!**************************************************************!*\
  !*** ./src/game/features/playerList/components/selectors.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.__esModule = true;
var playerList_1 = __webpack_require__(/*! ./components/playerList */ "./src/game/features/playerList/components/playerList.tsx");
__createBinding(exports, playerList_1, "PlayerList");
var state_1 = __webpack_require__(/*! ./state */ "./src/game/features/playerList/state.ts");
...
/***/ "./src/game/features/playerList/state.ts":
/*!***********************************************!*\
  !*** ./src/game/features/playerList/state.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./src/game/features/profile/ownedPieceCountSelector.ts":
/*!**************************************************************!*\
  !*** ./src/game/features/profile/ownedPieceCountSelector.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.__esModule = true;
exports.ownedPieceCountSelector = void 0;
var board_1 = __webpack_require__(/*! @creature-chess/board */ "../board/lib/index.js");
var selectors_1 = __webpack_require__(/*! ../../../menu/auth/store/selectors */ "./src/menu/auth/store/selectors.ts");
exports.ownedPieceCountSelector = function (state) {
    var playerId = selectors_1.getUserId(state);
    return board_1.BoardSelectors.getAllPieces(state.game.board).filter(function (p) { return p.ownerId === playerId; }).length;
};
...
var react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
var gamemode_1 = __webpack_require__(/*! @creature-chess/gamemode */ "../gamemode/lib/index.js");
var ownedPieceCountSelector_1 = __webpack_require__(/*! ./ownedPieceCountSelector */ "./src/game/features/profile/ownedPieceCountSelector.ts");
var PieceCount = function (props) {
    ...
    var pieceCount = react_redux_1.useSelector(ownedPieceCountSelector_1.ownedPieceCountSelector);
    if (pieceCount !== level) {
...
var Profile = function () {
    ...
    var health = react_redux_1.useSelector(function (state) {
        var player = state.game.playerList.find(function (p) { return p.id === state.user.user.id; });
    ...
    return (React.createElement("div", { className: "profile" },
        React.createElement("div", { className: "row" },
            ...
            level !== models_2.MAX_PLAYER_LEVEL
                && (React.createElement(progressBar_1.ProgressBar, { className: "xp-progress", current: xp, max: gamemode_1.getXpToNextLevel(level), renderContents: renderProgressBar }))),
        React.createElement("div", { className: "row" },
            React.createElement(pieceCount_1.PieceCount, null),
            level !== models_2.MAX_PLAYER_LEVEL
                && (React.createElement("button", { className: "buy-xp", onClick: function () { return dispatch(gamemode_1.PlayerActions.buyXpAction()); } },
                    "Buy ",
...
var RoundIndicator = function () {
    var round = react_redux_1.useSelector(function (state) { return state.game.gameInfo.round; });
    if (round === null) {
        return null;
    }
...
var QuitGameButton = function () {
    ...
    var onClick = (areYouSure
        ? function () {
            dispatch(gamemode_1.PlayerActions.quitGameAction());
        }
        : function () {
            setAreYouSure(true);
        });
...
/***/ "./src/game/gamePage/gamePage.tsx":
/*!****************************************!*\
  !*** ./src/game/gamePage/gamePage.tsx ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var mobileGame_1 = __webpack_require__(/*! ./layouts/mobileGame */ "./src/game/gamePage/layouts/mobileGame.tsx");
var desktopGame_1 = __webpack_require__(/*! ./layouts/desktopGame */ "./src/game/gamePage/layouts/desktopGame.tsx");
...
/***/ "./src/game/gamePage/layouts/desktopGame.tsx":
/*!***************************************************!*\
  !*** ./src/game/gamePage/layouts/desktopGame.tsx ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var features_1 = __webpack_require__(/*! ../../features */ "./src/game/features/index.ts");
...
var DesktopGame = function () {
    return (React.createElement("div", { className: "game landscape" },
        React.createElement("div", { className: "group" },
            ...
            React.createElement(features_1.PlayerList, null)),
...
/***/ "./src/game/gamePage/layouts/mobileGame.tsx":
/*!**************************************************!*\
  !*** ./src/game/gamePage/layouts/mobileGame.tsx ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var gamePage_1 = __webpack_require__(/*! ./gamePage/gamePage */ "./src/game/gamePage/gamePage.tsx");
...
exports.clickToDrop = function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (false) {}
                return [4 /*yield*/, effects_1.take(gamemode_1.PlayerActions.PLAYER_CLICK_TILE_ACTION)];
            case 1:
                action = _a.sent();
                tile = action.payload.tile;
                return [4 /*yield*/, effects_1.select(function (state) { return state.ui.selectedPieceId ? gamemode_1.getPiece(state.game, state.ui.selectedPieceId) : null; })];
            case 2:
                piece = _a.sent();
                if (!piece) {
                    return [3 /*break*/, 0];
            ...
            case 4:
                ...
                return [4 /*yield*/, effects_1.put(gamemode_1.PlayerActions.playerDropPieceAction(piece.id, from, tile))];
            case 5:
                _a.sent();
...
exports.closeShopOnFirstBuy = function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.take(gamemode_1.PlayerActions.BUY_CARD_ACTION)];
            case 1:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, effects_1.take(gamemode_1.PlayerActions.QUIT_GAME_ACTION)];
            case 1:
                _a.sent();
...
var lobby_1 = __webpack_require__(/*! ../../lobby */ "./src/lobby/index.ts");
var features_1 = __webpack_require__(/*! ../features */ "./src/game/features/index.ts");
var gameInfo_1 = __webpack_require__(/*! packages/gamemode/lib/gameInfo */ "../gamemode/lib/gameInfo/index.js");
exports.gameSaga = function (slices) {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                action = _d.sent();
                return [4 /*yield*/, effects_1.fork(battle_1.battleSagaFactory(function (state) { return state.game.board; }), models_1.defaultGameOptions, slices.boardSlice)];
            case 2:
                _d.sent();
            ...
            case 11:
                _d.sent();
                return [4 /*yield*/, effects_1.put(features_1.PlayerListCommands.updatePlayerListCommand(players))];
            case 12:
                _d.sent();
                update = { phase: phase, startedAt: phaseStartedAtSeconds };
                return [4 /*yield*/, effects_1.put(gamemode_1.GameEvents.gamePhaseStartedEvent(update))];
            case 13:
                _d.sent();
                return [4 /*yield*/, effects_1.put(gameInfo_1.GameInfoCommands.setGameInfoCommand(update))];
            case 14:
                _d.sent();
...
var loading_1 = __webpack_require__(/*! ../ui/display/loading */ "./src/ui/display/loading.tsx");
var config_1 = __webpack_require__(/*! ./auth/config */ "./src/menu/auth/config.ts");
var actions_2 = __webpack_require__(/*! ./actions */ "./src/menu/actions.ts");
var Navbar = function () {
...
var mapDispatchToProps = function (dispatch) { return ({
    onFindGame: function (serverIP) { return dispatch(actions_2.findGameAction(serverIP)); },
...
/***/ "./src/networking/connection-status.ts":
/*!*********************************************!*\
  !*** ./src/networking/connection-status.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
var connection_status_1 = __webpack_require__(/*! ./connection-status */ "./src/networking/connection-status.ts");
            ...
            case 0:
                channel = redux_saga_1.eventChannel(function (emit) {
                    ...
                    registry.on(networking_1.ServerToClient.Game.PacketOpcodes.PLAYER_LIST_UPDATE, function (packet) {
                        emit(features_1.PlayerListCommands.updatePlayerListCommand(packet));
                    });
                    ...
                    registry.on(networking_1.ServerToClient.Game.PacketOpcodes.FINISH_GAME, function (packet) {
                    ...
                    registry.on(networking_1.ServerToClient.Game.PacketOpcodes.PHASE_UPDATE, function (packet) {
                        ...
                        emit(gamemode_1.GameEvents.gamePhaseStartedEvent(update));
                        emit(gameInfo_1.GameInfoCommands.setGameInfoCommand(update));
                        switch (packet.phase) {
                            case models_1.GamePhase.PREPARING: {
                                ...
                                emit(gamemode_1.PlayerCommands.updateCardsCommand(cards));
                                emit(gamemode_1.PlayerInfoCommands.clearOpponentCommand());
                            ...
                            case models_1.GamePhase.READY: {
                                ...
                                emit(gamemode_1.PlayerInfoCommands.updateOpponentCommand(opponentId));
...
var sendPlayerActions = function (registry) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                if (false) {}
                return [4 /*yield*/, effects_1.take(gamemode_1.PlayerActions.PlayerActionTypesArray)];
            case 2:
                action = _a.sent();
                index = ++lastSentIndex;
...
exports.rootSaga = function (getAccessTokenSilently, loginWithRedirect, slices) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, effects_1.fork(networking_1.findGame, { getAccessTokenSilently: getAccessTokenSilently, loginWithRedirect: loginWithRedirect }, slices)];
            case 2:
                _a.sent();
...
exports.__esModule = true;
exports.finishGameAction = exports.updateConnectionStatus = exports.closeOverlay = exports.openOverlay = exports.joinGameError = exports.clearSelectedPiece = exports.selectPiece = exports.CLEAR_SELECTED_PIECE = exports.SELECT_PIECE = exports.FINISH_GAME = exports.JOIN_ERROR = exports.UPDATE_CONNECTION_STATUS = exports.CLOSE_OVERLAY = exports.OPEN_OVERLAY = void 0;
...
function reducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case menu_1.MenuActions.FIND_GAME:
...
var CardDeck = /** @class */ (function () {
    function CardDeck(logger, definitions) {
        var _this = this;
        this.logger = logger;
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var opponentProvider_1 = __webpack_require__(/*! ./opponentProvider */ "../gamemode/lib/opponentProvider.js");
var playerList_1 = __webpack_require__(/*! ./playerList */ "../gamemode/lib/playerList.js");
var cardDeck_1 = __webpack_require__(/*! ./cardDeck */ "../gamemode/lib/cardDeck.js");
var events_2 = __webpack_require__(/*! ./events */ "../gamemode/lib/events.js");
...
var phases_1 = __webpack_require__(/*! ./game/phases */ "../gamemode/lib/game/phases/index.js");
var state_1 = __webpack_require__(/*! ./gameInfo/state */ "../gamemode/lib/gameInfo/state.js");
    ...
    function Game(createLogger, players, options) {
        ...
        this.sendPublicEventsSagaFactory = function () {
            ...
            return function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, effects_1.takeLatest(state_1.setGameInfoCommand.toString(), function (_a) {
                                var payload = _a.payload;
                                return __generator(this, function (_b) {
                                    _this.dispatchPublicGameEvent(events_2.gamePhaseStartedEvent(payload));
                                    return [2 /*return*/];
                                });
                            })];
                        case 1:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            _this.logger.info("Game started with " + players.length + " players: " + players.map(function (p) { return p.name; }).join(", "));
                            _a.label = 1;
                        case 1:
                            if (false) {}
                            return [4 /*yield*/, effects_1.call(phases_1.runPreparingPhase, _this.players, _this.options.phaseLengths[models_1.GamePhase.PREPARING] * 1000)];
                        case 2:
                            _a.sent();
                            _this.updateOpponentProvider();
                            return [4 /*yield*/, effects_1.call(phases_1.runReadyPhase, _this.opponentProvider, _this.players, _this.options.phaseLengths[models_1.GamePhase.READY] * 1000, _this.options)];
                        case 3:
                            _a.sent();
                            return [4 /*yield*/, effects_1.call(phases_1.runPlayingPhase, _this.players, _this.options.phaseLengths[models_1.GamePhase.PLAYING] * 1000)];
                        case 4:
                            _a.sent();
                            ...
                            return [3 /*break*/, 1];
                        case 5:
                            winnerId = _this.getPlayerList()[0].id;
                            ...
                            winner = _this.players.find(function (p) { return p.id === winnerId; });
                            event = events_2.gameFinishEvent({ winnerName: winner.name });
                            _this.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT; }).forEach(function (p) { return p.receiveGameEvent(event); });
                            gamePlayers = _this.players.map(function (p) { return ({
                                id: p.id,
                                name: p.name
                            }); });
        ...
        this.addPlayer = function (player) {
            player.setLogger(_this_1.logger);
            _this_1.players.push(player);
            _this_1.playerList.addPlayer(player);
            player.setDeck(_this_1.deck);
            player.setGetGameInfoState(function () { return _this_1.store.getState().gameInfo; });
            player.setGetPlayerListPlayers(_this_1.playerList.getValue);
        };
        this.onPlayerListUpdate = function (players) {
            _this_1.dispatchPublicGameEvent(events_2.playerListChangedEvent({ players: players }));
        };
        this.getLivingPlayers = function () { return _this_1.players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.isAlive(); }); };
        this.id = uuid_1.v4();
        ...
        this.deck = new cardDeck_1.CardDeck(this.logger, definitions_1.getAllDefinitions());
...
/***/ "../gamemode/lib/game/phases/index.js":
/*!********************************************!*\
  !*** ../gamemode/lib/game/phases/index.js ***!
  \********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
var playing_1 = __webpack_require__(/*! ./playing */ "../gamemode/lib/game/phases/playing.js");
__createBinding(exports, playing_1, "runPlayingPhase");
var preparing_1 = __webpack_require__(/*! ./preparing */ "../gamemode/lib/game/phases/preparing.js");
__createBinding(exports, preparing_1, "runPreparingPhase");
var ready_1 = __webpack_require__(/*! ./ready */ "../gamemode/lib/game/phases/ready.js");
__createBinding(exports, ready_1, "runReadyPhase");


/***/ }),

/***/ "../gamemode/lib/game/phases/playing.js":
/*!**********************************************!*\
  !*** ../gamemode/lib/game/phases/playing.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var gameInfo_1 = __webpack_require__(/*! ../../gameInfo */ "../gamemode/lib/gameInfo/index.js");
var getLivingPlayers = function (players) { return players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.isAlive(); }); };
exports.runPlayingPhase = function (players, phaseLengthMs) {
    var battleTimeoutDeferred, phase, startedAt, promises, round, _a, _b, player;
    var e_1, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                battleTimeoutDeferred = pDefer();
                delay_1["default"](phaseLengthMs).then(function () { return battleTimeoutDeferred.resolve(); });
                phase = models_1.GamePhase.PLAYING;
                startedAt = Date.now() / 1000;
                return [4 /*yield*/, effects_1.put(gameInfo_1.GameInfoCommands.setGameInfoCommand({ phase: phase, startedAt: startedAt }))];
            case 1:
                _d.sent();
                promises = getLivingPlayers(players).map(function (p) { return p.fightMatch(startedAt, battleTimeoutDeferred); });
                return [4 /*yield*/, Promise.all(promises)];
            case 2:
                _d.sent();
                return [4 /*yield*/, effects_1.select(function (state) { return state.gameInfo.round; })];
            case 3:
                round = _d.sent();
                try {
                    for (_a = __values(players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.getRoundDiedAt() === round; })), _b = _a.next(); !_b.done; _b = _a.next()) {
                        player = _b.value;
                        player.kill();
                    }
                }
...
/***/ "../gamemode/lib/game/phases/preparing.js":
/*!************************************************!*\
  !*** ../gamemode/lib/game/phases/preparing.js ***!
  \************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var gameInfo_1 = __webpack_require__(/*! ../../gameInfo */ "../gamemode/lib/gameInfo/index.js");
var readyNotifier_1 = __webpack_require__(/*! ../../readyNotifier */ "../gamemode/lib/readyNotifier/index.js");
var getLivingPlayers = function (players) { return players.filter(function (p) { return p.getStatus() !== models_1.PlayerStatus.QUIT && p.isAlive(); }); };
exports.runPreparingPhase = function (players, phaseLengthMs) {
    var round, phase, startedAt, notifier;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.select(function (state) { return state.gameInfo.round; })];
            case 1:
                round = _a.sent();
                phase = models_1.GamePhase.PREPARING;
                startedAt = Date.now() / 1000;
                return [4 /*yield*/, effects_1.put(gameInfo_1.GameInfoCommands.setGameInfoCommand({ phase: phase, startedAt: startedAt, round: round + 1 }))];
            case 2:
                _a.sent();
                getLivingPlayers(players).forEach(function (p) { return p.enterPreparingPhase(); });
                notifier = readyNotifier_1.readyNotifier(players);
                return [4 /*yield*/, effects_1.race([
                        notifier.promise,
                        effects_1.delay(phaseLengthMs)
                    ])];
            case 3:
                _a.sent();
                notifier.dispose();
                getLivingPlayers(players).forEach(function (p) { return p.fillBoard(); });
                return [2 /*return*/];
        }
    });
};
...
/***/ "../gamemode/lib/game/phases/ready.js":
/*!********************************************!*\
  !*** ../gamemode/lib/game/phases/ready.js ***!
  \********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var gameInfo_1 = __webpack_require__(/*! ../../gameInfo */ "../gamemode/lib/gameInfo/index.js");
var match_1 = __webpack_require__(/*! ../../match */ "../gamemode/lib/match.js");
exports.runReadyPhase = function (opponentProvider, players, phaseLengthMs, options) {
    var matchups, phase, startedAt;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                matchups = opponentProvider.getMatchups();
                matchups.forEach(function (_a) {
                    var homeId = _a.homeId, awayId = _a.awayId, awayIsClone = _a.awayIsClone;
                    var homePlayer = players.find(function (p) { return p.id === homeId; });
                    var awayPlayer = players.find(function (p) { return p.id === awayId; });
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, effects_1.delay(phaseLengthMs)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
/***/ "../gamemode/lib/gameInfo/index.js":
/*!*****************************************!*\
  !*** ../gamemode/lib/gameInfo/index.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
var state_1 = __webpack_require__(/*! ./state */ "../gamemode/lib/gameInfo/state.js");
__createBinding(exports, state_1, "GameInfoCommands");
__createBinding(exports, state_1, "reducer", "gameInfoReducer");


/***/ }),

/***/ "../gamemode/lib/gameInfo/state.js":
/*!*****************************************!*\
  !*** ../gamemode/lib/gameInfo/state.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var _a;
exports.__esModule = true;
exports.GameInfoCommands = exports.setGameInfoCommand = exports.reducer = void 0;
var toolkit_1 = __webpack_require__(/*! @reduxjs/toolkit */ "../gamemode/node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
var initialState = {
    round: null,
    phase: null,
...
exports.reducer = (_a = toolkit_1.createSlice({
    ...
    initialState: initialState,
    reducers: {
        setGameInfoCommand: function (state, command) {
...
}), _a.reducer), exports.setGameInfoCommand = _a.actions.setGameInfoCommand;
var GameInfoCommands = { setGameInfoCommand: exports.setGameInfoCommand };
exports.GameInfoCommands = GameInfoCommands;


/***/ }),

/***/ "../gamemode/lib/getXpToNextLevel.js":
/*!*******************************************!*\
  !*** ../gamemode/lib/getXpToNextLevel.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var gameInfo_1 = __webpack_require__(/*! ./gameInfo */ "../gamemode/lib/gameInfo/index.js");
__createBinding(exports, gameInfo_1, "gameInfoReducer");
exports.GameEvents = __webpack_require__(/*! ./events */ "../gamemode/lib/events.js");
var definitions_1 = __webpack_require__(/*! ./definitions */ "../gamemode/lib/definitions/index.js");
__createBinding(exports, definitions_1, "getDefinitionById");
var match_1 = __webpack_require__(/*! ./match */ "../gamemode/lib/match.js");
__createBinding(exports, match_1, "Match");
var getXpToNextLevel_1 = __webpack_require__(/*! ./getXpToNextLevel */ "../gamemode/lib/getXpToNextLevel.js");
...
/***/ "../gamemode/lib/opponentProvider.js":
/*!*******************************************!*\
  !*** ../gamemode/lib/opponentProvider.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "../gamemode/lib/player/actions.js":
/*!*****************************************!*\
  !*** ../gamemode/lib/player/actions.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, exports) => {
...
__createBinding(exports, player_1, "Player");
exports.PlayerActions = __webpack_require__(/*! ./actions */ "../gamemode/lib/player/actions.js");
...
var actions_1 = __webpack_require__(/*! ./actions */ "../gamemode/lib/player/actions.js");
var events_3 = __webpack_require__(/*! ../events */ "../gamemode/lib/events.js");
var cardShop_1 = __webpack_require__(/*! ./cardShop */ "../gamemode/lib/player/cardShop.js");
var PlayerEvent;
...
var Player = /** @class */ (function () {
    ...
    Player.prototype.setGetGameInfoState = function (fn) {
...
exports.PlayerActionSagas = __webpack_require__(/*! ./playerActions */ "../gamemode/lib/player/sagas/playerActions/index.js");
...
/***/ "../gamemode/lib/player/sagas/playerActions/buyCard.js":
/*!*************************************************************!*\
  !*** ../gamemode/lib/player/sagas/playerActions/buyCard.js ***!
  \*************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var board_1 = __webpack_require__(/*! @creature-chess/board */ "../board/lib/index.js");
var createPieceFromCard_1 = __webpack_require__(/*! ./createPieceFromCard */ "../gamemode/lib/player/sagas/playerActions/createPieceFromCard.js");
var playerSelectors_1 = __webpack_require__(/*! ../../playerSelectors */ "../gamemode/lib/player/playerSelectors.js");
var commands_1 = __webpack_require__(/*! ../../playerInfo/commands */ "../gamemode/lib/player/playerInfo/commands.js");
var cardShop_1 = __webpack_require__(/*! ../../cardShop */ "../gamemode/lib/player/cardShop.js");
var getCardDestination = function (state, playerId, sortPositions) {
    ...
    var inPreparingPhase = state.gameInfo.phase === models_1.GamePhase.PREPARING;
...
exports.buyCardPlayerActionSagaFactory = function (getLogger, _a, playerId, name) {
    var boardSlice = _a.boardSlice, benchSlice = _a.benchSlice;
    return function () {
        var _loop_1;
        return __generator(this, function (_a) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 8:
                                    ...
                                    piece = createPieceFromCard_1.createPieceFromCard(playerId, card);
...
/***/ "../gamemode/lib/player/sagas/playerActions/buyXp.js":
/*!***********************************************************!*\
  !*** ../gamemode/lib/player/sagas/playerActions/buyXp.js ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "../gamemode/lib/player/sagas/playerActions/createPieceFromCard.js":
/*!*************************************************************************!*\
  !*** ../gamemode/lib/player/sagas/playerActions/createPieceFromCard.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var uuid_1 = __webpack_require__(/*! uuid */ "../gamemode/node_modules/uuid/dist/esm-browser/index.js");
var definitions_1 = __webpack_require__(/*! ../../../definitions */ "../gamemode/lib/definitions/index.js");
exports.createPiece = function (ownerId, definitionId, id, stage) {
...
exports.createPieceFromCard = function (ownerId, card) {
    return exports.createPiece(ownerId, card.definitionId, card.id);
};


/***/ }),

/***/ "../gamemode/lib/player/sagas/playerActions/dropPiece.js":
/*!***************************************************************!*\
  !*** ../gamemode/lib/player/sagas/playerActions/dropPiece.js ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "../gamemode/lib/player/sagas/playerActions/index.js":
/*!***********************************************************!*\
  !*** ../gamemode/lib/player/sagas/playerActions/index.js ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
var buyCard_1 = __webpack_require__(/*! ./buyCard */ "../gamemode/lib/player/sagas/playerActions/buyCard.js");
__createBinding(exports, buyCard_1, "buyCardPlayerActionSagaFactory");
var buyXp_1 = __webpack_require__(/*! ./buyXp */ "../gamemode/lib/player/sagas/playerActions/buyXp.js");
__createBinding(exports, buyXp_1, "buyXpPlayerActionSagaFactory");
var dropPiece_1 = __webpack_require__(/*! ./dropPiece */ "../gamemode/lib/player/sagas/playerActions/dropPiece.js");
__createBinding(exports, dropPiece_1, "dropPiecePlayerActionSagaFactory");
var rerollCards_1 = __webpack_require__(/*! ./rerollCards */ "../gamemode/lib/player/sagas/playerActions/rerollCards.js");
__createBinding(exports, rerollCards_1, "rerollCardsPlayerActionSagaFactory");
var sellPiece_1 = __webpack_require__(/*! ./sellPiece */ "../gamemode/lib/player/sagas/playerActions/sellPiece.js");
__createBinding(exports, sellPiece_1, "sellPiecePlayerActionSagaFactory");
var toggleShopLock_1 = __webpack_require__(/*! ./toggleShopLock */ "../gamemode/lib/player/sagas/playerActions/toggleShopLock.js");
__createBinding(exports, toggleShopLock_1, "toggleShopLockPlayerActionSagaFactory");


/***/ }),

/***/ "../gamemode/lib/player/sagas/playerActions/rerollCards.js":
/*!*****************************************************************!*\
  !*** ../gamemode/lib/player/sagas/playerActions/rerollCards.js ***!
  \*****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "../gamemode/lib/player/sagas/playerActions/sellPiece.js":
/*!***************************************************************!*\
  !*** ../gamemode/lib/player/sagas/playerActions/sellPiece.js ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
exports.sellPiecePlayerActionSagaFactory = exports.PIECES_FOR_STAGE = void 0;
var effects_1 = __webpack_require__(/*! @redux-saga/core/effects */ "../gamemode/node_modules/@redux-saga/core/dist/redux-saga-effects.esm.js");
var pieceSelectors_1 = __webpack_require__(/*! ../../pieceSelectors */ "../gamemode/lib/player/pieceSelectors.js");
var actions_1 = __webpack_require__(/*! ../../actions */ "../gamemode/lib/player/actions.js");
var commands_1 = __webpack_require__(/*! ../../playerInfo/commands */ "../gamemode/lib/player/playerInfo/commands.js");
var events_1 = __webpack_require__(/*! ../../events */ "../gamemode/lib/player/events.js");
exports.PIECES_FOR_STAGE = [1, 3, 9];
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    piecesUsed = exports.PIECES_FOR_STAGE[piece.stage];
...
/***/ "../gamemode/lib/player/sagas/playerActions/toggleShopLock.js":
/*!********************************************************************!*\
  !*** ../gamemode/lib/player/sagas/playerActions/toggleShopLock.js ***!
  \********************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    oldLevel = level;
                    for (i = 0; i < amount; i++) {
                        toNextLevel = getXpToNextLevel_1.getXpToNextLevel(level);
                        newXp = xp + 1;
                ...
                case 4:
                    ...
                    return [4 /*yield*/, effects_1.select(function (state) { return state.gameInfo.phase === models_1.GamePhase.PREPARING; })];
                case 5:
    ...
    var rootSaga = function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = effects_1.all;
                    return [4 /*yield*/, effects_1.fork(sagas_1.PlayerActionSagas.buyCardPlayerActionSagaFactory(getLogger, slices, playerId, name))];
                case 1:
                    _b = [
                        _c.sent()
                    ];
...
/***/ "../gamemode/lib/readyNotifier/index.js":
/*!**********************************************!*\
  !*** ../gamemode/lib/readyNotifier/index.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var limitedQueue_1 = __webpack_require__(/*! ./limitedQueue */ "../gamemode/lib/readyNotifier/limitedQueue.js");
...
/***/ "../gamemode/lib/readyNotifier/limitedQueue.js":
/*!*****************************************************!*\
  !*** ../gamemode/lib/readyNotifier/limitedQueue.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/index.tsx","vendors-node_modules_auth0_auth0-react_dist_auth0-react_esm_js-node_modules_fortawesome_free--0d0541"]
/******/ 		];
