...
exports.battleEventChannel = function (startingBoardState, options, bufferSize) {
...
exports.battle = function (gameOptions) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeEvery(START_BATTLE, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                board = _a.sent();
                                return [4 /*yield*/, effects_1.call(battleEventChannel_1.battleEventChannel, board, gameOptions, 100)];
                            case 2:
...
var takePieceTurn = function (currentTurn, pieceId, board) {
    ...
    if (attackableEnemy) {
        ...
        var attackResult = attack(attacker, attackableEnemy);
...
var attack = function (attacker, defender) {
    ...
    return {
        attacker: __assign(__assign({}, attacker), { attacking: {
                ...
                damage: damage
            }, targetPieceId: defender.id, facingAway: getNewAttackerFacingAway(attacker.facingAway, attackerDirection) }),
        ...
        var rootSaga = function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = effects_1.all;
                        return [4 /*yield*/, effects_1.fork(combat_1.battle, gameOptions)];
                    case 1:
                        _b = [
                            _c.sent()
                        ];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 9:
                    ...
                    return [4 /*yield*/, effects_1.fork(shared_1.battle, shared_1.defaultGameOptions)];
