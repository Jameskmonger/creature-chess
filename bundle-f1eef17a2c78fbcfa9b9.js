            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.store.dispatch(store_1.GameCommands.startPreparingPhaseCommand(round + 1, Date.now() / 1000));
    ...
    Game.prototype.runReadyPhase = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.store.dispatch(store_1.GameCommands.startGamePhaseCommand(models_1.GamePhase.READY, Date.now() / 1000));
                        this.updateOpponentProvider();
    ...
    Game.prototype.runPlayingPhase = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        this.store.dispatch(store_1.GameCommands.startGamePhaseCommand(models_1.GamePhase.PLAYING, Date.now() / 1000));
...
__createBinding(exports, store_2, "GameCommands", "GameActions");
var match_1 = __webpack_require__(/*! ./match */ "../shared/lib/game/match/index.js");
...
exports.__esModule = true;
exports.battleEventChannel = exports.BATTLE_FINISH_EVENT = exports.BATTLE_TURN = void 0;
...
var battleEventChannel_1 = __webpack_require__(/*! ./battleEventChannel */ "../shared/lib/game/match/combat/battleEventChannel.js");
__createBinding(exports, battleEventChannel_1, "BATTLE_FINISH_EVENT");
...
var TurnSimulator = /** @class */ (function () {
    ...
    TurnSimulator.prototype.takePieceTurn = function (currentTurn, pieceId, board) {
        ...
        if (attackableEnemy) {
            ...
            return board_1.boardReducer(board, board_1.BoardCommands.updateBoardPieces([attackResult.attacker, attackResult.defender]));
        }
...
exports.__esModule = true;
exports.afterRerollCardsEvent = exports.AFTER_REROLL_CARDS_EVENT = exports.afterSellPieceEvent = exports.AFTER_SELL_PIECE_EVENT = exports.playerFinishMatchEvent = exports.PLAYER_FINISH_MATCH_EVENT = void 0;
...
var Player = /** @class */ (function () {
    ...
    Player.prototype.quitGame = function () {
        this.store.dispatch(playerInfo_1.PlayerInfoCommands.updateStatusCommand(models_1.PlayerStatus.QUIT));
        // todo combine these
...
exports.cardShopSagaFactory = function (definitionProvider, playerId) {
    return function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeEvery(actions_1.BUY_CARD_ACTION, function (_a) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 4:
                                    _b.sent();
                                    _b.label = 5;
                                case 5: return [4 /*yield*/, effects_1.put(commands_2.updateMoneyCommand(money - card.cost))];
                                case 6:
                                    _b.sent();
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, effects_1.takeEvery(actions_1.BUY_XP_ACTION, function () {
...
/***/ "../shared/lib/game/store/commands.js":
/*!********************************************!*\
  !*** ../shared/lib/game/store/commands.js ***!
  \********************************************/
/*! no static exports found */
...
exports.__esModule = true;
exports.startPreparingPhaseCommand = exports.startGamePhaseCommand = exports.START_GAME_PHASE_COMMAND = void 0;
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
exports.START_GAME_PHASE_COMMAND = "START_GAME_PHASE_COMMAND";
exports.startGamePhaseCommand = function (phase, startedAt) { return ({
    type: exports.START_GAME_PHASE_COMMAND,
    payload: { phase: phase, startedAt: startedAt }
}); };
exports.startPreparingPhaseCommand = function (round, startedAt) { return ({
    type: exports.START_GAME_PHASE_COMMAND,
...
exports.GameCommands = __webpack_require__(/*! ./commands */ "../shared/lib/game/store/commands.js");
...
var commands_1 = __webpack_require__(/*! ./commands */ "../shared/lib/game/store/commands.js");
...
function reducer(state, command) {
    ...
    switch (command.type) {
        case commands_1.START_GAME_PHASE_COMMAND:
...
var subscribe = function (registry, lobbyRegistry, socket) {
    return redux_saga_1.eventChannel(function (emit) {
        ...
        registry.on(shared_1.ServerToClientPacketOpcodes.PHASE_UPDATE, function (packet) {
            ...
            emit(shared_1.GameActions.startGamePhaseCommand(packet.phase, packet.startedAtSeconds));
            switch (packet.phase) {
        ...
        registry.on(shared_1.ServerToClientPacketOpcodes.JOIN_GAME, function (_a) {
            ...
            emit(shared_1.PlayerInfoCommands.updateMoneyCommand(money));
            emit(shared_1.PlayerInfoCommands.updateCardsCommand(cards));
            emit(playerListActions_1.playerListUpdated(players));
            emit(shared_1.PlayerInfoCommands.updateLevelCommand(level, xp));
            emit(shared_1.BoardCommands.initialiseBoard(board));
            emit(shared_1.BenchCommands.initialiseBenchCommand(bench));
            if (phase) {
                emit(shared_1.GameActions.startGamePhaseCommand(phase.phase, phase.startedAtSeconds));
            }
            else {
...
exports.__esModule = true;
exports.playersResurrected = exports.finishGameAction = exports.updateConnectionStatus = exports.enableDebugMode = exports.clearAnnouncement = exports.updateAnnouncement = exports.closeOverlay = exports.openOverlay = exports.joinGameError = exports.joinCompleteAction = exports.findGameAction = exports.PLAYERS_RESURRECTED = exports.FINISH_GAME = exports.JOIN_ERROR = exports.JOIN_COMPLETE = exports.UPDATE_CONNECTION_STATUS = exports.ENABLE_DEBUG_MODE = exports.CLEAR_ANNOUNCEMENT = exports.UPDATE_ANNOUNCEMENT = exports.CLOSE_OVERLAY = exports.OPEN_OVERLAY = exports.FIND_GAME = void 0;
