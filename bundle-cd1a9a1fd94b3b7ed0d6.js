...
var getBoardInformation = function (width, height) {
    if (inPortraitMode(width, height)) {
        // board + spacing
        var colsRequired = models_1.Constants.GRID_SIZE;
...
exports.networking = function () {
    var action, state, isLoggedIn, idToken, socket, chosenNickname, e_1, nickname, error, nickname, error, outgoingRegistry, incomingRegistry, _a, error, response;
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 9:
                nickname = (_b.sent()).payload.nickname;
            ...
            case 30:
                _b.sent();
                return [3 /*break*/, 34];
            case 31: return [4 /*yield*/, effects_1.put(gameActions_1.joinGameError(error))];
            case 32:
                _b.sent();
            ...
            case 33:
                action = _b.sent();
                return [3 /*break*/, 28];
            case 34: return [4 /*yield*/, effects_1.fork(writeActionsToPackets, outgoingRegistry)];
            case 35:
                _b.sent();
                return [2 /*return*/];
        }
