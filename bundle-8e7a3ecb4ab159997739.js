    ...
    for (var y = 0; y < height; y++) {
        ...
        for (var x = 0; x < width; x++) {
            ...
            tiles.push((!tileContainsPiece && !locked)
                ? React.createElement(DroppableTile_1.DroppableTile, { key: "tile-" + x, className: className, location: location_1, onDrop: onDrop, onClick: onClick })
...
var DroppableTile = function (_a) {
    var className = _a.className, location = _a.location, onDrop = _a.onDrop, onClick = _a.onClick;
    var belowPieceLimit = context_1.useBelowPieceLimit();
    var pieces = context_1.usePieces();
    var _b = __read(react_dnd_1.useDrop({
        accept: "Piece",
        drop: function (item) { return onDrop(item, location); },
        canDrop: function (_a) {
            var piece = _a.piece;
    ...
    return (React.createElement("div", { ref: drop, className: "tile " + className + " style-default", "touch-action": "none", onPointerUp: function () { return onClick(location); } },
...
var BenchPieces = function () {
    ...
    pieces.forEach(function (piece, index) {
        ...
        pieceElements.push(React.createElement(positionablePiece_1.PositionablePiece, { key: piece.id, id: piece.id, x: index, y: 0, draggable: true, animate: false, selected: selected, pieceIsOnBench: true }));
    });
    return (React.createElement(React.Fragment, null, pieceElements));
};
var getLocationForPiece = function (pieceId, board, bench) {
    if (board) {
        var boardPiecePosition = shared_1.BoardSelectors.getPiecePosition(board, pieceId);
    ...
    if (bench) {
        var benchSlot = bench.pieces.findIndex(function (p) { return p !== null && p.id === pieceId; });
        if (benchSlot > -1) {
            return {
                type: "bench",
...
var onDropPiece = function (dispatch, board, bench) {
    return function (_a, location) {
        var piece = _a.piece;
...
var Bench = function () {
    ...
    for (var x = 0; x < models_1.Constants.GRID_SIZE.width; x++) {
        ...
        var onTileClick = function (location) { return dispatch(shared_1.PlayerActions.playerClickTileAction(location)); };
        if (locked || !tileEmpty) {
            tiles.push(React.createElement(UndroppableTile_1.UndroppableTile, { key: "tile-" + x, className: "bench" }));
        }
        else {
            tiles.push(React.createElement(DroppableTile_1.DroppableTile, { key: "tile-" + x, className: "bench", location: location_1, onDrop: onDropPiece(dispatch, board, bench), onClick: onTileClick }));
        }
    }
...
var BoardPieces = function (props) {
    ...
    var entries = Object.entries(pieces);
    ...
    try {
        for (var entries_1 = __values(entries), entries_1_1 = entries_1.next(); !entries_1_1.done; entries_1_1 = entries_1.next()) {
            var _b = __read(entries_1_1.value, 2), position = _b[0], id = _b[1];
            if (!id) {
                continue;
            }
    ...
    return (React.createElement("div", { className: "board-pieces" }, pieceElements));
};
var getLocationForPiece = function (pieceId, board, bench) {
    if (board) {
        var boardPiecePosition = shared_1.BoardSelectors.getPiecePosition(board, pieceId);
    ...
    return (React.createElement("div", { className: "chessboard" },
        ...
        React.createElement("div", { className: "board-tiles" },
            React.createElement(context_1.BoardContextProvider, { value: board },
                React.createElement(BoardGrid_1.BoardGrid, { onDrop: onDropPiece(dispatch, board, bench), onClick: onTileClick })),
...
var PositionablePiece = function (_a) {
    var id = _a.id, x = _a.x, y = _a.y, draggable = _a.draggable, animate = _a.animate, selected = _a.selected, _b = _a.pieceIsOnBench, pieceIsOnBench = _b === void 0 ? false : _b;
    return (React.createElement("div", { className: "positionable-piece x-" + x + " y-" + y },
        React.createElement(pieceComponent_1.PieceComponent, { id: id, draggable: draggable, animate: animate, selected: selected, pieceIsOnBench: pieceIsOnBench })));
};
            ...
            case 0:
                channel = redux_saga_1.eventChannel(function (emit) {
                    ...
                    registry.on(shared_1.ServerToClientPacketOpcodes.BOARD_UPDATE, function (_a) {
                        var state = _a.state;
                        emit(shared_1.BoardCommands.setBoardPiecesCommand(state));
                    });
                    ...
                    registry.on(shared_1.ServerToClientPacketOpcodes.LEVEL_UPDATE, function (packet) {
                        ...
                        emit(shared_1.BoardCommands.setPieceLimitCommand(packet.level));
                    });
                    ...
                    registry.on(shared_1.ServerToClientPacketOpcodes.PHASE_UPDATE, function (packet) {
                        ...
                        switch (packet.phase) {
                            case models_1.GamePhase.PREPARING: {
                                ...
                                emit(shared_1.BoardCommands.setBoardPiecesCommand(board));
                                ...
                                emit(shared_1.BoardCommands.unlockBoardCommand());
                            ...
                            case models_1.GamePhase.READY: {
                                ...
                                emit(shared_1.BenchCommands.initialiseBenchCommand(bench.pieces));
                                emit(shared_1.BoardCommands.lockBoardCommand());
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 13:
                ...
                return [4 /*yield*/, effects_1.put(shared_1.BoardCommands.setBoardPiecesCommand(board))];
            case 14:
                _e.sent();
...
__createBinding(exports, state_1, "lockBoardCommand");
__createBinding(exports, state_1, "unlockBoardCommand");
__createBinding(exports, state_1, "setPieceLimitCommand");
__createBinding(exports, state_1, "setBoardPiecesCommand");
__createBinding(exports, state_1, "moveBoardPieceCommand");
__createBinding(exports, state_1, "removeBoardPiecesCommand");
__createBinding(exports, state_1, "updateBoardPiecesCommand");
__createBinding(exports, state_1, "addBoardPieceCommand");
__createBinding(exports, state_1, "setBoardSizeCommand");
...
exports.BoardSelectors = __webpack_require__(/*! ./selectors */ "../shared/lib/board/selectors.js");
...
exports.__esModule = true;
exports.getPiecePosition = void 0;
...
var _a, _b;
exports.__esModule = true;
exports.updateBoardPiecesCommand = exports.removeBoardPiecesCommand = exports.moveBoardPieceCommand = exports.addBoardPieceCommand = exports.setBoardPiecesCommand = exports.setPieceLimitCommand = exports.unlockBoardCommand = exports.lockBoardCommand = exports.setBoardSizeCommand = exports.reducer = void 0;
var toolkit_1 = __webpack_require__(/*! @reduxjs/toolkit */ "../shared/node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
var filter_1 = __webpack_require__(/*! ./utils/filter */ "../shared/lib/board/utils/filter.js");
var initialState = {
    pieces: {},
    piecePositions: {},
    locked: false,
...
exports.reducer = (_a = toolkit_1.createSlice({
    ...
    reducers: {
        ...
        addBoardPieceCommand: function (state, _a) {
            ...
            return __assign(__assign({}, state), { pieces: __assign(__assign({}, state.pieces), (_b = {}, _b[piece.id] = __assign(__assign({}, piece), { facingAway: true }), _b)), piecePositions: __assign(__assign({}, state.piecePositions), (_c = {}, _c[x + "," + y] = piece.id, _c)) });
        },
        ...
        updateBoardPiecesCommand: function (state, _a) {
            ...
            var newState = __assign(__assign({}, state), { pieces: __assign({}, state.pieces) });
            try {
...
}), _a.reducer), exports.setBoardSizeCommand = (_b = _a.actions, _b.setBoardSizeCommand), exports.lockBoardCommand = _b.lockBoardCommand, exports.unlockBoardCommand = _b.unlockBoardCommand, exports.setPieceLimitCommand = _b.setPieceLimitCommand, exports.setBoardPiecesCommand = _b.setBoardPiecesCommand, exports.addBoardPieceCommand = _b.addBoardPieceCommand, exports.moveBoardPieceCommand = _b.moveBoardPieceCommand, exports.removeBoardPiecesCommand = _b.removeBoardPiecesCommand, exports.updateBoardPiecesCommand = _b.updateBoardPiecesCommand;


/***/ }),

/***/ "../shared/lib/board/utils/filter.js":
/*!*******************************************!*\
  !*** ../shared/lib/board/utils/filter.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports) {
...
exports.mergeBoards = function (home, away) {
    ...
    var expandedHome = state_1.reducer(home, state_1.setBoardSizeCommand(newSize));
    var expandedAway = state_1.reducer(away, state_1.setBoardSizeCommand(newSize));
...
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var selectors_1 = __webpack_require__(/*! ../selectors */ "../shared/lib/board/selectors.js");
...
exports.rotatePiecesAboutCenter = function (state) {
    ...
    return __assign(__assign({}, state), { pieces: Object.entries(state.pieces).reduce(function (acc, _a) {
            var _b;
            var _c = __read(_a, 2), pieceId = _c[0], piece = _c[1];
            return (__assign(__assign({}, acc), (_b = {}, _b[pieceId] = __assign(__assign({}, piece), { facingAway: !piece.facingAway }), _b)));
        }, {}), piecePositions: newPositions.reduce(function (acc, _a) {
            var _b;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        emit(board_1.BoardCommands.setBoardPiecesCommand({
                            pieces: board.pieces,
...
var takePieceTurn = function (currentTurn, pieceId, board) {
    ...
    var attacker = __assign(__assign({}, board.pieces[pieceId]), { attacking: null, hit: null, combat: __assign(__assign({}, board.pieces[pieceId].combat), { board: __assign({}, board.pieces[pieceId].combat.board) }) });
    ...
    if (attackerBoardState.removeFromBoardAtTurn === currentTurn) {
        return board_1.boardReducer(board, board_1.BoardCommands.removeBoardPiecesCommand([pieceId]));
    }
    if (attacker.currentHealth === 0) {
        ...
        return board_1.boardReducer(board, board_1.BoardCommands.updateBoardPiecesCommand([attacker]));
    }
    ...
    if (!targetAlive) {
        ...
        return board_1.boardReducer(board, board_1.BoardCommands.updateBoardPiecesCommand([newAttacker, defender]));
    }
    else {
        ...
        return board_1.boardReducer(board_1.boardReducer(board, board_1.BoardCommands.moveBoardPieceCommand({ pieceId: pieceId, from: attackerPosition, to: nextPosition })), board_1.BoardCommands.updateBoardPiecesCommand([attacker]));
    }
};
...
var Match = /** @class */ (function () {
    function Match(home, away, gameOptions) {
        ...
        var board = board_1.mergeBoards(home.getBoard(), away.getBoard());
        this.store.dispatch(board_1.BoardCommands.setBoardPiecesCommand(board));
    }
    ...
    Match.prototype.getBoardForPlayer = function (playerId) {
        ...
        return (playerId === this.away.id)
            ? board_1.rotatePiecesAboutCenter(board)
            : board;
    };
...
var pieces = function (state, command) {
    ...
    switch (command.type) {
        ...
        case commands_1.ADD_BENCH_PIECE_COMMAND: {
            ...
            newState[slotToUse] = __assign(__assign({}, piece), { facingAway: false });
            return newState;
        }
        ...
        case commands_1.MOVE_BENCH_PIECE_COMMAND: {
            ...
            newState[to.slot] = __assign({}, piece);
            return newState;
        }
        default:
            return state;
...
var Player = /** @class */ (function () {
    ...
    Player.prototype.enterPreparingPhase = function () {
        ...
        this.store.dispatch(board_1.BoardCommands.setPieceLimitCommand(this.getLevel()));
        this.store.dispatch(board_1.BoardCommands.unlockBoardCommand());
    };
    ...
    Player.prototype.enterReadyPhase = function (match) {
        this.match = match;
        this.store.dispatch(board_1.BoardCommands.lockBoardCommand());
    ...
    Player.prototype.clearPieces = function () {
        ...
        this.store.dispatch(board_1.BoardCommands.setBoardPiecesCommand({ pieces: {}, piecePositions: {} }));
...
exports.getPlayerFirstEmptyBoardSlot = function (state, sortPositions) {
    ...
    for (var y_1 = 0; y_1 < state.size.height; y_1++) {
        for (var x_1 = 0; x_1 < state.size.width; x_1++) {
            var boardPiece = pieceSelectors_1.getBoardPieceForPosition(state, x_1, y_1);
            if (!boardPiece) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeLatest(
                    ...
                    [commands_1.ADD_BENCH_PIECE_COMMAND, board_1.BoardCommands.addBoardPieceCommand], function (_a) {
                        var boardLocked, state, targetDefinitionId, targetStage, getCombinablePieces, matchingBoardPieces, matchingBenchPieces, totalInstances, pieceToReplace_1, piecePosition, boardPieceIds, benchPieceIds, newPiece, x, y, benchPieceIds, newPiece;
                        var piece = _a.payload.piece;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, effects_1.take(board_1.BoardCommands.unlockBoardCommand)];
                                case 2:
                                    // todo check if we have 3 evolvable pieces on the bench and evolve those? maybe
                                    _b.sent();
                                ...
                                case 6:
                                    ...
                                    return [4 /*yield*/, effects_1.put(board_1.BoardCommands.removeBoardPiecesCommand(boardPieceIds))];
                                case 7:
                                    _b.sent();
                                ...
                                case 8:
                                    ...
                                    return [4 /*yield*/, effects_1.put(board_1.BoardCommands.addBoardPieceCommand({ x: x, y: y, piece: newPiece }))];
                                case 9:
                                    _b.sent();
                                    return [3 /*break*/, 14];
                                case 10:
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    _loop_1 = function () {
                                        var state, belowPieceLimit, benchPiece, destination, benchPieceSlot, fromLocation, toLocation;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                ...
                                                case 1:
                                                    ...
                                                    destination = playerSelectors_1.getPlayerFirstEmptyBoardSlot(state.board);
                                                    if (!destination) {
                                                        return [2 /*return*/, { value: void 0 }];
                                                    }
                                                    benchPieceSlot = state.bench.pieces.findIndex(function (p) { return p !== null && p.id === benchPiece.id; });
                                                    fromLocation = {
                                                        type: "bench",
                                                        location: {
                                                            slot: benchPieceSlot
...
var getCardDestination = function (state, playerId, sortPositions) {
    ...
    if (belowPieceLimit && inPreparingPhase) {
        var boardSlot = playerSelectors_1.getPlayerFirstEmptyBoardSlot(state.board, sortPositions);
        if (boardSlot) {
            return {
                type: "board",
                location: {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 8:
                                    ...
                                    return [4 /*yield*/, effects_1.put(board_1.BoardCommands.addBoardPieceCommand({ piece: piece, x: x, y: y }))];
                                case 9:
                                    _b.sent();
                                    return [3 /*break*/, 12];
                                case 10:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeEvery(actions_1.PLAYER_DROP_PIECE_ACTION, function (_a) {
                        var state, fromPiece, toPiece, belowPieceLimit, _b, x, y;
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, effects_1.put(board_1.BoardCommands.moveBoardPieceCommand({ pieceId: pieceId, from: from.location, to: to.location }))];
                                case 2:
                                    _d.sent();
                                    return [3 /*break*/, 11];
                                case 3:
                                ...
                                case 5:
                                    ...
                                    return [4 /*yield*/, effects_1.put(board_1.BoardCommands.removeBoardPiecesCommand([pieceId]))];
                                case 6:
                                    _d.sent();
                                ...
                                case 9:
                                    ...
                                    return [4 /*yield*/, effects_1.put(board_1.BoardCommands.addBoardPieceCommand({ piece: fromPiece, x: x, y: y }))];
                                case 10:
                                    _d.sent();
                                    _d.label = 11;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, effects_1.put(board_1.BoardCommands.setPieceLimitCommand(level))];
                case 6:
                    _a.sent();
                    _a.label = 7;
...
__createBinding(exports, board_1, "BoardSelectors");
...
exports.__esModule = true;
exports.moveOrAddPiece = exports.clonePiece = exports.createPieceFromCard = exports.getStats = exports.createPiece = void 0;
var uuid_1 = __webpack_require__(/*! uuid */ "../shared/node_modules/uuid/dist/esm-browser/index.js");
...
exports.clonePiece = function (definitionProvider, piece) {
    return exports.createPiece(definitionProvider, piece.ownerId, piece.definitionId, piece.id, piece.stage);
};
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/index.tsx","vendors-node_modules_auth0_auth0-react_dist_auth0-react_esm_js-node_modules_fortawesome_free--45b69a"]
/******/ 		];
