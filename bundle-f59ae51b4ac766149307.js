...
var auth_2 = __webpack_require__(/*! ./auth */ "./src/auth/index.ts");
    ...
    React.useEffect(function () {
        if (isAuthenticated && !userFetched) {
            getAccessTokenSilently().then(function (token) {
                dispatch(auth_2.AuthActions.userAuthenticated(token));
            })["catch"](function (e) {
...
var LoginPage = function () {
    ...
    if (isLoading || loadingSignIn) {
        return React.createElement(ui_1.Loading, null);
    }
    return (React.createElement("div", { className: "login" },
        ...
        React.createElement("div", { className: "groups" },
            ...
            React.createElement("div", { className: "group" },
                React.createElement(ui_1.Segment, { header: "Watch a demo video", open: demoOpen, onHeaderClick: onDemoClick },
        ...
        React.createElement(ui_1.Footer, null)));
};
...
__createBinding(exports, selectors_1, "getUserId");
var saga_1 = __webpack_require__(/*! ./store/saga */ "./src/auth/store/saga.ts");
__createBinding(exports, saga_1, "loadUserSaga");
var reducer_1 = __webpack_require__(/*! ./store/reducer */ "./src/auth/store/reducer.ts");
__createBinding(exports, reducer_1, "userReducer");
exports.AuthActions = __importStar(__webpack_require__(/*! ./store/actions */ "./src/auth/store/actions.ts"));
...
var Healthbar = function (_a) {
    ...
    var piece = react_redux_1.useSelector(function (state) { return gamemode_1.getPiece(state.game, pieceId); });
    var localPlayerId = react_redux_1.useSelector(auth_1.getUserId);
    ...
    return (React.createElement(ui_1.ProgressBar, { className: "healthbar " + (friendly ? "friendly" : "enemy") + " " + (vertical ? "vertical" : ""), current: currentHealth, max: maxHealth, vertical: vertical }));
};
...
exports.ownedPieceCountSelector = function (state) {
    var playerId = auth_1.getUserId(state);
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                ...
                                switch (_b) {
                                    case models_1.GamePhase.PREPARING: return [3 /*break*/, 1];
                                    case models_1.GamePhase.READY: return [3 /*break*/, 3];
                                }
                                return [3 /*break*/, 6];
                            case 1: return [4 /*yield*/, effects_1.put(ui_1.openOverlay(ui_1.Overlay.SHOP))];
                            case 2:
                                _c.sent();
                                return [2 /*return*/];
                            case 3: return [4 /*yield*/, effects_1.put(ui_1.closeOverlay())];
                            case 4:
                                _c.sent();
...
exports.rootSaga = function (getAccessTokenSilently, loginWithRedirect, slices) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.fork(auth_1.loadUserSaga)];
            case 1:
                _a.sent();
...
exports.__esModule = true;
exports.finishGameAction = exports.updateConnectionStatus = exports.closeOverlay = exports.openOverlay = exports.clearSelectedPiece = exports.selectPiece = exports.CLEAR_SELECTED_PIECE = exports.SELECT_PIECE = exports.FINISH_GAME = exports.UPDATE_CONNECTION_STATUS = exports.CLOSE_OVERLAY = exports.OPEN_OVERLAY = void 0;
...
var footer_1 = __webpack_require__(/*! ./footer */ "./src/ui/display/footer.tsx");
__createBinding(exports, footer_1, "Footer");
var loading_1 = __webpack_require__(/*! ./loading */ "./src/ui/display/loading.tsx");
...
var overlay_1 = __webpack_require__(/*! ./overlay */ "./src/ui/overlay.ts");
__createBinding(exports, overlay_1, "Overlay");
var display_1 = __webpack_require__(/*! ./display */ "./src/ui/display/index.ts");
__createBinding(exports, display_1, "Footer");
__createBinding(exports, display_1, "Loading");
__createBinding(exports, display_1, "Segment");
    ...
    function Game(createLogger, players, options) {
        ...
        this.gameSagaFactory = function () {
            ...
            return function (players) {
                var startTime, sagaDependencies, winnerId, duration, winner, event, gamePlayers;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        this.addPlayer = function (player) {
            ...
            player.setGetRoundInfoState(function () { return _this_1.store.getState().roundInfo; });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [3 /*break*/, 0];
            case 4:
                winnerId = dependencies.players.getAll()[0].id;
                return [2 /*return*/, {
                        winnerId: winnerId
                    }];
        }
