...
var LoginPage = function () {
    ...
    var _b = __read(React.useState(false), 2), whyNeedAccountOpen = _b[0], setWhyNeedAccountOpen = _b[1];
    var onSignInClick = function () {
        setLoadingSignIn(true);
        auth0_1.signIn();
    };
    var onWhyNeedAccountClick = function () { return setWhyNeedAccountOpen(!whyNeedAccountOpen); };
    if (checkingSession) {
        return React.createElement(loading_1.Loading, null);
    }
    return (React.createElement("div", { className: "login" },
        ...
        loadingSignIn
            && React.createElement("button", { className: "login-button" }, "Loading..."),
        !loadingSignIn
            && React.createElement("button", { onClick: onSignInClick, className: "login-button" }, "Log in / Sign up"),
        React.createElement("div", { className: "segment " + (whyNeedAccountOpen ? "" : "closed") },
            React.createElement("div", { className: "header", onClick: onWhyNeedAccountClick },
                "Why do I need an account? ",
                whyNeedAccountOpen ? "-" : "+"),
            React.createElement("div", { className: "content" },
                React.createElement("p", null, "Logging into an account allows the game to keep your session, so that if you get disconnected, you can get right back into the game."),
                React.createElement("p", null, "\u00A0"),
                React.createElement("p", null, "I don't store any of your personal data. Your game data might be deleted occasionally as I develop the game further."))),
        React.createElement("div", { className: "video-container" },
            React.createElement("h3", { className: "demo" }, "Demo"),
...
exports.__esModule = true;
exports.LEADERBOARD_ENDPOINT = exports.CURRENT_USER_ENDPOINT = exports.scope = exports.audience = exports.logoutRedirectUrl = exports.redirectUri = exports.clientID = exports.domain = void 0;
var local = false;
    ...
    return function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 12: return [4 /*yield*/, _a.apply(void 0, [_b.concat([
                            _c.sent()
                        ])])];
                case 13:
                    _c.sent();
        ...
        return (React.createElement("div", { className: "menu" },
            ...
            React.createElement("div", { className: "join-game" },
                ...
                React.createElement("div", { className: "blurb" },
                    React.createElement("p", null, "This is a strategy game in which you configure creatures on a board."),
                    ...
                    React.createElement("p", null,
                        "Good luck! ",
                        React.createElement("span", { className: "author" }, "~ jkm"))),
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, effects_1.takeEvery(actions_1.UPDATE_CONNECTION_STATUS, function (_a) {
                        var user;
                        var status = _a.payload.status;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    if (status !== shared_1.ConnectionStatus.CONNECTED) {
                                        return [2 /*return*/];
                                    }
                                    return [4 /*yield*/, effects_1.select(function (state) { return state.auth.user; })];
                                case 1:
                                    user = _b.sent();
