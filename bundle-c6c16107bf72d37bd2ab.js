...
var PieceComponent = function (props) {
    ...
    var runAnimations = function (newPiece) {
        ...
        var attacking = newPiece.attacking, hit = newPiece.hit, celebrating = newPiece.celebrating, currentHealth = newPiece.currentHealth;
        if (!oldPiece) {
            setOldPiece(newPiece);
            return;
        }
        if (attacking && !oldPiece.attacking) {
            runAnimation("attack-" + attacking.attackType.name, { attackPower: attacking.damage, attackXDirection: attacking.direction.x, attackYDirection: attacking.direction.y });
        }
        if (hit && !oldPiece.hit) {
...
var findGame = function (registry) {
    return new Promise(function (resolve) {
        registry.emit(client_to_server_1.ClientToServerPacketOpcodes.FIND_GAME, { empty: true }, function (response) {
            resolve(response);
        });
    });
};
var subscribe = function (registry, socket) {
    return redux_saga_1.eventChannel(function (emit) {
        ...
        registry.on(server_to_client_1.ServerToClientPacketOpcodes.START_GAME, function (packet) {
            ...
            // todo rework this
            if (packet.fullState) {
                var _a = packet.fullState, money = _a.money, cards = _a.cards, players = _a.players, _b = _a.level, level = _b.level, xp = _b.xp, board = _a.board, bench = _a.bench;
                ...
                emit(localPlayerActions_1.localPlayerLevelUpdate(level, xp));
...
exports.networking = function () {
    var action, state, isLoggedIn, idToken, socket, chosenNickname, e_1, nickname, error, nickname, error, outgoingRegistry, incomingRegistry, _a, error, response, _b, playerId, lobbyId, players, startTimestamp, _c, localPlayerId, reconnectionSecret, gameId, name_1, _d, money, cards, players, _e, level, xp, board, bench, phase;
    return tslib_1.__generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 9:
                nickname = (_f.sent()).payload.nickname;
            ...
            case 28:
                if (false) {}
                return [4 /*yield*/, effects_1.call(findGame, outgoingRegistry)];
            case 29:
                _a = _f.sent(), error = _a.error, response = _a.response;
                if (!!error) return [3 /*break*/, 44];
                if (!(response.type === "lobby")) return [3 /*break*/, 31];
                _b = response.payload, playerId = _b.playerId, lobbyId = _b.lobbyId, players = _b.players, startTimestamp = _b.startTimestamp;
                return [4 /*yield*/, effects_1.put(lobbyActions_1.joinLobbyAction(playerId, lobbyId, players, startTimestamp, false // todo remove this parameter
                    ))];
            case 30:
                _f.sent();
                _f.label = 31;
            case 31:
                if (!(response.type === "game")) return [3 /*break*/, 43];
                _c = response.payload, localPlayerId = _c.localPlayerId, reconnectionSecret = _c.reconnectionSecret, gameId = _c.gameId, name_1 = _c.name;
                return [4 /*yield*/, effects_1.put(localPlayerActions_1.joinCompleteAction(localPlayerId, reconnectionSecret, gameId, name_1))];
            case 32:
                _f.sent();
                _d = response.payload.fullState, money = _d.money, cards = _d.cards, players = _d.players, _e = _d.level, level = _e.level, xp = _e.xp, board = _d.board, bench = _d.bench, phase = _d.phase;
                return [4 /*yield*/, effects_1.put(gameInfo_1.moneyUpdateAction(money))];
            case 33:
                _f.sent();
                return [4 /*yield*/, effects_1.put(cardShop_1.cardsUpdated(cards))];
            case 34:
                _f.sent();
                return [4 /*yield*/, effects_1.put(playerListActions_1.playerListUpdated(players))];
            case 35:
                _f.sent();
                return [4 /*yield*/, effects_1.put(localPlayerActions_1.localPlayerLevelUpdate(level, xp))];
            case 36:
                _f.sent();
                return [4 /*yield*/, effects_1.put(boardActions_1.initialiseBoard(board))];
            case 37:
                _f.sent();
                return [4 /*yield*/, effects_1.put(benchActions_1.initialiseBench(bench))];
            case 38:
                _f.sent();
                if (!phase) return [3 /*break*/, 41];
                return [4 /*yield*/, effects_1.put(gameInfo_1.gamePhaseUpdate(phase))];
            case 39:
                _f.sent();
                return [4 /*yield*/, effects_1.put(gameActions_1.phaseStartSeconds(phase.startedAt / 1000))];
            case 40:
                _f.sent();
                return [3 /*break*/, 43];
            case 41: return [4 /*yield*/, effects_1.put(gameActions_1.updateConnectionStatus(networking_1.ConnectionStatus.RECONNECTED))];
            case 42:
                _f.sent();
                _f.label = 43;
            case 43: return [3 /*break*/, 47];
            case 44: return [4 /*yield*/, effects_1.put(gameActions_1.joinGameError(error))];
            case 45:
                _f.sent();
            ...
            case 46:
                action = _f.sent();
                return [3 /*break*/, 28];
            case 47: return [4 /*yield*/, effects_1.fork(writeActionsToPackets, outgoingRegistry)];
            case 48:
                _f.sent();
                return [2 /*return*/];
        }
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 4:
                                    ...
                                    if (!(selectedPiece && selectedPiece.position.y !== null)) return [3 /*break*/, 6];
...
exports.phaseTimer = function () {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeLatest(gameInfo_1.GAME_PHASE_UPDATE, function () {
                    var seconds;
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                ...
                return [4 /*yield*/, effects_1.takeEvery(localPlayerActionTypes_1.JOIN_COMPLETE, function (_a) {
                        ...
                        return tslib_1.__generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 8: return [4 /*yield*/, _b.apply(void 0, [_c.concat([
                                            _d.sent()
                                        ])])];
                                case 9:
                                    _d.sent();
...
exports.classBuilds = (_a = {},
    ...
    _a);
var getBaseStats = function (cost) {
    if (cost === 1) {
        return {
            hp: 10,
            attack: 10,
...
var getAvailablePoints = function (stage) {
    if (stage === 0) {
        return 20;
    }
    if (stage === 1) {
...
var getStats = function (definitionClass, cost, stage) {
    var baseStats = getBaseStats(cost);
    var availablePoints = getAvailablePoints(stage);
...
exports.definitions = [
    ...
    createDefinition(16, "Incandesfin", creatureType_1.CreatureType.Water, definitionClass_1.DefinitionClass.VALIANT, 2),
    ...
    createDefinition(30, "Bursa", creatureType_1.CreatureType.Earth, definitionClass_1.DefinitionClass.ARCANE, 4),
...
exports.battleEventChannel = function (turnSimulator, turnDuration, startingBoardState, maxTurns, bufferSize) {
    return redux_saga_1.eventChannel(function (emit) {
        var cancelled = false;
        var board = {
            pieces: tslib_1.__assign({}, startingBoardState.pieces),
...
exports.getAttackableEnemy = function (piece, attackType, board) {
    var e_2, _a;
...
exports.getNewPiecePosition = function (piece, board) {
    ...
    return pathfinding_1.getNextPiecePosition(piece, target, board);
};
...
var TurnSimulator = /** @class */ (function () {
    ...
    TurnSimulator.prototype.simulateTurn = function (turnCount, board) {
        var e_1, _a;
        var pieceIds = Object.keys(board.pieces);
        try {
            for (var pieceIds_1 = tslib_1.__values(pieceIds), pieceIds_1_1 = pieceIds_1.next(); !pieceIds_1_1.done; pieceIds_1_1 = pieceIds_1.next()) {
                var pieceId = pieceIds_1_1.value;
                ...
                if (attacker.coolDown > 0) {
                    ...
                    board = board_1.boardReducer(board, boardActions_1.updateBoardPiece(attacker));
                    continue;
                }
                var defender = movement_1.getAttackableEnemy(attacker, attackerCombatInfo.stats.attackType, board);
                if (!defender) {
                ...
                board = board_1.boardReducer(board, boardActions_1.updateBoardPieces([updatedFighters.attacker, updatedFighters.defender]));
            }
        }
        catch (e_1_1) { e_1 = { error: e_1_1 }; }
        finally {
        ...
        if (utils_1.isATeamDefeated(board)) {
            var newPieces = Object.values(board.pieces).map(function (piece) { return (tslib_1.__assign(tslib_1.__assign({}, piece), { celebrating: true })); });
            board = board_1.boardReducer(board, boardActions_1.updateBoardPieces(newPieces));
        }
        return board;
    };
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeEvery(actions_1.BUY_CARD, function (_a) {
                        var state, gamePhase, card, money, slot, piece, remainingCards;
                        ...
                        return tslib_1.__generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    ...
                                    // no valid slots
                                    if (slot === null) {
                                        log_1.log("attempted to buy a card but has no empty slot");
                                        return [2 /*return*/];
                                    }
                                    piece = piece_utils_1.createPieceFromCard(definitionProvider, playerId, card, slot);
                                ...
                                case 2:
                                    _b.sent();
                                    return [4 /*yield*/, effects_1.put(gameInfo_1.moneyUpdateAction(money - card.cost))];
                                case 3:
                                    _b.sent();
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, effects_1.takeLatest(
                    ...
                    [benchActionTypes_1.ADD_BENCH_PIECE, boardActionTypes_1.UPDATE_BOARD_PIECE], function (_a) {
...
exports.isATeamDefeated = function (board) {
    var healthByTeam = get_total_health_by_team_1.getTotalHealthByTeam(board);
