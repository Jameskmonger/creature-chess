...
var BoardContainer = function (_a) {
    ...
    return (React.createElement("div", { className: "group board-container style-default" },
        ...
        React.createElement("div", { className: "bench" },
            React.createElement(board_react_1.BoardGrid, { state: bench, onDrop: tileInteraction_1.onDropPiece(dispatch, "bench", board, bench), onClick: tileInteraction_1.onTileClick(dispatch, "bench"), renderItem: renderBenchPiece }))));
};
...
var GameBoard = function () {
    ...
    if (matchBoard) {
        return (React.createElement("div", { className: "board-tiles" },
            React.createElement(board_react_1.BoardGrid, { state: matchBoard, renderItem: renderBoardPiece })));
    }
    return (React.createElement("div", { className: "board-tiles" },
        React.createElement(board_react_1.BoardGrid, { state: board, onDrop: tileInteraction_1.onDropPiece(dispatch, "board", board, bench), onClick: tileInteraction_1.onTileClick(dispatch, "board"), renderItem: renderBoardPiece })));
};
...
var auth_1 = __webpack_require__(/*! ../../../../auth */ "./src/auth/index.ts");
var display_1 = __webpack_require__(/*! ../../../../display */ "./src/display/index.ts");
var playerPicture_1 = __webpack_require__(/*! ../../playerList/components/playerPicture */ "./src/game/module/playerList/components/playerPicture.tsx");
var playerTitle_1 = __webpack_require__(/*! ../../playerList/components/playerTitle */ "./src/game/module/playerList/components/playerTitle.tsx");
var boardOverlay_1 = __webpack_require__(/*! ./boardOverlay */ "./src/game/module/board/overlays/boardOverlay.tsx");
...
var ReadyOverlay = function () {
    ...
    var returnTitleOrSpacer = function (player) {
        if (player.profile.title !== null) {
            return React.createElement(playerTitle_1.PlayerTitle, { playerId: player.id });
        }
            ...
            React.createElement("div", { className: "outer-profile-box" },
                React.createElement("div", { className: "inner-profile-box" },
                    React.createElement("div", { className: "player-picture" },
                        React.createElement(playerPicture_1.PlayerPicture, { playerId: localPlayer.id })),
                    React.createElement("div", { className: "name-and-health" },
                        ...
                        React.createElement("div", { className: "healthbar-container" },
                            React.createElement(display_1.ProgressBar, { className: "healthbar player-health", current: localPlayer.health, max: 100, renderContents: renderHealthbar }))),
                    ...
                    React.createElement("div", { className: "name-and-health right" },
                        ...
                        React.createElement("div", { className: "healthbar-container" },
                            React.createElement(display_1.ProgressBar, { className: "healthbar player-health", current: opponent.health, max: 100, renderContents: renderHealthbar }))),
                    React.createElement("div", { className: "player-picture" },
                        React.createElement(playerPicture_1.PlayerPicture, { playerId: opponent.id })))),
...
var StageIndicator = function (_a) {
    var pieceId = _a.pieceId;
    var piece = react_redux_1.useSelector(function (state) {
        if (state.game.match.board) {
            return board_1.BoardSelectors.getPiece(state.game.match.board, pieceId);
        }
        return gamemode_1.getPiece(state.game, pieceId);
    });
...
var display_1 = __webpack_require__(/*! ../../../../../display */ "./src/display/index.ts");
var auth_1 = __webpack_require__(/*! ../../../../../auth */ "./src/auth/index.ts");
var getColourName = function (friendly, spectating) {
    if (friendly) {
        return "friendly";
    }
    if (spectating) {
...
var Healthbar = function (_a) {
    ...
    var spectatingPlayerId = react_redux_1.useSelector(function (state) { return state.game.spectating.id; });
    var piece = react_redux_1.useSelector(function (state) {
        if (state.game.match.board) {
            return board_1.BoardSelectors.getPiece(state.game.match.board, pieceId);
        }
    ...
    var spectating = spectatingPlayerId === ownerId;
    return (React.createElement(display_1.ProgressBar, { className: "healthbar " + getColourName(friendly, spectating) + " " + (vertical ? "vertical" : ""), current: currentHealth, max: maxHealth, vertical: vertical }));
};
...
var PieceComponent = function (props) {
    ...
    var piece = react_redux_1.useSelector(function (state) {
        if (state.game.match.board) {
            return board_1.BoardSelectors.getPiece(state.game.match.board, id);
        }
        return gamemode_1.getPiece(state.game, id);
    });
    var inPreparingPhase = react_redux_1.useSelector(function (state) { return state.game.roundInfo.phase === models_1.GamePhase.PREPARING; });
...
var CardShop = function (_a) {
    ...
    var onBuy = function () {
        ...
        dispatch(gamemode_1.PlayerActions.buyCardPlayerAction({ index: currentCardIndex }));
        setCurrentCardIndex(null);
    };
...
var RerollButton = function (_a) {
    ...
    var onBuy = function () {
        dispatch(gamemode_1.PlayerActions.rerollCardsPlayerAction());
        afterReroll();
    };
            ...
            React.createElement("ul", null,
                React.createElement("li", null,
                    React.createElement("span", { className: "list-header" },
                        React.createElement(TypeIndicator_1.TypeIndicator, { type: models_1.CreatureType.Earth }),
                        " Earth:"),
                    " Overcomes water."),
                React.createElement("li", null,
                    React.createElement("span", { className: "list-header" },
                        React.createElement(TypeIndicator_1.TypeIndicator, { type: models_1.CreatureType.Metal }),
                        "Metal:"),
                    " Overcomes wood."),
                React.createElement("li", null,
                    React.createElement("span", { className: "list-header" },
                        React.createElement(TypeIndicator_1.TypeIndicator, { type: models_1.CreatureType.Water }),
                        "Water:"),
                    " Overcomes fire."),
                React.createElement("li", null,
                    React.createElement("span", { className: "list-header" },
                        React.createElement(TypeIndicator_1.TypeIndicator, { type: models_1.CreatureType.Wood }),
                        "Wood:"),
                    " Overcomes earth."),
                React.createElement("li", null,
                    React.createElement("span", { className: "list-header" },
                        React.createElement(TypeIndicator_1.TypeIndicator, { type: models_1.CreatureType.Fire }),
                        "Fire:"),
                    " Overcomes metal."))),
        React.createElement("div", { className: "section" },
...
var SpectateButton = function (_a) {
    var currentlySpectating = _a.currentlySpectating, playerId = _a.playerId;
    var dispatch = react_redux_1.useDispatch();
    var onClick = function (e) {
        var action = currentlySpectating ? { playerId: null } : { playerId: playerId };
        dispatch(gamemode_1.PlayerActions.spectatePlayerAction(action));
        e.persist();
        e.nativeEvent.stopImmediatePropagation();
        e.stopPropagation();
    };
    return React.createElement("button", { className: "spectate-player", onClick: onClick }, currentlySpectating ? "Stop spectating" : "Spectate");
};
var PlayerListItem = function (_a) {
    ...
    var currentlySpectating = react_redux_1.useSelector(function (state) { return state.game.spectating.id === playerId; });
    var inPreparingPhase = react_redux_1.useSelector(function (state) { return state.game.roundInfo.phase === models_1.GamePhase.PREPARING; });
    ...
    return (React.createElement("div", { className: className, onClick: toggleExpanded, ref: ref },
        ...
        React.createElement("div", { className: "details" },
            ...
            React.createElement("div", { className: "row" },
                ...
                React.createElement("div", { className: "row-half " + (currentlySpectating || isExpanded ? "center" : "") }, currentlySpectating || isExpanded
                    ? React.createElement(SpectateButton, { currentlySpectating: currentlySpectating, playerId: playerId })
                    : React.createElement(React.Fragment, null,
...
var clientBattleSaga = function (slices) {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.fork(battle_1.battleSagaFactory(function (state) { var _a; return (_a = state.game.match) === null || _a === void 0 ? void 0 : _a.board; }), models_1.defaultGameOptions, slices.boardSlice)];
            case 1:
                _a.sent();
                return [4 /*yield*/, effects_1.takeLatest(battle_1.BattleEvents.BATTLE_TURN_EVENT, function (_a) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, effects_1.put(match_1.setMatchBoard(board))];
                                case 1:
                                    _b.sent();
                                    return [2 /*return*/];
                            }
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                ...
                                return [3 /*break*/, 6];
                            case 1: return [4 /*yield*/, effects_1.put(gamemode_1.PlayerInfoCommands.updateOpponentCommand(null))];
                            case 2:
                                _c.sent();
                            ...
                            case 3:
                                _c.sent();
                                return [2 /*return*/];
                            case 4: return [4 /*yield*/, effects_1.put(boardSlice.commands.lockBoardCommand())];
                            case 5:
                                _c.sent();
                                return [2 /*return*/];
        ...
        switch (_b.label) {
            case 0:
                channel = redux_saga_1.eventChannel(function (emit) {
                    ...
                    registry.on(networking_1.ServerToClient.Game.PacketOpcodes.MATCH_BOARD_UPDATE, function (_a) {
                    ...
                    registry.on(networking_1.ServerToClient.Game.PacketOpcodes.SPECTATING_PLAYER_UPDATE, function (newValue) {
                        emit(gamemode_1.PlayerCommands.setSpectatingIdCommand(newValue));
                    });
                    registry.on(networking_1.ServerToClient.Game.PacketOpcodes.OPPONENT_ID_UPDATE, function (newValue) {
                        emit(gamemode_1.PlayerInfoCommands.updateOpponentCommand(newValue));
                    });
                    ...
                    registry.on(networking_1.ServerToClient.Game.PacketOpcodes.LEVEL_UPDATE, function (packet) {
                        emit(gamemode_1.PlayerInfoCommands.updateLevelCommand(packet));
...
var incomingGameNetworking = function (socket, slices) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                registry = networking_1.ServerToClient.Game.createIncomingRegistry(function (opcode, handler) { return socket.on(opcode, handler); });
...
var networking_2 = __webpack_require__(/*! @creature-chess/networking */ "../networking/lib/index.js");
var battle_1 = __webpack_require__(/*! @creature-chess/battle */ "../battle/lib/index.js");
var gamemode_1 = __webpack_require__(/*! @creature-chess/gamemode */ "../gamemode/lib/index.js");
        ...
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.all([
                    effects_1.takeEvery(battle_1.BattleEvents.BATTLE_FINISH_EVENT, function () {
                        return __generator(this, function (_a) {
                            registry.emit(networking_2.ClientToServer.PacketOpcodes.FINISH_MATCH, { empty: true });
                            return [2 /*return*/];
                        });
                    }),
                    effects_1.call(networking_1.emitActionsSaga, registry, gamemode_1.PlayerActionTypesArray)
                ])];
            case 1:
                _a.sent();
                return [2 /*return*/];
...
var outgoingGameNetworking = function (socket) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                registry = networking_2.ClientToServer.createOutgoingRegistry(function (opcode, payload, ack) { return socket.emit(opcode, payload, ack); });
...
var lobbyNetworking = function (socket) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                registry = networking_1.ServerToClient.Lobby.createIncomingRegistry(function (opcode, handler) { return socket.on(opcode, handler); });
...
/***/ "../gamemode/lib/entities/player/dependencies.js":
/*!*******************************************************!*\
  !*** ../gamemode/lib/entities/player/dependencies.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var saga_1 = __webpack_require__(/*! ../../playerActions/saga */ "../gamemode/lib/playerActions/saga.js");
...
/***/ "../gamemode/lib/entities/player/events.js":
/*!*************************************************!*\
  !*** ../gamemode/lib/entities/player/events.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.PlayerStateSelectors = __webpack_require__(/*! ./state/selectors */ "../gamemode/lib/entities/player/state/selectors.js");
exports.PlayerEvents = __webpack_require__(/*! ./events */ "../gamemode/lib/entities/player/events.js");
var dependencies_1 = __webpack_require__(/*! ./dependencies */ "../gamemode/lib/entities/player/dependencies.js");
...
var selectors_1 = __webpack_require__(/*! ../state/selectors */ "../gamemode/lib/entities/player/state/selectors.js");
var playerBattle = function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.all([
                    effects_1.takeLatest(playerInfo_1.PlayerInfoCommands.updateOpponentCommand, function (_a) {
                        var opponentId = _a.payload;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    if (!opponentId) return [3 /*break*/, 2];
                                    return [4 /*yield*/, effects_1.put(playerInfo_1.PlayerInfoCommands.updateBattleCommand(models_1.inProgressBattle(opponentId)))];
                                case 1:
                                    _b.sent();
                                    _b.label = 2;
...
var typed_redux_saga_1 = __webpack_require__(/*! typed-redux-saga */ "../gamemode/node_modules/typed-redux-saga/dist/es/index.js");
var board_1 = __webpack_require__(/*! @shoki/board */ "../shoki-board/lib/index.js");
var playerActions_1 = __webpack_require__(/*! ../../../playerActions */ "../gamemode/lib/playerActions/index.js");
var selectors_1 = __webpack_require__(/*! ../state/selectors */ "../gamemode/lib/entities/player/state/selectors.js");
...
var typed_redux_saga_1 = __webpack_require__(/*! typed-redux-saga */ "../gamemode/node_modules/typed-redux-saga/dist/es/index.js");
var models_1 = __webpack_require__(/*! @creature-chess/models */ "../models/lib/index.js");
var events_1 = __webpack_require__(/*! ../events */ "../gamemode/lib/entities/player/events.js");
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            ...
                            case 5:
                                ...
                                return [4 /*yield*/, effects_1.put(playerInfo_1.PlayerInfoCommands.updateStatusCommand(models_1.PlayerStatus.DEAD))];
                            case 6:
                                _d.sent();
...
var typed_redux_saga_1 = __webpack_require__(/*! typed-redux-saga */ "../gamemode/node_modules/typed-redux-saga/dist/es/index.js");
var events_1 = __webpack_require__(/*! ../../../../game/events */ "../gamemode/lib/game/events.js");
var events_2 = __webpack_require__(/*! ../../events */ "../gamemode/lib/entities/player/events.js");
var playerInfo_1 = __webpack_require__(/*! ../../../../player/playerInfo */ "../gamemode/lib/player/playerInfo/index.js");
var commands_1 = __webpack_require__(/*! ../../../../player/playerInfo/commands */ "../gamemode/lib/player/playerInfo/commands.js");
var selectors_1 = __webpack_require__(/*! ../../state/selectors */ "../gamemode/lib/entities/player/state/selectors.js");
var selectors_2 = __webpack_require__(/*! ../../selectors */ "../gamemode/lib/entities/player/selectors.js");
                ...
                return [4 /*yield*/, effects_1.takeEvery(events_1.playerRunPreparingPhaseEvent.toString(), function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 10:
                                    _a.sent();
                                    return [4 /*yield*/, effects_1.put(playerInfo_1.PlayerInfoCommands.updateOpponentCommand(null))];
                                case 11:
                                    _a.sent();
                                    _a.label = 12;
...
var setStatusOnQuit = function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, effects_1.put(player_1.PlayerInfoCommands.updateStatusCommand(models_1.PlayerStatus.QUIT))];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
/***/ "../gamemode/lib/entities/player/state/selectors.js":
/*!**********************************************************!*\
  !*** ../gamemode/lib/entities/player/state/selectors.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var effects_1 = __webpack_require__(/*! redux-saga/effects */ "../gamemode/node_modules/redux-saga/dist/redux-saga-effects-npm-proxy.esm.js");
var typed_redux_saga_1 = __webpack_require__(/*! typed-redux-saga */ "../gamemode/node_modules/typed-redux-saga/dist/es/index.js");
var events_1 = __webpack_require__(/*! ../../../entities/player/events */ "../gamemode/lib/entities/player/events.js");
var selectors_1 = __webpack_require__(/*! ../selectors */ "../gamemode/lib/features/match/selectors.js");
...
exports.__esModule = true;
exports.playerFinishMatchEvent = exports.playerRunReadyPhaseEvent = exports.playerBeforeReadyPhaseEvent = exports.playerRunPreparingPhaseEvent = exports.playerListChangedEvent = exports.gameFinishEvent = exports.gamePhaseStartedEvent = void 0;
var toolkit_1 = __webpack_require__(/*! @reduxjs/toolkit */ "../gamemode/node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
...
var selectors_1 = __webpack_require__(/*! ../entities/player/state/selectors */ "../gamemode/lib/entities/player/state/selectors.js");
...
var player_1 = __webpack_require__(/*! ../entities/player */ "../gamemode/lib/entities/player/index.js");
...
var selectors_2 = __webpack_require__(/*! ../../entities/player/state/selectors */ "../gamemode/lib/entities/player/state/selectors.js");
var player_1 = __webpack_require__(/*! ../../entities/player */ "../gamemode/lib/entities/player/index.js");
var events_1 = __webpack_require__(/*! ../../entities/player/events */ "../gamemode/lib/entities/player/events.js");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [5 /*yield**/, __values(typed_redux_saga_1.select(player_2.PlayerStateSelectors.getPlayerHealth))];
                case 1:
                    initialHealth = _a.sent();
                    emitHealth(initialHealth);
                    sagas.push(effects_1.takeLatest(player_1.PlayerInfoCommands.updateHealthCommand.toString(), function (_a) {
                ...
                case 2:
                    ...
                    return [5 /*yield**/, __values(typed_redux_saga_1.select(player_2.PlayerStateSelectors.getPlayerStreak))];
                case 3:
                    initialStreak = _a.sent();
                    emitStreak(initialStreak);
                    sagas.push(effects_1.takeLatest(player_1.PlayerInfoCommands.UPDATE_STREAK_COMMAND, function (_a) {
                ...
                case 4:
                    ...
                    return [5 /*yield**/, __values(typed_redux_saga_1.select(player_2.PlayerStateSelectors.getPlayerStatus))];
                case 5:
                    initialStatus = _a.sent();
                    emitStatus(initialStatus);
                    sagas.push(effects_1.takeLatest(player_1.PlayerInfoCommands.updateStatusCommand.toString(), function (_a) {
                ...
                case 6:
                    ...
                    return [5 /*yield**/, __values(typed_redux_saga_1.select(player_2.PlayerStateSelectors.getPlayerBattle))];
                case 7:
                    initialBattle = _a.sent();
                    emitBattle(initialBattle);
                    sagas.push(effects_1.takeLatest(player_1.PlayerInfoCommands.UPDATE_BATTLE_COMMAND, function (_a) {
                ...
                case 8:
                    ...
                    return [5 /*yield**/, __values(typed_redux_saga_1.select(player_2.PlayerStateSelectors.isPlayerReady))];
                case 9:
                    initialReady = _a.sent();
                    emitReady(initialReady);
                    sagas.push(effects_1.takeLatest(player_1.PlayerInfoCommands.updateReadyCommand.toString(), function (_a) {
...
exports.PlayerActions = __webpack_require__(/*! ./playerActions */ "../gamemode/lib/playerActions/index.js");
var pieceSelectors_1 = __webpack_require__(/*! ./player/pieceSelectors */ "../gamemode/lib/player/pieceSelectors.js");
...
exports.__esModule = true;
exports.PlayerInfoCommands = void 0;
...
exports.__esModule = true;
exports.updateStreakCommand = exports.updateBattleCommand = exports.updateOpponentCommand = exports.updateReadyCommand = exports.updateStatusCommand = exports.updateLevelCommand = exports.updateMoneyCommand = exports.updateHealthCommand = exports.UPDATE_STREAK_COMMAND = exports.UPDATE_BATTLE_COMMAND = void 0;
var toolkit_1 = __webpack_require__(/*! @reduxjs/toolkit */ "../gamemode/node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
...
/***/ "../gamemode/lib/playerActions/buyCard.js":
/*!************************************************!*\
  !*** ../gamemode/lib/playerActions/buyCard.js ***!
  \************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var cardShop_1 = __webpack_require__(/*! ../entities/player/state/cardShop */ "../gamemode/lib/entities/player/state/cardShop.js");
var definitions_1 = __webpack_require__(/*! ../definitions */ "../gamemode/lib/definitions/index.js");
var selectors_2 = __webpack_require__(/*! ../entities/player/selectors */ "../gamemode/lib/entities/player/selectors.js");
var dependencies_1 = __webpack_require__(/*! ../entities/player/dependencies */ "../gamemode/lib/entities/player/dependencies.js");
...
/***/ "../gamemode/lib/playerActions/buyXp.js":
/*!**********************************************!*\
  !*** ../gamemode/lib/playerActions/buyXp.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var selectors_1 = __webpack_require__(/*! ../entities/player/state/selectors */ "../gamemode/lib/entities/player/state/selectors.js");
var commands_1 = __webpack_require__(/*! ../player/playerInfo/commands */ "../gamemode/lib/player/playerInfo/commands.js");
var xp_1 = __webpack_require__(/*! ../entities/player/sagas/xp */ "../gamemode/lib/entities/player/sagas/xp.js");
var toolkit_1 = __webpack_require__(/*! @reduxjs/toolkit */ "../gamemode/node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
var dependencies_1 = __webpack_require__(/*! ../entities/player/dependencies */ "../gamemode/lib/entities/player/dependencies.js");
...
/***/ "../gamemode/lib/playerActions/dropPiece.js":
/*!**************************************************!*\
  !*** ../gamemode/lib/playerActions/dropPiece.js ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "../gamemode/lib/playerActions/index.js":
/*!**********************************************!*\
  !*** ../gamemode/lib/playerActions/index.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var buyCard_1 = __webpack_require__(/*! ./buyCard */ "../gamemode/lib/playerActions/buyCard.js");
exports.buyCardPlayerAction = buyCard_1.buyCardPlayerAction;
var buyXp_1 = __webpack_require__(/*! ./buyXp */ "../gamemode/lib/playerActions/buyXp.js");
exports.buyXpPlayerAction = buyXp_1.buyXpPlayerAction;
var rerollCards_1 = __webpack_require__(/*! ./rerollCards */ "../gamemode/lib/playerActions/rerollCards.js");
exports.rerollCardsPlayerAction = rerollCards_1.rerollCardsPlayerAction;
var toggleShopLock_1 = __webpack_require__(/*! ./toggleShopLock */ "../gamemode/lib/playerActions/toggleShopLock.js");
exports.toggleShopLockPlayerAction = toggleShopLock_1.toggleShopLockPlayerAction;
var sellPiece_1 = __webpack_require__(/*! ./sellPiece */ "../gamemode/lib/playerActions/sellPiece.js");
exports.sellPiecePlayerAction = sellPiece_1.sellPiecePlayerAction;
var readyUp_1 = __webpack_require__(/*! ./readyUp */ "../gamemode/lib/playerActions/readyUp.js");
exports.readyUpPlayerAction = readyUp_1.readyUpPlayerAction;
var quitGame_1 = __webpack_require__(/*! ./quitGame */ "../gamemode/lib/playerActions/quitGame.js");
exports.quitGamePlayerAction = quitGame_1.quitGamePlayerAction;
var dropPiece_1 = __webpack_require__(/*! ./dropPiece */ "../gamemode/lib/playerActions/dropPiece.js");
exports.dropPiecePlayerAction = dropPiece_1.dropPiecePlayerAction;
var spectate_1 = __webpack_require__(/*! ./spectate */ "../gamemode/lib/playerActions/spectate.js");
...
/***/ "../gamemode/lib/playerActions/quitGame.js":
/*!*************************************************!*\
  !*** ../gamemode/lib/playerActions/quitGame.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "../gamemode/lib/playerActions/readyUp.js":
/*!************************************************!*\
  !*** ../gamemode/lib/playerActions/readyUp.js ***!
  \************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "../gamemode/lib/playerActions/rerollCards.js":
/*!****************************************************!*\
  !*** ../gamemode/lib/playerActions/rerollCards.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                ...
                                return [4 /*yield*/, effects_1.put(playerInfo_1.PlayerInfoCommands.updateMoneyCommand(money - models_1.REROLL_COST))];
                            case 4:
                                _a.sent();
...
/***/ "../gamemode/lib/playerActions/saga.js":
/*!*********************************************!*\
  !*** ../gamemode/lib/playerActions/saga.js ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "../gamemode/lib/playerActions/sellPiece.js":
/*!**************************************************!*\
  !*** ../gamemode/lib/playerActions/sellPiece.js ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "../gamemode/lib/playerActions/spectate.js":
/*!*************************************************!*\
  !*** ../gamemode/lib/playerActions/spectate.js ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var toolkit_1 = __webpack_require__(/*! @reduxjs/toolkit */ "../gamemode/node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
var engine_1 = __webpack_require__(/*! @shoki/engine */ "../shoki-engine/lib/index.js");
var spectating_1 = __webpack_require__(/*! ../entities/player/state/spectating */ "../gamemode/lib/entities/player/state/spectating.js");
var selectors_1 = __webpack_require__(/*! ../entities/player/state/selectors */ "../gamemode/lib/entities/player/state/selectors.js");
...
/***/ "../gamemode/lib/playerActions/toggleShopLock.js":
/*!*******************************************************!*\
  !*** ../gamemode/lib/playerActions/toggleShopLock.js ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
exports.createOutgoingRegistry = exports.createIncomingRegistry = exports.PacketOpcodes = void 0;
var networking_1 = __webpack_require__(/*! @shoki/networking */ "../shoki-networking/lib/index.js");
...
var createIncomingRegistry = function (registerListener) {
    return new networking_1.IncomingPacketRegistry(registerListener);
};
exports.createIncomingRegistry = createIncomingRegistry;
var createOutgoingRegistry = function (emit) {
    return new networking_1.OutgoingPacketRegistry(emit);
};
exports.createOutgoingRegistry = createOutgoingRegistry;
...
exports.__esModule = true;
exports.ClientToServer = exports.ServerToClient = void 0;
...
(function (PacketOpcodes) {
    ...
    PacketOpcodes["MATCH_BOARD_UPDATE"] = "matchBoardUpdate";
    PacketOpcodes["SPECTATING_PLAYER_UPDATE"] = "spectatingPlayerUpdate";
    PacketOpcodes["OPPONENT_ID_UPDATE"] = "opponentIdUpdate";
...
exports.__esModule = true;
exports.receiveActionsSaga = exports.IncomingPacketRegistry = exports.emitActionsSaga = exports.emitActionsOpcode = exports.OutgoingPacketRegistry = void 0;
var registry_1 = __webpack_require__(/*! ./registry */ "../shoki-networking/lib/registry/index.js");
__createBinding(exports, registry_1, "OutgoingPacketRegistry");
__createBinding(exports, registry_1, "emitActionsOpcode");
__createBinding(exports, registry_1, "emitActionsSaga");
__createBinding(exports, registry_1, "IncomingPacketRegistry");
__createBinding(exports, registry_1, "receiveActionsSaga");


/***/ }),

/***/ "../shoki-networking/lib/registry/emitActions.js":
/*!*******************************************************!*\
  !*** ../shoki-networking/lib/registry/emitActions.js ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
exports.emitActionsSaga = exports.emitActionsOpcode = void 0;
...
exports.emitActionsOpcode = "emitActions";
/**
 ...
 */
var emitActionsSaga = function (registry, actions) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                registry.emit(exports.emitActionsOpcode, payload);
                return [3 /*break*/, 1];
            case 3: return [2 /*return*/];
        }
    });
};
exports.emitActionsSaga = emitActionsSaga;


/***/ }),

/***/ "../shoki-networking/lib/registry/incoming-packet-registry.js":
/*!********************************************************************!*\
  !*** ../shoki-networking/lib/registry/incoming-packet-registry.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
var IncomingPacketRegistry = /** @class */ (function () {
    ...
    IncomingPacketRegistry.prototype.off = function (opcode, handler) {
        // todo implement
    };
...
/***/ "../shoki-networking/lib/registry/index.js":
/*!*************************************************!*\
  !*** ../shoki-networking/lib/registry/index.js ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
exports.receiveActionsSaga = exports.emitActionsOpcode = exports.emitActionsSaga = exports.OutgoingPacketRegistry = exports.IncomingPacketRegistry = void 0;
var incoming_packet_registry_1 = __webpack_require__(/*! ./incoming-packet-registry */ "../shoki-networking/lib/registry/incoming-packet-registry.js");
__createBinding(exports, incoming_packet_registry_1, "IncomingPacketRegistry");
var outgoing_packet_registry_1 = __webpack_require__(/*! ./outgoing-packet-registry */ "../shoki-networking/lib/registry/outgoing-packet-registry.js");
__createBinding(exports, outgoing_packet_registry_1, "OutgoingPacketRegistry");
var emitActions_1 = __webpack_require__(/*! ./emitActions */ "../shoki-networking/lib/registry/emitActions.js");
__createBinding(exports, emitActions_1, "emitActionsSaga");
__createBinding(exports, emitActions_1, "emitActionsOpcode");
var receiveActions_1 = __webpack_require__(/*! ./receiveActions */ "../shoki-networking/lib/registry/receiveActions.js");
__createBinding(exports, receiveActions_1, "receiveActionsSaga");


/***/ }),

/***/ "../shoki-networking/lib/registry/outgoing-packet-registry.js":
/*!********************************************************************!*\
  !*** ../shoki-networking/lib/registry/outgoing-packet-registry.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "../shoki-networking/lib/registry/receiveActions.js":
/*!**********************************************************!*\
  !*** ../shoki-networking/lib/registry/receiveActions.js ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.__esModule = true;
exports.receiveActionsSaga = void 0;
var redux_saga_1 = __webpack_require__(/*! redux-saga */ "../shoki-networking/node_modules/redux-saga/dist/redux-saga-core-npm-proxy.esm.js");
var effects_1 = __webpack_require__(/*! redux-saga/effects */ "../shoki-networking/node_modules/redux-saga/dist/redux-saga-effects-npm-proxy.esm.js");
var emitActions_1 = __webpack_require__(/*! ./emitActions */ "../shoki-networking/lib/registry/emitActions.js");
/**
 ...
 */
var receiveActionsSaga = function (registry, actions) {
        ...
        switch (_c.label) {
            case 0:
                ...
                channel = redux_saga_1.eventChannel(function (emit) {
                    ...
                    registry.on(emitActions_1.emitActionsOpcode, onReceiveActions);
                    return function () { return registry.off(emitActions_1.emitActionsOpcode, onReceiveActions); };
                });
                actionQueue = [];
                _c.label = 1;
            case 1:
...
exports.receiveActionsSaga = receiveActionsSaga;
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/index.tsx","vendors-node_modules_auth0_auth0-react_dist_auth0-react_esm_js-node_modules_fortawesome_free--298e0b"]
/******/ 		];
...
/******/ })()
;
//# sourceMappingURL=bundle-eb403209ecf184052837.js.map